...
printint(int fd, int xx, int base, int sgn)
{
 ...
 30c:	0f b6 92 34 06 00 00 	movzbl 0x634(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 448:	75 28                	jne    472 <printf+0x12a>
          s = "(null)";
 44a:	be 2d 06 00 00       	mov    $0x62d,%esi
...
free(void *ap)
{
 ...
 4bd:	a1 d8 08 00 00       	mov    0x8d8,%eax
 ...
 4f9:	89 08                	mov    %ecx,(%eax)
  freep = p;
 4fb:	a3 d8 08 00 00       	mov    %eax,0x8d8
}
 500:	5b                   	pop    %ebx
 501:	5e                   	pop    %esi
 502:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 558:	e8 54 ff ff ff       	call   4b1 <free>
  return freep;
 55d:	a1 d8 08 00 00       	mov    0x8d8,%eax
...
malloc(uint nbytes)
{
 ...
 581:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 584:	8b 0d d8 08 00 00    	mov    0x8d8,%ecx
 ...
 590:	eb 4d                	jmp    5df <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 592:	c7 05 d8 08 00 00 dc 	movl   $0x8dc,0x8d8
 599:	08 00 00 
 59c:	c7 05 dc 08 00 00 dc 	movl   $0x8dc,0x8dc
 5a3:	08 00 00 
    base.s.size = 0;
 5a6:	c7 05 e0 08 00 00 00 	movl   $0x0,0x8e0
 5ad:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 5b0:	b9 dc 08 00 00       	mov    $0x8dc,%ecx
 ...
 5c3:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5c6:	89 0d d8 08 00 00    	mov    %ecx,0x8d8
      return (void*)(p + 1);
 ...
 5e4:	73 d1                	jae    5b7 <malloc+0x46>
    if(p == freep)
 5e6:	39 05 d8 08 00 00    	cmp    %eax,0x8d8
