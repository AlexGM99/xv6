...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
   ...
   e:	68 50 0f 00 00       	push   $0xf50
  13:	6a 02                	push   $0x2
  15:	e8 7e 0c 00 00       	call   c98 <printf>
  memset(buf, 0, nbuf);
...
panic(char *s)
{
  ...
  54:	68 ed 0f 00 00       	push   $0xfed
  59:	6a 02                	push   $0x2
  5b:	e8 38 0c 00 00       	call   c98 <printf>
  exit();
...
00000084 <runcmd>:
{
  ...
  99:	ff 24 85 08 10 00 00 	jmp    *0x1008(,%eax,4)
    exit();
  a0:	e8 a9 0a 00 00       	call   b4e <exit>
    panic("runcmd");
  a5:	83 ec 0c             	sub    $0xc,%esp
  a8:	68 58 0f 00 00       	push   $0xf58
  ...
  cc:	68 5f 0f 00 00       	push   $0xf5f
  d1:	6a 02                	push   $0x2
  d3:	e8 c0 0b 00 00       	call   c98 <printf>
    break;
 ...
 10b:	68 6f 0f 00 00       	push   $0xf6f
 110:	6a 02                	push   $0x2
 112:	e8 81 0b 00 00       	call   c98 <printf>
      exit();
...
execcmd(void)
{
 ...
 231:	6a 54                	push   $0x54
 233:	e8 89 0c 00 00       	call   ec1 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
 ...
 258:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 25b:	6a 18                	push   $0x18
 25d:	e8 5f 0c 00 00       	call   ec1 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
 ...
 2a0:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2a3:	6a 0c                	push   $0xc
 2a5:	e8 17 0c 00 00       	call   ec1 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
 ...
 2d6:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2d9:	6a 0c                	push   $0xc
 2db:	e8 e1 0b 00 00       	call   ec1 <malloc>
...
backcmd(struct cmd *subcmd)
{
 ...
 30c:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 30f:	6a 08                	push   $0x8
 311:	e8 ab 0b 00 00       	call   ec1 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
 ...
 35b:	50                   	push   %eax
 35c:	68 bc 15 00 00       	push   $0x15bc
 ...
 3dd:	50                   	push   %eax
 3de:	68 bc 15 00 00       	push   $0x15bc
 ...
 3f5:	50                   	push   %eax
 3f6:	68 b4 15 00 00       	push   $0x15b4
 ...
 432:	50                   	push   %eax
 433:	68 bc 15 00 00       	push   $0x15bc
...
peek(char **ps, char *es, char *toks)
{
 ...
 473:	50                   	push   %eax
 474:	68 bc 15 00 00       	push   $0x15bc
...
parseexec(char **ps, char *es)
{
 ...
 649:	68 a6 0f 00 00       	push   $0xfa6
 64e:	e8 f8 f9 ff ff       	call   4b <panic>
      panic("too many args");
 653:	83 ec 0c             	sub    $0xc,%esp
 656:	68 ad 0f 00 00       	push   $0xfad
...
nulterminate(struct cmd *cmd)
{
 ...
 800:	ff 24 85 20 10 00 00 	jmp    *0x1020(,%eax,4)
  case EXEC:
...
00000882 <parsecmd>:
{
 ...
 8d5:	50                   	push   %eax
 8d6:	68 e2 0f 00 00       	push   $0xfe2
 8db:	6a 02                	push   $0x2
 8dd:	e8 b6 03 00 00       	call   c98 <printf>
    panic("syntax");
 8e2:	c7 04 24 a6 0f 00 00 	movl   $0xfa6,(%esp)
...
000008ee <main>:
{
 ...
 996:	68 f9 0f 00 00       	push   $0xff9
 99b:	6a 02                	push   $0x2
 99d:	e8 f6 02 00 00       	call   c98 <printf>
...
00000bce <dup2>:
SYSCALL(dup2)
 bce:	b8 17 00 00 00       	mov    $0x17,%eax
 bd3:	cd 40                	int    $0x40
 bd5:	c3                   	ret    
...
00000bf6 <date>:
SYSCALL(date)
 bf6:	b8 16 00 00 00       	mov    $0x16,%eax
 bfb:	cd 40                	int    $0x40
 bfd:	c3                   	ret    
...
putc(int fd, char c)
{
 ...
 c01:	83 ec 1c             	sub    $0x1c,%esp
 c04:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
 c07:	6a 01                	push   $0x1
 c09:	8d 55 f4             	lea    -0xc(%ebp),%edx
 c0c:	52                   	push   %edx
 c0d:	50                   	push   %eax
 c0e:	e8 5b ff ff ff       	call   b6e <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 c21:	89 c7                	mov    %eax,%edi
  ...
  neg = 0;
  if(sgn && xx < 0){
 c23:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 c27:	0f 95 c3             	setne  %bl
 c2a:	89 d0                	mov    %edx,%eax
 c2c:	c1 e8 1f             	shr    $0x1f,%eax
 c2f:	84 c3                	test   %al,%bl
 c31:	74 10                	je     c43 <printint+0x2b>
    neg = 1;
    x = -xx;
 c33:	f7 da                	neg    %edx
    neg = 1;
 c35:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }
 ...
 c41:	eb 0b                	jmp    c4e <printint+0x36>
  neg = 0;
 c43:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 c4a:	eb f0                	jmp    c3c <printint+0x24>
  do{
    buf[i++] = digits[x % base];
 ...
 c59:	8d 46 01             	lea    0x1(%esi),%eax
 c5c:	0f b6 92 40 10 00 00 	movzbl 0x1040(%edx),%edx
 c63:	88 54 35 d8          	mov    %dl,-0x28(%ebp,%esi,1)
  }while((x /= base) != 0);
 c67:	89 da                	mov    %ebx,%edx
 c69:	85 db                	test   %ebx,%ebx
 c6b:	75 df                	jne    c4c <printint+0x34>
 c6d:	89 c3                	mov    %eax,%ebx
  if(neg)
 c6f:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 c73:	74 16                	je     c8b <printint+0x73>
    buf[i++] = '-';
 c75:	c6 44 05 d8 2d       	movb   $0x2d,-0x28(%ebp,%eax,1)
 c7a:	8d 5e 02             	lea    0x2(%esi),%ebx
 c7d:	eb 0c                	jmp    c8b <printint+0x73>

  while(--i >= 0)
    putc(fd, buf[i]);
 c7f:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 c84:	89 f8                	mov    %edi,%eax
 c86:	e8 73 ff ff ff       	call   bfe <putc>
  while(--i >= 0)
 c8b:	83 eb 01             	sub    $0x1,%ebx
 c8e:	79 ef                	jns    c7f <printint+0x67>
}
 c90:	83 c4 2c             	add    $0x2c,%esp
 c93:	5b                   	pop    %ebx
 c94:	5e                   	pop    %esi
 c95:	5f                   	pop    %edi
 c96:	5d                   	pop    %ebp
...
printf(int fd, const char *fmt, ...)
{
 ...
 c9e:	83 ec 1c             	sub    $0x1c,%esp
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
 ca1:	8d 45 10             	lea    0x10(%ebp),%eax
 ca4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
 ca7:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
 cac:	bb 00 00 00 00       	mov    $0x0,%ebx
 cb1:	eb 14                	jmp    cc7 <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
 cb3:	89 fa                	mov    %edi,%edx
 cb5:	8b 45 08             	mov    0x8(%ebp),%eax
 cb8:	e8 41 ff ff ff       	call   bfe <putc>
 cbd:	eb 05                	jmp    cc4 <printf+0x2c>
      }
    } else if(state == '%'){
 cbf:	83 fe 25             	cmp    $0x25,%esi
 cc2:	74 25                	je     ce9 <printf+0x51>
  for(i = 0; fmt[i]; i++){
 cc4:	83 c3 01             	add    $0x1,%ebx
 cc7:	8b 45 0c             	mov    0xc(%ebp),%eax
 cca:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
 cce:	84 c0                	test   %al,%al
 cd0:	0f 84 23 01 00 00    	je     df9 <printf+0x161>
    c = fmt[i] & 0xff;
 cd6:	0f be f8             	movsbl %al,%edi
 cd9:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
 cdc:	85 f6                	test   %esi,%esi
 cde:	75 df                	jne    cbf <printf+0x27>
      if(c == '%'){
 ce0:	83 f8 25             	cmp    $0x25,%eax
 ce3:	75 ce                	jne    cb3 <printf+0x1b>
        state = '%';
 ce5:	89 c6                	mov    %eax,%esi
 ce7:	eb db                	jmp    cc4 <printf+0x2c>
      if(c == 'd'){
 ce9:	83 f8 64             	cmp    $0x64,%eax
 cec:	74 49                	je     d37 <printf+0x9f>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 cee:	83 f8 78             	cmp    $0x78,%eax
 cf1:	0f 94 c1             	sete   %cl
 cf4:	83 f8 70             	cmp    $0x70,%eax
 cf7:	0f 94 c2             	sete   %dl
 cfa:	08 d1                	or     %dl,%cl
 cfc:	75 63                	jne    d61 <printf+0xc9>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 cfe:	83 f8 73             	cmp    $0x73,%eax
 d01:	0f 84 84 00 00 00    	je     d8b <printf+0xf3>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 d0a:	0f 84 b7 00 00 00    	je     dc7 <printf+0x12f>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 d10:	83 f8 25             	cmp    $0x25,%eax
 d13:	0f 84 cc 00 00 00    	je     de5 <printf+0x14d>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 d19:	ba 25 00 00 00       	mov    $0x25,%edx
 d1e:	8b 45 08             	mov    0x8(%ebp),%eax
 d21:	e8 d8 fe ff ff       	call   bfe <putc>
        putc(fd, c);
 d26:	89 fa                	mov    %edi,%edx
 d28:	8b 45 08             	mov    0x8(%ebp),%eax
 d2b:	e8 ce fe ff ff       	call   bfe <putc>
      }
      state = 0;
 d30:	be 00 00 00 00       	mov    $0x0,%esi
 d35:	eb 8d                	jmp    cc4 <printf+0x2c>
        printint(fd, *ap, 10, 1);
 d37:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 d3a:	8b 17                	mov    (%edi),%edx
 d3c:	83 ec 0c             	sub    $0xc,%esp
 d3f:	6a 01                	push   $0x1
 d41:	b9 0a 00 00 00       	mov    $0xa,%ecx
 d46:	8b 45 08             	mov    0x8(%ebp),%eax
 d49:	e8 ca fe ff ff       	call   c18 <printint>
        ap++;
 d4e:	83 c7 04             	add    $0x4,%edi
 d51:	89 7d e4             	mov    %edi,-0x1c(%ebp)
 d54:	83 c4 10             	add    $0x10,%esp
      state = 0;
 d57:	be 00 00 00 00       	mov    $0x0,%esi
 d5c:	e9 63 ff ff ff       	jmp    cc4 <printf+0x2c>
        printint(fd, *ap, 16, 0);
 d61:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 d64:	8b 17                	mov    (%edi),%edx
 d66:	83 ec 0c             	sub    $0xc,%esp
 d69:	6a 00                	push   $0x0
 d6b:	b9 10 00 00 00       	mov    $0x10,%ecx
 d70:	8b 45 08             	mov    0x8(%ebp),%eax
 d73:	e8 a0 fe ff ff       	call   c18 <printint>
        ap++;
 d78:	83 c7 04             	add    $0x4,%edi
 d7b:	89 7d e4             	mov    %edi,-0x1c(%ebp)
 d7e:	83 c4 10             	add    $0x10,%esp
      state = 0;
 d81:	be 00 00 00 00       	mov    $0x0,%esi
 d86:	e9 39 ff ff ff       	jmp    cc4 <printf+0x2c>
        s = (char*)*ap;
 d8b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 d8e:	8b 30                	mov    (%eax),%esi
        ap++;
 d90:	83 c0 04             	add    $0x4,%eax
 d93:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
 d96:	85 f6                	test   %esi,%esi
 d98:	75 28                	jne    dc2 <printf+0x12a>
          s = "(null)";
 d9a:	be 38 10 00 00       	mov    $0x1038,%esi
 d9f:	8b 7d 08             	mov    0x8(%ebp),%edi
 da2:	eb 0d                	jmp    db1 <printf+0x119>
          putc(fd, *s);
 da4:	0f be d2             	movsbl %dl,%edx
 da7:	89 f8                	mov    %edi,%eax
 da9:	e8 50 fe ff ff       	call   bfe <putc>
          s++;
 dae:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 db1:	0f b6 16             	movzbl (%esi),%edx
 db4:	84 d2                	test   %dl,%dl
 db6:	75 ec                	jne    da4 <printf+0x10c>
      state = 0;
 db8:	be 00 00 00 00       	mov    $0x0,%esi
 dbd:	e9 02 ff ff ff       	jmp    cc4 <printf+0x2c>
 dc2:	8b 7d 08             	mov    0x8(%ebp),%edi
 dc5:	eb ea                	jmp    db1 <printf+0x119>
        putc(fd, *ap);
 dc7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 dca:	0f be 17             	movsbl (%edi),%edx
 dcd:	8b 45 08             	mov    0x8(%ebp),%eax
 dd0:	e8 29 fe ff ff       	call   bfe <putc>
        ap++;
 dd5:	83 c7 04             	add    $0x4,%edi
 dd8:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 ddb:	be 00 00 00 00       	mov    $0x0,%esi
 de0:	e9 df fe ff ff       	jmp    cc4 <printf+0x2c>
        putc(fd, c);
 de5:	89 fa                	mov    %edi,%edx
 de7:	8b 45 08             	mov    0x8(%ebp),%eax
 dea:	e8 0f fe ff ff       	call   bfe <putc>
      state = 0;
 def:	be 00 00 00 00       	mov    $0x0,%esi
 df4:	e9 cb fe ff ff       	jmp    cc4 <printf+0x2c>
    }
  }
}
...
free(void *ap)
{
 ...
 e0d:	a1 44 16 00 00       	mov    0x1644,%eax
 ...
 e49:	89 08                	mov    %ecx,(%eax)
  freep = p;
 e4b:	a3 44 16 00 00       	mov    %eax,0x1644
}
 e50:	5b                   	pop    %ebx
 e51:	5e                   	pop    %esi
 e52:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 e90:	50                   	push   %eax
 e91:	e8 48 fd ff ff       	call   bde <sbrk>
  if(p == (char*)-1)
 ...
 ea8:	e8 54 ff ff ff       	call   e01 <free>
  return freep;
 ead:	a1 44 16 00 00       	mov    0x1644,%eax
...
malloc(uint nbytes)
{
 ...
 ed1:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 ed4:	8b 0d 44 16 00 00    	mov    0x1644,%ecx
 eda:	85 c9                	test   %ecx,%ecx
 edc:	74 04                	je     ee2 <malloc+0x21>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ede:	8b 01                	mov    (%ecx),%eax
 ee0:	eb 4d                	jmp    f2f <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 ee2:	c7 05 44 16 00 00 48 	movl   $0x1648,0x1644
 ee9:	16 00 00 
 eec:	c7 05 48 16 00 00 48 	movl   $0x1648,0x1648
 ef3:	16 00 00 
    base.s.size = 0;
 ef6:	c7 05 4c 16 00 00 00 	movl   $0x0,0x164c
 efd:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 f00:	b9 48 16 00 00       	mov    $0x1648,%ecx
 f05:	eb d7                	jmp    ede <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
 f07:	39 da                	cmp    %ebx,%edx
 f09:	74 1a                	je     f25 <malloc+0x64>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
 f0b:	29 da                	sub    %ebx,%edx
 f0d:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
 f10:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
 f13:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
 f16:	89 0d 44 16 00 00    	mov    %ecx,0x1644
      return (void*)(p + 1);
 f1c:	83 c0 08             	add    $0x8,%eax
    }
    if(p == freep)
 ...
 f24:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
 f25:	8b 10                	mov    (%eax),%edx
 f27:	89 11                	mov    %edx,(%ecx)
 f29:	eb eb                	jmp    f16 <malloc+0x55>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 f2b:	89 c1                	mov    %eax,%ecx
 f2d:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
 f2f:	8b 50 04             	mov    0x4(%eax),%edx
 f32:	39 da                	cmp    %ebx,%edx
 f34:	73 d1                	jae    f07 <malloc+0x46>
    if(p == freep)
 f36:	39 05 44 16 00 00    	cmp    %eax,0x1644
 f3c:	75 ed                	jne    f2b <malloc+0x6a>
      if((p = morecore(nunits)) == 0)
 f3e:	89 d8                	mov    %ebx,%eax
 f40:	e8 2c ff ff ff       	call   e71 <morecore>
 f45:	85 c0                	test   %eax,%eax
 f47:	75 e2                	jne    f2b <malloc+0x6a>
        return 0;
 f49:	b8 00 00 00 00       	mov    $0x0,%eax
 f4e:	eb cf                	jmp    f1f <malloc+0x5e>
