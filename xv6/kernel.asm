...
80100373:	e8 93 02 00 00       	call   8010060b <cprintf>
  cprintf("\n");
80100378:	c7 04 24 5f 6e 10 80 	movl   $0x80106e5f,(%esp)
...
80100506:	e8 c2 4b 00 00       	call   801050cd <uartputc>
...
8010051f:	e8 a9 4b 00 00       	call   801050cd <uartputc>
80100524:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010052b:	e8 9d 4b 00 00       	call   801050cd <uartputc>
80100530:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100537:	e8 91 4b 00 00       	call   801050cd <uartputc>
...
80100970:	75 b2                	jne    80100924 <exec+0x52>
  if((pgdir = setupkvm()) == 0)
80100972:	e8 16 59 00 00       	call   8010628d <setupkvm>
...
80100a06:	e8 28 57 00 00       	call   80106133 <allocuvm>
...
80100a38:	e8 c4 55 00 00       	call   80106001 <loaduvm>
...
80100a74:	e8 ba 56 00 00       	call   80106133 <allocuvm>
...
80100a9d:	e8 7b 57 00 00       	call   8010621d <freevm>
...
80100abc:	e8 51 58 00 00       	call   80106312 <clearpteu>
...
80100b06:	e8 55 59 00 00       	call   80106460 <copyout>
...
80100b66:	e8 f5 58 00 00       	call   80106460 <copyout>
...
80100bd1:	e8 aa 52 00 00       	call   80105e80 <switchuvm>
  freevm(oldpgdir);
80100bd6:	89 1c 24             	mov    %ebx,(%esp)
80100bd9:	e8 3f 56 00 00       	call   8010621d <freevm>
  return 0;
...
80101bd7:	68 58 6c 10 80       	push   $0x80106c58
...
80102a2d:	e8 33 24 00 00       	call   80104e65 <idtinit>
...
80102a4d:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102a50:	e8 19 34 00 00       	call   80105e6e <switchkvm>
  seginit();
80102a55:	e8 c8 32 00 00       	call   80105d22 <seginit>
  lapicinit();
...
80102aa7:	e8 67 26 00 00       	call   80105113 <uartinit>
  pinit();         // process table
80102aac:	e8 b4 06 00 00       	call   80103165 <pinit>
  tvinit();        // trap vectors
80102ab1:	e8 fe 22 00 00       	call   80104db4 <tvinit>
  binit();         // buffer cache
...
801030e1:	c7 80 b0 0f 00 00 a9 	movl   $0x80104da9,0xfb0(%eax)
801030e8:	4d 10 80 
  sp -= sizeof *p->context;
...
8010322d:	e8 5b 30 00 00       	call   8010628d <setupkvm>
...
8010324b:	e8 48 2d 00 00       	call   80105f98 <inituvm>
  p->sz = PGSIZE;
...
80103324:	e8 78 2d 00 00       	call   801060a1 <deallocuvm>
...
80103341:	e8 ed 2d 00 00       	call   80106133 <allocuvm>
...
80103353:	e8 28 2b 00 00       	call   80105e80 <switchuvm>
  return 0;
...
80103398:	e8 a1 2f 00 00       	call   8010633e <copyuvm>
...
801034a8:	e8 d3 29 00 00       	call   80105e80 <switchuvm>
      p->state = RUNNING;
...
801034be:	e8 38 09 00 00       	call   80103dfb <swtch>
      switchkvm();
801034c3:	e8 a6 29 00 00       	call   80105e6e <switchkvm>
      c->proc = 0;
...
8010376e:	e8 aa 2a 00 00       	call   8010621d <freevm>
        p->pid = 0;
...
801038ce:	68 5f 6e 10 80       	push   $0x80106e5f
...
80103958:	68 58 6b 10 80       	push   $0x80106b58
...
80103b2d:	68 63 6b 10 80       	push   $0x80106b63
80103b32:	e8 11 c8 ff ff       	call   80100348 <panic>
    panic("popcli");
80103b37:	83 ec 0c             	sub    $0xc,%esp
80103b3a:	68 7a 6b 10 80       	push   $0x80106b7a
...
80103bf0:	68 81 6b 10 80       	push   $0x80106b81
...
80103c37:	68 89 6b 10 80       	push   $0x80106b89
...
80103f6b:	8b 14 85 c0 6b 10 80 	mov    -0x7fef9440(,%eax,4),%edx
...
80103f8b:	68 91 6b 10 80       	push   $0x80106b91
...
8010407c:	68 20 6c 10 80       	push   $0x80106c20
...
80104194:	68 32 6c 10 80       	push   $0x80106c32
...
801041b8:	68 42 6c 10 80       	push   $0x80106c42
...
801041d0:	68 41 6c 10 80       	push   $0x80106c41
...
801041e5:	68 44 6c 10 80       	push   $0x80106c44
801041ea:	e8 59 c1 ff ff       	call   80100348 <panic>
    panic("create: dirlink");
801041ef:	83 ec 0c             	sub    $0xc,%esp
801041f2:	68 50 6c 10 80       	push   $0x80106c50
...
8010460a:	68 42 6c 10 80       	push   $0x80106c42
...
80104626:	68 41 6c 10 80       	push   $0x80106c41
...
801046fa:	68 60 6c 10 80       	push   $0x80106c60
...
8010473a:	68 72 6c 10 80       	push   $0x80106c72
...
80104c6c:	78 27                	js     80104c95 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
...
80104c7b:	e8 81 e6 ff ff       	call   80103301 <growproc>
80104c80:	83 c4 10             	add    $0x10,%esp
80104c83:	85 c0                	test   %eax,%eax
80104c85:	78 07                	js     80104c8e <sys_sbrk+0x39>
    return -1;
  return addr;
}
80104c87:	89 d8                	mov    %ebx,%eax
80104c89:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104c8c:	c9                   	leave  
80104c8d:	c3                   	ret    
    return -1;
80104c8e:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104c93:	eb f2                	jmp    80104c87 <sys_sbrk+0x32>
    return -1;
80104c95:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104c9a:	eb eb                	jmp    80104c87 <sys_sbrk+0x32>
...
80104ca0:	83 ec 1c             	sub    $0x1c,%esp
  int n;
  uint ticks0;

  if(argint(0, &n) < 0)
80104ca3:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104ca6:	50                   	push   %eax
80104ca7:	6a 00                	push   $0x0
80104ca9:	e8 de f1 ff ff       	call   80103e8c <argint>
80104cae:	83 c4 10             	add    $0x10,%esp
80104cb1:	85 c0                	test   %eax,%eax
80104cb3:	78 75                	js     80104d2a <sys_sleep+0x8e>
    return -1;
  acquire(&tickslock);
80104cb5:	83 ec 0c             	sub    $0xc,%esp
80104cb8:	68 60 3c 11 80       	push   $0x80113c60
80104cbd:	e8 d3 ee ff ff       	call   80103b95 <acquire>
  ticks0 = ticks;
80104cc2:	8b 1d a0 44 11 80    	mov    0x801144a0,%ebx
  while(ticks - ticks0 < n){
80104cc8:	83 c4 10             	add    $0x10,%esp
80104ccb:	a1 a0 44 11 80       	mov    0x801144a0,%eax
80104cd0:	29 d8                	sub    %ebx,%eax
80104cd2:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104cd5:	73 39                	jae    80104d10 <sys_sleep+0x74>
    if(myproc()->killed){
80104cd7:	e8 1a e5 ff ff       	call   801031f6 <myproc>
80104cdc:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104ce0:	75 17                	jne    80104cf9 <sys_sleep+0x5d>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
80104ce2:	83 ec 08             	sub    $0x8,%esp
80104ce5:	68 60 3c 11 80       	push   $0x80113c60
80104cea:	68 a0 44 11 80       	push   $0x801144a0
80104cef:	e8 a6 e9 ff ff       	call   8010369a <sleep>
80104cf4:	83 c4 10             	add    $0x10,%esp
80104cf7:	eb d2                	jmp    80104ccb <sys_sleep+0x2f>
      release(&tickslock);
80104cf9:	83 ec 0c             	sub    $0xc,%esp
80104cfc:	68 60 3c 11 80       	push   $0x80113c60
80104d01:	e8 f4 ee ff ff       	call   80103bfa <release>
      return -1;
80104d06:	83 c4 10             	add    $0x10,%esp
80104d09:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d0e:	eb 15                	jmp    80104d25 <sys_sleep+0x89>
  }
  release(&tickslock);
80104d10:	83 ec 0c             	sub    $0xc,%esp
80104d13:	68 60 3c 11 80       	push   $0x80113c60
80104d18:	e8 dd ee ff ff       	call   80103bfa <release>
  return 0;
...
80104d2f:	eb f4                	jmp    80104d25 <sys_sleep+0x89>
...
80104d35:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80104d38:	68 60 3c 11 80       	push   $0x80113c60
80104d3d:	e8 53 ee ff ff       	call   80103b95 <acquire>
  xticks = ticks;
80104d42:	8b 1d a0 44 11 80    	mov    0x801144a0,%ebx
  release(&tickslock);
80104d48:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80104d4f:	e8 a6 ee ff ff       	call   80103bfa <release>
  return xticks;
}
80104d54:	89 d8                	mov    %ebx,%eax
80104d56:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104d59:	c9                   	leave  
80104d5a:	c3                   	ret    
...
80104d8f:	eb f7                	jmp    80104d88 <sys_date+0x2d>
...
80104d92:	06                   	push   %es
  pushl %fs
80104d93:	0f a0                	push   %fs
  pushl %gs
80104d95:	0f a8                	push   %gs
  pushal
80104d97:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80104d98:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80104d9c:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80104d9e:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80104da0:	54                   	push   %esp
  call trap
80104da1:	e8 e3 00 00 00       	call   80104e89 <trap>
  addl $4, %esp
...
80104da9:	61                   	popa   
  popl %gs
80104daa:	0f a9                	pop    %gs
  popl %fs
80104dac:	0f a1                	pop    %fs
  popl %es
80104dae:	07                   	pop    %es
  popl %ds
80104daf:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80104db0:	83 c4 08             	add    $0x8,%esp
  iret
80104db3:	cf                   	iret   
...
80104db7:	83 ec 08             	sub    $0x8,%esp
  ...
  for(i = 0; i < 256; i++)
80104dba:	b8 00 00 00 00       	mov    $0x0,%eax
80104dbf:	eb 4a                	jmp    80104e0b <tvinit+0x57>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80104dc1:	8b 0c 85 08 90 10 80 	mov    -0x7fef6ff8(,%eax,4),%ecx
80104dc8:	66 89 0c c5 a0 3c 11 	mov    %cx,-0x7feec360(,%eax,8)
80104dcf:	80 
80104dd0:	66 c7 04 c5 a2 3c 11 	movw   $0x8,-0x7feec35e(,%eax,8)
80104dd7:	80 08 00 
80104dda:	c6 04 c5 a4 3c 11 80 	movb   $0x0,-0x7feec35c(,%eax,8)
80104de1:	00 
80104de2:	0f b6 14 c5 a5 3c 11 	movzbl -0x7feec35b(,%eax,8),%edx
80104de9:	80 
80104dea:	83 e2 f0             	and    $0xfffffff0,%edx
80104ded:	83 ca 0e             	or     $0xe,%edx
80104df0:	83 e2 8f             	and    $0xffffff8f,%edx
80104df3:	83 ca 80             	or     $0xffffff80,%edx
80104df6:	88 14 c5 a5 3c 11 80 	mov    %dl,-0x7feec35b(,%eax,8)
80104dfd:	c1 e9 10             	shr    $0x10,%ecx
80104e00:	66 89 0c c5 a6 3c 11 	mov    %cx,-0x7feec35a(,%eax,8)
80104e07:	80 
  for(i = 0; i < 256; i++)
80104e08:	83 c0 01             	add    $0x1,%eax
80104e0b:	3d ff 00 00 00       	cmp    $0xff,%eax
80104e10:	7e af                	jle    80104dc1 <tvinit+0xd>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80104e12:	8b 15 08 91 10 80    	mov    0x80109108,%edx
80104e18:	66 89 15 a0 3e 11 80 	mov    %dx,0x80113ea0
80104e1f:	66 c7 05 a2 3e 11 80 	movw   $0x8,0x80113ea2
80104e26:	08 00 
80104e28:	c6 05 a4 3e 11 80 00 	movb   $0x0,0x80113ea4
80104e2f:	0f b6 05 a5 3e 11 80 	movzbl 0x80113ea5,%eax
80104e36:	83 c8 0f             	or     $0xf,%eax
80104e39:	83 e0 ef             	and    $0xffffffef,%eax
80104e3c:	83 c8 e0             	or     $0xffffffe0,%eax
80104e3f:	a2 a5 3e 11 80       	mov    %al,0x80113ea5
80104e44:	c1 ea 10             	shr    $0x10,%edx
80104e47:	66 89 15 a6 3e 11 80 	mov    %dx,0x80113ea6

  initlock(&tickslock, "time");
80104e4e:	83 ec 08             	sub    $0x8,%esp
80104e51:	68 81 6c 10 80       	push   $0x80106c81
80104e56:	68 60 3c 11 80       	push   $0x80113c60
80104e5b:	e8 f9 eb ff ff       	call   80103a59 <initlock>
}
...
80104e68:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80104e6b:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
80104e71:	b8 a0 3c 11 80       	mov    $0x80113ca0,%eax
80104e76:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80104e7a:	c1 e8 10             	shr    $0x10,%eax
80104e7d:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80104e81:	8d 45 fa             	lea    -0x6(%ebp),%eax
80104e84:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80104e87:	c9                   	leave  
80104e88:	c3                   	ret    
...
80104e8f:	83 ec 1c             	sub    $0x1c,%esp
80104e92:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80104e95:	8b 43 30             	mov    0x30(%ebx),%eax
80104e98:	83 f8 40             	cmp    $0x40,%eax
80104e9b:	74 13                	je     80104eb0 <trap+0x27>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80104e9d:	83 e8 20             	sub    $0x20,%eax
80104ea0:	83 f8 1f             	cmp    $0x1f,%eax
80104ea3:	0f 87 3a 01 00 00    	ja     80104fe3 <trap+0x15a>
80104ea9:	ff 24 85 28 6d 10 80 	jmp    *-0x7fef92d8(,%eax,4)
    if(myproc()->killed)
80104eb0:	e8 41 e3 ff ff       	call   801031f6 <myproc>
80104eb5:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104eb9:	75 1f                	jne    80104eda <trap+0x51>
    myproc()->tf = tf;
80104ebb:	e8 36 e3 ff ff       	call   801031f6 <myproc>
80104ec0:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80104ec3:	e8 87 f0 ff ff       	call   80103f4f <syscall>
    if(myproc()->killed)
80104ec8:	e8 29 e3 ff ff       	call   801031f6 <myproc>
80104ecd:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104ed1:	74 7e                	je     80104f51 <trap+0xc8>
      exit();
80104ed3:	e8 ca e6 ff ff       	call   801035a2 <exit>
80104ed8:	eb 77                	jmp    80104f51 <trap+0xc8>
      exit();
80104eda:	e8 c3 e6 ff ff       	call   801035a2 <exit>
80104edf:	eb da                	jmp    80104ebb <trap+0x32>
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80104ee1:	e8 f5 e2 ff ff       	call   801031db <cpuid>
80104ee6:	85 c0                	test   %eax,%eax
80104ee8:	74 6f                	je     80104f59 <trap+0xd0>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
80104eea:	e8 aa d4 ff ff       	call   80102399 <lapiceoi>
  }
...
80104eef:	e8 02 e3 ff ff       	call   801031f6 <myproc>
80104ef4:	85 c0                	test   %eax,%eax
80104ef6:	74 1c                	je     80104f14 <trap+0x8b>
80104ef8:	e8 f9 e2 ff ff       	call   801031f6 <myproc>
80104efd:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f01:	74 11                	je     80104f14 <trap+0x8b>
80104f03:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104f07:	83 e0 03             	and    $0x3,%eax
80104f0a:	66 83 f8 03          	cmp    $0x3,%ax
80104f0e:	0f 84 62 01 00 00    	je     80105076 <trap+0x1ed>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80104f14:	e8 dd e2 ff ff       	call   801031f6 <myproc>
80104f19:	85 c0                	test   %eax,%eax
80104f1b:	74 0f                	je     80104f2c <trap+0xa3>
80104f1d:	e8 d4 e2 ff ff       	call   801031f6 <myproc>
80104f22:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80104f26:	0f 84 54 01 00 00    	je     80105080 <trap+0x1f7>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80104f2c:	e8 c5 e2 ff ff       	call   801031f6 <myproc>
80104f31:	85 c0                	test   %eax,%eax
80104f33:	74 1c                	je     80104f51 <trap+0xc8>
80104f35:	e8 bc e2 ff ff       	call   801031f6 <myproc>
80104f3a:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f3e:	74 11                	je     80104f51 <trap+0xc8>
80104f40:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104f44:	83 e0 03             	and    $0x3,%eax
80104f47:	66 83 f8 03          	cmp    $0x3,%ax
80104f4b:	0f 84 43 01 00 00    	je     80105094 <trap+0x20b>
    exit();
}
...
80104f5c:	68 60 3c 11 80       	push   $0x80113c60
80104f61:	e8 2f ec ff ff       	call   80103b95 <acquire>
      ticks++;
80104f66:	83 05 a0 44 11 80 01 	addl   $0x1,0x801144a0
      wakeup(&ticks);
80104f6d:	c7 04 24 a0 44 11 80 	movl   $0x801144a0,(%esp)
80104f74:	e8 86 e8 ff ff       	call   801037ff <wakeup>
      release(&tickslock);
80104f79:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80104f80:	e8 75 ec ff ff       	call   80103bfa <release>
80104f85:	83 c4 10             	add    $0x10,%esp
80104f88:	e9 5d ff ff ff       	jmp    80104eea <trap+0x61>
    ideintr();
80104f8d:	e8 e1 cd ff ff       	call   80101d73 <ideintr>
    lapiceoi();
80104f92:	e8 02 d4 ff ff       	call   80102399 <lapiceoi>
    break;
80104f97:	e9 53 ff ff ff       	jmp    80104eef <trap+0x66>
    kbdintr();
80104f9c:	e8 3c d2 ff ff       	call   801021dd <kbdintr>
    lapiceoi();
80104fa1:	e8 f3 d3 ff ff       	call   80102399 <lapiceoi>
    break;
80104fa6:	e9 44 ff ff ff       	jmp    80104eef <trap+0x66>
    uartintr();
80104fab:	e8 05 02 00 00       	call   801051b5 <uartintr>
    lapiceoi();
80104fb0:	e8 e4 d3 ff ff       	call   80102399 <lapiceoi>
    break;
80104fb5:	e9 35 ff ff ff       	jmp    80104eef <trap+0x66>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80104fba:	8b 7b 38             	mov    0x38(%ebx),%edi
            cpuid(), tf->cs, tf->eip);
80104fbd:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80104fc1:	e8 15 e2 ff ff       	call   801031db <cpuid>
80104fc6:	57                   	push   %edi
80104fc7:	0f b7 f6             	movzwl %si,%esi
80104fca:	56                   	push   %esi
80104fcb:	50                   	push   %eax
80104fcc:	68 8c 6c 10 80       	push   $0x80106c8c
80104fd1:	e8 35 b6 ff ff       	call   8010060b <cprintf>
    lapiceoi();
80104fd6:	e8 be d3 ff ff       	call   80102399 <lapiceoi>
    break;
80104fdb:	83 c4 10             	add    $0x10,%esp
80104fde:	e9 0c ff ff ff       	jmp    80104eef <trap+0x66>
    if(myproc() == 0 || (tf->cs&3) == 0){
80104fe3:	e8 0e e2 ff ff       	call   801031f6 <myproc>
80104fe8:	85 c0                	test   %eax,%eax
80104fea:	74 5f                	je     8010504b <trap+0x1c2>
80104fec:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80104ff0:	74 59                	je     8010504b <trap+0x1c2>
...
80104ff2:	0f 20 d7             	mov    %cr2,%edi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80104ff5:	8b 43 38             	mov    0x38(%ebx),%eax
80104ff8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80104ffb:	e8 db e1 ff ff       	call   801031db <cpuid>
80105000:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105003:	8b 53 34             	mov    0x34(%ebx),%edx
80105006:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105009:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
8010500c:	e8 e5 e1 ff ff       	call   801031f6 <myproc>
80105011:	8d 48 6c             	lea    0x6c(%eax),%ecx
80105014:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105017:	e8 da e1 ff ff       	call   801031f6 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010501c:	57                   	push   %edi
8010501d:	ff 75 e4             	pushl  -0x1c(%ebp)
80105020:	ff 75 e0             	pushl  -0x20(%ebp)
80105023:	ff 75 dc             	pushl  -0x24(%ebp)
80105026:	56                   	push   %esi
80105027:	ff 75 d8             	pushl  -0x28(%ebp)
8010502a:	ff 70 10             	pushl  0x10(%eax)
8010502d:	68 e4 6c 10 80       	push   $0x80106ce4
80105032:	e8 d4 b5 ff ff       	call   8010060b <cprintf>
    myproc()->killed = 1;
80105037:	83 c4 20             	add    $0x20,%esp
8010503a:	e8 b7 e1 ff ff       	call   801031f6 <myproc>
8010503f:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80105046:	e9 a4 fe ff ff       	jmp    80104eef <trap+0x66>
8010504b:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010504e:	8b 73 38             	mov    0x38(%ebx),%esi
80105051:	e8 85 e1 ff ff       	call   801031db <cpuid>
80105056:	83 ec 0c             	sub    $0xc,%esp
80105059:	57                   	push   %edi
8010505a:	56                   	push   %esi
8010505b:	50                   	push   %eax
8010505c:	ff 73 30             	pushl  0x30(%ebx)
8010505f:	68 b0 6c 10 80       	push   $0x80106cb0
80105064:	e8 a2 b5 ff ff       	call   8010060b <cprintf>
      panic("trap");
80105069:	83 c4 14             	add    $0x14,%esp
8010506c:	68 86 6c 10 80       	push   $0x80106c86
80105071:	e8 d2 b2 ff ff       	call   80100348 <panic>
    exit();
80105076:	e8 27 e5 ff ff       	call   801035a2 <exit>
8010507b:	e9 94 fe ff ff       	jmp    80104f14 <trap+0x8b>
  if(myproc() && myproc()->state == RUNNING &&
80105080:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105084:	0f 85 a2 fe ff ff    	jne    80104f2c <trap+0xa3>
    yield();
8010508a:	e8 d9 e5 ff ff       	call   80103668 <yield>
8010508f:	e9 98 fe ff ff       	jmp    80104f2c <trap+0xa3>
    exit();
80105094:	e8 09 e5 ff ff       	call   801035a2 <exit>
80105099:	e9 b3 fe ff ff       	jmp    80104f51 <trap+0xc8>
...
8010509f:	89 e5                	mov    %esp,%ebp
  if(!uart)
801050a1:	83 3d bc 95 10 80 00 	cmpl   $0x0,0x801095bc
801050a8:	74 15                	je     801050bf <uartgetc+0x21>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801050aa:	ba fd 03 00 00       	mov    $0x3fd,%edx
801050af:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
801050b0:	a8 01                	test   $0x1,%al
801050b2:	74 12                	je     801050c6 <uartgetc+0x28>
801050b4:	ba f8 03 00 00       	mov    $0x3f8,%edx
801050b9:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
801050ba:	0f b6 c0             	movzbl %al,%eax
}
801050bd:	5d                   	pop    %ebp
801050be:	c3                   	ret    
    return -1;
801050bf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050c4:	eb f7                	jmp    801050bd <uartgetc+0x1f>
    return -1;
801050c6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050cb:	eb f0                	jmp    801050bd <uartgetc+0x1f>

801050cd <uartputc>:
  if(!uart)
801050cd:	83 3d bc 95 10 80 00 	cmpl   $0x0,0x801095bc
801050d4:	74 3b                	je     80105111 <uartputc+0x44>
{
...
801050dd:	bb 00 00 00 00       	mov    $0x0,%ebx
801050e2:	eb 10                	jmp    801050f4 <uartputc+0x27>
    microdelay(10);
801050e4:	83 ec 0c             	sub    $0xc,%esp
801050e7:	6a 0a                	push   $0xa
801050e9:	e8 ca d2 ff ff       	call   801023b8 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801050ee:	83 c3 01             	add    $0x1,%ebx
801050f1:	83 c4 10             	add    $0x10,%esp
801050f4:	83 fb 7f             	cmp    $0x7f,%ebx
801050f7:	7f 0a                	jg     80105103 <uartputc+0x36>
801050f9:	ba fd 03 00 00       	mov    $0x3fd,%edx
801050fe:	ec                   	in     (%dx),%al
801050ff:	a8 20                	test   $0x20,%al
80105101:	74 e1                	je     801050e4 <uartputc+0x17>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105103:	8b 45 08             	mov    0x8(%ebp),%eax
80105106:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010510b:	ee                   	out    %al,(%dx)
}
8010510c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010510f:	c9                   	leave  
80105110:	c3                   	ret    
80105111:	f3 c3                	repz ret 
...
80105118:	b9 00 00 00 00       	mov    $0x0,%ecx
8010511d:	ba fa 03 00 00       	mov    $0x3fa,%edx
80105122:	89 c8                	mov    %ecx,%eax
80105124:	ee                   	out    %al,(%dx)
80105125:	be fb 03 00 00       	mov    $0x3fb,%esi
8010512a:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
8010512f:	89 f2                	mov    %esi,%edx
80105131:	ee                   	out    %al,(%dx)
80105132:	b8 0c 00 00 00       	mov    $0xc,%eax
80105137:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010513c:	ee                   	out    %al,(%dx)
8010513d:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80105142:	89 c8                	mov    %ecx,%eax
80105144:	89 da                	mov    %ebx,%edx
80105146:	ee                   	out    %al,(%dx)
80105147:	b8 03 00 00 00       	mov    $0x3,%eax
8010514c:	89 f2                	mov    %esi,%edx
8010514e:	ee                   	out    %al,(%dx)
8010514f:	ba fc 03 00 00       	mov    $0x3fc,%edx
80105154:	89 c8                	mov    %ecx,%eax
80105156:	ee                   	out    %al,(%dx)
80105157:	b8 01 00 00 00       	mov    $0x1,%eax
8010515c:	89 da                	mov    %ebx,%edx
8010515e:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010515f:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105164:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105165:	3c ff                	cmp    $0xff,%al
80105167:	74 45                	je     801051ae <uartinit+0x9b>
  uart = 1;
80105169:	c7 05 bc 95 10 80 01 	movl   $0x1,0x801095bc
80105170:	00 00 00 
80105173:	ba fa 03 00 00       	mov    $0x3fa,%edx
80105178:	ec                   	in     (%dx),%al
80105179:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010517e:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
8010517f:	83 ec 08             	sub    $0x8,%esp
80105182:	6a 00                	push   $0x0
80105184:	6a 04                	push   $0x4
80105186:	e8 f3 cd ff ff       	call   80101f7e <ioapicenable>
  for(p="xv6...\n"; *p; p++)
8010518b:	83 c4 10             	add    $0x10,%esp
8010518e:	bb a8 6d 10 80       	mov    $0x80106da8,%ebx
80105193:	eb 12                	jmp    801051a7 <uartinit+0x94>
    uartputc(*p);
80105195:	83 ec 0c             	sub    $0xc,%esp
80105198:	0f be c0             	movsbl %al,%eax
8010519b:	50                   	push   %eax
8010519c:	e8 2c ff ff ff       	call   801050cd <uartputc>
  for(p="xv6...\n"; *p; p++)
801051a1:	83 c3 01             	add    $0x1,%ebx
801051a4:	83 c4 10             	add    $0x10,%esp
801051a7:	0f b6 03             	movzbl (%ebx),%eax
801051aa:	84 c0                	test   %al,%al
801051ac:	75 e7                	jne    80105195 <uartinit+0x82>
}
...
801051b8:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
801051bb:	68 9e 50 10 80       	push   $0x8010509e
801051c0:	e8 79 b5 ff ff       	call   8010073e <consoleintr>
}
...
801051cc:	6a 00                	push   $0x0
  jmp alltraps
801051ce:	e9 be fb ff ff       	jmp    80104d91 <alltraps>
...
801051d3:	6a 00                	push   $0x0
  pushl $1
801051d5:	6a 01                	push   $0x1
  jmp alltraps
801051d7:	e9 b5 fb ff ff       	jmp    80104d91 <alltraps>
...
801051dc:	6a 00                	push   $0x0
  pushl $2
801051de:	6a 02                	push   $0x2
  jmp alltraps
801051e0:	e9 ac fb ff ff       	jmp    80104d91 <alltraps>
...
801051e5:	6a 00                	push   $0x0
  pushl $3
801051e7:	6a 03                	push   $0x3
  jmp alltraps
801051e9:	e9 a3 fb ff ff       	jmp    80104d91 <alltraps>
...
801051ee:	6a 00                	push   $0x0
  pushl $4
801051f0:	6a 04                	push   $0x4
  jmp alltraps
801051f2:	e9 9a fb ff ff       	jmp    80104d91 <alltraps>
...
801051f7:	6a 00                	push   $0x0
  pushl $5
801051f9:	6a 05                	push   $0x5
  jmp alltraps
801051fb:	e9 91 fb ff ff       	jmp    80104d91 <alltraps>
...
80105200:	6a 00                	push   $0x0
  pushl $6
80105202:	6a 06                	push   $0x6
  jmp alltraps
80105204:	e9 88 fb ff ff       	jmp    80104d91 <alltraps>
...
80105209:	6a 00                	push   $0x0
  pushl $7
8010520b:	6a 07                	push   $0x7
  jmp alltraps
8010520d:	e9 7f fb ff ff       	jmp    80104d91 <alltraps>

80105212 <vector8>:
.globl vector8
vector8:
  pushl $8
80105212:	6a 08                	push   $0x8
  jmp alltraps
80105214:	e9 78 fb ff ff       	jmp    80104d91 <alltraps>
...
80105219:	6a 00                	push   $0x0
  pushl $9
8010521b:	6a 09                	push   $0x9
  jmp alltraps
8010521d:	e9 6f fb ff ff       	jmp    80104d91 <alltraps>
...
80105222:	6a 0a                	push   $0xa
  jmp alltraps
80105224:	e9 68 fb ff ff       	jmp    80104d91 <alltraps>

80105229 <vector11>:
.globl vector11
vector11:
  pushl $11
80105229:	6a 0b                	push   $0xb
  jmp alltraps
8010522b:	e9 61 fb ff ff       	jmp    80104d91 <alltraps>

80105230 <vector12>:
.globl vector12
vector12:
  pushl $12
80105230:	6a 0c                	push   $0xc
  jmp alltraps
80105232:	e9 5a fb ff ff       	jmp    80104d91 <alltraps>

80105237 <vector13>:
.globl vector13
vector13:
  pushl $13
80105237:	6a 0d                	push   $0xd
  jmp alltraps
80105239:	e9 53 fb ff ff       	jmp    80104d91 <alltraps>

8010523e <vector14>:
.globl vector14
vector14:
  pushl $14
8010523e:	6a 0e                	push   $0xe
  jmp alltraps
80105240:	e9 4c fb ff ff       	jmp    80104d91 <alltraps>
...
80105245:	6a 00                	push   $0x0
  pushl $15
80105247:	6a 0f                	push   $0xf
  jmp alltraps
80105249:	e9 43 fb ff ff       	jmp    80104d91 <alltraps>
...
8010524e:	6a 00                	push   $0x0
  pushl $16
80105250:	6a 10                	push   $0x10
  jmp alltraps
80105252:	e9 3a fb ff ff       	jmp    80104d91 <alltraps>

80105257 <vector17>:
.globl vector17
vector17:
  pushl $17
80105257:	6a 11                	push   $0x11
  jmp alltraps
80105259:	e9 33 fb ff ff       	jmp    80104d91 <alltraps>
...
8010525e:	6a 00                	push   $0x0
  pushl $18
80105260:	6a 12                	push   $0x12
  jmp alltraps
80105262:	e9 2a fb ff ff       	jmp    80104d91 <alltraps>
...
80105267:	6a 00                	push   $0x0
  pushl $19
80105269:	6a 13                	push   $0x13
  jmp alltraps
8010526b:	e9 21 fb ff ff       	jmp    80104d91 <alltraps>
...
80105270:	6a 00                	push   $0x0
  pushl $20
80105272:	6a 14                	push   $0x14
  jmp alltraps
80105274:	e9 18 fb ff ff       	jmp    80104d91 <alltraps>
...
80105279:	6a 00                	push   $0x0
  pushl $21
8010527b:	6a 15                	push   $0x15
  jmp alltraps
8010527d:	e9 0f fb ff ff       	jmp    80104d91 <alltraps>
...
80105282:	6a 00                	push   $0x0
  pushl $22
80105284:	6a 16                	push   $0x16
  jmp alltraps
80105286:	e9 06 fb ff ff       	jmp    80104d91 <alltraps>
...
8010528b:	6a 00                	push   $0x0
  pushl $23
8010528d:	6a 17                	push   $0x17
  jmp alltraps
8010528f:	e9 fd fa ff ff       	jmp    80104d91 <alltraps>
...
80105294:	6a 00                	push   $0x0
  pushl $24
80105296:	6a 18                	push   $0x18
  jmp alltraps
80105298:	e9 f4 fa ff ff       	jmp    80104d91 <alltraps>
...
8010529d:	6a 00                	push   $0x0
  pushl $25
8010529f:	6a 19                	push   $0x19
  jmp alltraps
801052a1:	e9 eb fa ff ff       	jmp    80104d91 <alltraps>
...
801052a6:	6a 00                	push   $0x0
  pushl $26
801052a8:	6a 1a                	push   $0x1a
  jmp alltraps
801052aa:	e9 e2 fa ff ff       	jmp    80104d91 <alltraps>
...
801052af:	6a 00                	push   $0x0
  pushl $27
801052b1:	6a 1b                	push   $0x1b
  jmp alltraps
801052b3:	e9 d9 fa ff ff       	jmp    80104d91 <alltraps>
...
801052b8:	6a 00                	push   $0x0
  pushl $28
801052ba:	6a 1c                	push   $0x1c
  jmp alltraps
801052bc:	e9 d0 fa ff ff       	jmp    80104d91 <alltraps>
...
801052c1:	6a 00                	push   $0x0
  pushl $29
801052c3:	6a 1d                	push   $0x1d
  jmp alltraps
801052c5:	e9 c7 fa ff ff       	jmp    80104d91 <alltraps>
...
801052ca:	6a 00                	push   $0x0
  pushl $30
801052cc:	6a 1e                	push   $0x1e
  jmp alltraps
801052ce:	e9 be fa ff ff       	jmp    80104d91 <alltraps>
...
801052d3:	6a 00                	push   $0x0
  pushl $31
801052d5:	6a 1f                	push   $0x1f
  jmp alltraps
801052d7:	e9 b5 fa ff ff       	jmp    80104d91 <alltraps>
...
801052dc:	6a 00                	push   $0x0
  pushl $32
801052de:	6a 20                	push   $0x20
  jmp alltraps
801052e0:	e9 ac fa ff ff       	jmp    80104d91 <alltraps>
...
801052e5:	6a 00                	push   $0x0
  pushl $33
801052e7:	6a 21                	push   $0x21
  jmp alltraps
801052e9:	e9 a3 fa ff ff       	jmp    80104d91 <alltraps>
...
801052ee:	6a 00                	push   $0x0
  pushl $34
801052f0:	6a 22                	push   $0x22
  jmp alltraps
801052f2:	e9 9a fa ff ff       	jmp    80104d91 <alltraps>
...
801052f7:	6a 00                	push   $0x0
  pushl $35
801052f9:	6a 23                	push   $0x23
  jmp alltraps
801052fb:	e9 91 fa ff ff       	jmp    80104d91 <alltraps>
...
80105300:	6a 00                	push   $0x0
  pushl $36
80105302:	6a 24                	push   $0x24
  jmp alltraps
80105304:	e9 88 fa ff ff       	jmp    80104d91 <alltraps>
...
80105309:	6a 00                	push   $0x0
  pushl $37
8010530b:	6a 25                	push   $0x25
  jmp alltraps
8010530d:	e9 7f fa ff ff       	jmp    80104d91 <alltraps>
...
80105312:	6a 00                	push   $0x0
  pushl $38
80105314:	6a 26                	push   $0x26
  jmp alltraps
80105316:	e9 76 fa ff ff       	jmp    80104d91 <alltraps>
...
8010531b:	6a 00                	push   $0x0
  pushl $39
8010531d:	6a 27                	push   $0x27
  jmp alltraps
8010531f:	e9 6d fa ff ff       	jmp    80104d91 <alltraps>
...
80105324:	6a 00                	push   $0x0
  pushl $40
80105326:	6a 28                	push   $0x28
  jmp alltraps
80105328:	e9 64 fa ff ff       	jmp    80104d91 <alltraps>
...
8010532d:	6a 00                	push   $0x0
  pushl $41
8010532f:	6a 29                	push   $0x29
  jmp alltraps
80105331:	e9 5b fa ff ff       	jmp    80104d91 <alltraps>
...
80105336:	6a 00                	push   $0x0
  pushl $42
80105338:	6a 2a                	push   $0x2a
  jmp alltraps
8010533a:	e9 52 fa ff ff       	jmp    80104d91 <alltraps>
...
8010533f:	6a 00                	push   $0x0
  pushl $43
80105341:	6a 2b                	push   $0x2b
  jmp alltraps
80105343:	e9 49 fa ff ff       	jmp    80104d91 <alltraps>
...
80105348:	6a 00                	push   $0x0
  pushl $44
8010534a:	6a 2c                	push   $0x2c
  jmp alltraps
8010534c:	e9 40 fa ff ff       	jmp    80104d91 <alltraps>
...
80105351:	6a 00                	push   $0x0
  pushl $45
80105353:	6a 2d                	push   $0x2d
  jmp alltraps
80105355:	e9 37 fa ff ff       	jmp    80104d91 <alltraps>
...
8010535a:	6a 00                	push   $0x0
  pushl $46
8010535c:	6a 2e                	push   $0x2e
  jmp alltraps
8010535e:	e9 2e fa ff ff       	jmp    80104d91 <alltraps>
...
80105363:	6a 00                	push   $0x0
  pushl $47
80105365:	6a 2f                	push   $0x2f
  jmp alltraps
80105367:	e9 25 fa ff ff       	jmp    80104d91 <alltraps>
...
8010536c:	6a 00                	push   $0x0
  pushl $48
8010536e:	6a 30                	push   $0x30
  jmp alltraps
80105370:	e9 1c fa ff ff       	jmp    80104d91 <alltraps>
...
80105375:	6a 00                	push   $0x0
  pushl $49
80105377:	6a 31                	push   $0x31
  jmp alltraps
80105379:	e9 13 fa ff ff       	jmp    80104d91 <alltraps>
...
8010537e:	6a 00                	push   $0x0
  pushl $50
80105380:	6a 32                	push   $0x32
  jmp alltraps
80105382:	e9 0a fa ff ff       	jmp    80104d91 <alltraps>
...
80105387:	6a 00                	push   $0x0
  pushl $51
80105389:	6a 33                	push   $0x33
  jmp alltraps
8010538b:	e9 01 fa ff ff       	jmp    80104d91 <alltraps>
...
80105390:	6a 00                	push   $0x0
  pushl $52
80105392:	6a 34                	push   $0x34
  jmp alltraps
80105394:	e9 f8 f9 ff ff       	jmp    80104d91 <alltraps>
...
80105399:	6a 00                	push   $0x0
  pushl $53
8010539b:	6a 35                	push   $0x35
  jmp alltraps
8010539d:	e9 ef f9 ff ff       	jmp    80104d91 <alltraps>
...
801053a2:	6a 00                	push   $0x0
  pushl $54
801053a4:	6a 36                	push   $0x36
  jmp alltraps
801053a6:	e9 e6 f9 ff ff       	jmp    80104d91 <alltraps>
...
801053ab:	6a 00                	push   $0x0
  pushl $55
801053ad:	6a 37                	push   $0x37
  jmp alltraps
801053af:	e9 dd f9 ff ff       	jmp    80104d91 <alltraps>
...
801053b4:	6a 00                	push   $0x0
  pushl $56
801053b6:	6a 38                	push   $0x38
  jmp alltraps
801053b8:	e9 d4 f9 ff ff       	jmp    80104d91 <alltraps>
...
801053bd:	6a 00                	push   $0x0
  pushl $57
801053bf:	6a 39                	push   $0x39
  jmp alltraps
801053c1:	e9 cb f9 ff ff       	jmp    80104d91 <alltraps>
...
801053c6:	6a 00                	push   $0x0
  pushl $58
801053c8:	6a 3a                	push   $0x3a
  jmp alltraps
801053ca:	e9 c2 f9 ff ff       	jmp    80104d91 <alltraps>
...
801053cf:	6a 00                	push   $0x0
  pushl $59
801053d1:	6a 3b                	push   $0x3b
  jmp alltraps
801053d3:	e9 b9 f9 ff ff       	jmp    80104d91 <alltraps>
...
801053d8:	6a 00                	push   $0x0
  pushl $60
801053da:	6a 3c                	push   $0x3c
  jmp alltraps
801053dc:	e9 b0 f9 ff ff       	jmp    80104d91 <alltraps>
...
801053e1:	6a 00                	push   $0x0
  pushl $61
801053e3:	6a 3d                	push   $0x3d
  jmp alltraps
801053e5:	e9 a7 f9 ff ff       	jmp    80104d91 <alltraps>
...
801053ea:	6a 00                	push   $0x0
  pushl $62
801053ec:	6a 3e                	push   $0x3e
  jmp alltraps
801053ee:	e9 9e f9 ff ff       	jmp    80104d91 <alltraps>
...
801053f3:	6a 00                	push   $0x0
  pushl $63
801053f5:	6a 3f                	push   $0x3f
  jmp alltraps
801053f7:	e9 95 f9 ff ff       	jmp    80104d91 <alltraps>
...
801053fc:	6a 00                	push   $0x0
  pushl $64
801053fe:	6a 40                	push   $0x40
  jmp alltraps
80105400:	e9 8c f9 ff ff       	jmp    80104d91 <alltraps>
...
80105405:	6a 00                	push   $0x0
  pushl $65
80105407:	6a 41                	push   $0x41
  jmp alltraps
80105409:	e9 83 f9 ff ff       	jmp    80104d91 <alltraps>
...
8010540e:	6a 00                	push   $0x0
  pushl $66
80105410:	6a 42                	push   $0x42
  jmp alltraps
80105412:	e9 7a f9 ff ff       	jmp    80104d91 <alltraps>
...
80105417:	6a 00                	push   $0x0
  pushl $67
80105419:	6a 43                	push   $0x43
  jmp alltraps
8010541b:	e9 71 f9 ff ff       	jmp    80104d91 <alltraps>
...
80105420:	6a 00                	push   $0x0
  pushl $68
80105422:	6a 44                	push   $0x44
  jmp alltraps
80105424:	e9 68 f9 ff ff       	jmp    80104d91 <alltraps>
...
80105429:	6a 00                	push   $0x0
  pushl $69
8010542b:	6a 45                	push   $0x45
  jmp alltraps
8010542d:	e9 5f f9 ff ff       	jmp    80104d91 <alltraps>
...
80105432:	6a 00                	push   $0x0
  pushl $70
80105434:	6a 46                	push   $0x46
  jmp alltraps
80105436:	e9 56 f9 ff ff       	jmp    80104d91 <alltraps>
...
8010543b:	6a 00                	push   $0x0
  pushl $71
8010543d:	6a 47                	push   $0x47
  jmp alltraps
8010543f:	e9 4d f9 ff ff       	jmp    80104d91 <alltraps>
...
80105444:	6a 00                	push   $0x0
  pushl $72
80105446:	6a 48                	push   $0x48
  jmp alltraps
80105448:	e9 44 f9 ff ff       	jmp    80104d91 <alltraps>
...
8010544d:	6a 00                	push   $0x0
  pushl $73
8010544f:	6a 49                	push   $0x49
  jmp alltraps
80105451:	e9 3b f9 ff ff       	jmp    80104d91 <alltraps>
...
80105456:	6a 00                	push   $0x0
  pushl $74
80105458:	6a 4a                	push   $0x4a
  jmp alltraps
8010545a:	e9 32 f9 ff ff       	jmp    80104d91 <alltraps>
...
8010545f:	6a 00                	push   $0x0
  pushl $75
80105461:	6a 4b                	push   $0x4b
  jmp alltraps
80105463:	e9 29 f9 ff ff       	jmp    80104d91 <alltraps>
...
80105468:	6a 00                	push   $0x0
  pushl $76
8010546a:	6a 4c                	push   $0x4c
  jmp alltraps
8010546c:	e9 20 f9 ff ff       	jmp    80104d91 <alltraps>
...
80105471:	6a 00                	push   $0x0
  pushl $77
80105473:	6a 4d                	push   $0x4d
  jmp alltraps
80105475:	e9 17 f9 ff ff       	jmp    80104d91 <alltraps>
...
8010547a:	6a 00                	push   $0x0
  pushl $78
8010547c:	6a 4e                	push   $0x4e
  jmp alltraps
8010547e:	e9 0e f9 ff ff       	jmp    80104d91 <alltraps>
...
80105483:	6a 00                	push   $0x0
  pushl $79
80105485:	6a 4f                	push   $0x4f
  jmp alltraps
80105487:	e9 05 f9 ff ff       	jmp    80104d91 <alltraps>
...
8010548c:	6a 00                	push   $0x0
  pushl $80
8010548e:	6a 50                	push   $0x50
  jmp alltraps
80105490:	e9 fc f8 ff ff       	jmp    80104d91 <alltraps>
...
80105495:	6a 00                	push   $0x0
  pushl $81
80105497:	6a 51                	push   $0x51
  jmp alltraps
80105499:	e9 f3 f8 ff ff       	jmp    80104d91 <alltraps>
...
8010549e:	6a 00                	push   $0x0
  pushl $82
801054a0:	6a 52                	push   $0x52
  jmp alltraps
801054a2:	e9 ea f8 ff ff       	jmp    80104d91 <alltraps>
...
801054a7:	6a 00                	push   $0x0
  pushl $83
801054a9:	6a 53                	push   $0x53
  jmp alltraps
801054ab:	e9 e1 f8 ff ff       	jmp    80104d91 <alltraps>
...
801054b0:	6a 00                	push   $0x0
  pushl $84
801054b2:	6a 54                	push   $0x54
  jmp alltraps
801054b4:	e9 d8 f8 ff ff       	jmp    80104d91 <alltraps>
...
801054b9:	6a 00                	push   $0x0
  pushl $85
801054bb:	6a 55                	push   $0x55
  jmp alltraps
801054bd:	e9 cf f8 ff ff       	jmp    80104d91 <alltraps>
...
801054c2:	6a 00                	push   $0x0
  pushl $86
801054c4:	6a 56                	push   $0x56
  jmp alltraps
801054c6:	e9 c6 f8 ff ff       	jmp    80104d91 <alltraps>
...
801054cb:	6a 00                	push   $0x0
  pushl $87
801054cd:	6a 57                	push   $0x57
  jmp alltraps
801054cf:	e9 bd f8 ff ff       	jmp    80104d91 <alltraps>
...
801054d4:	6a 00                	push   $0x0
  pushl $88
801054d6:	6a 58                	push   $0x58
  jmp alltraps
801054d8:	e9 b4 f8 ff ff       	jmp    80104d91 <alltraps>
...
801054dd:	6a 00                	push   $0x0
  pushl $89
801054df:	6a 59                	push   $0x59
  jmp alltraps
801054e1:	e9 ab f8 ff ff       	jmp    80104d91 <alltraps>
...
801054e6:	6a 00                	push   $0x0
  pushl $90
801054e8:	6a 5a                	push   $0x5a
  jmp alltraps
801054ea:	e9 a2 f8 ff ff       	jmp    80104d91 <alltraps>
...
801054ef:	6a 00                	push   $0x0
  pushl $91
801054f1:	6a 5b                	push   $0x5b
  jmp alltraps
801054f3:	e9 99 f8 ff ff       	jmp    80104d91 <alltraps>
...
801054f8:	6a 00                	push   $0x0
  pushl $92
801054fa:	6a 5c                	push   $0x5c
  jmp alltraps
801054fc:	e9 90 f8 ff ff       	jmp    80104d91 <alltraps>
...
80105501:	6a 00                	push   $0x0
  pushl $93
80105503:	6a 5d                	push   $0x5d
  jmp alltraps
80105505:	e9 87 f8 ff ff       	jmp    80104d91 <alltraps>
...
8010550a:	6a 00                	push   $0x0
  pushl $94
8010550c:	6a 5e                	push   $0x5e
  jmp alltraps
8010550e:	e9 7e f8 ff ff       	jmp    80104d91 <alltraps>
...
80105513:	6a 00                	push   $0x0
  pushl $95
80105515:	6a 5f                	push   $0x5f
  jmp alltraps
80105517:	e9 75 f8 ff ff       	jmp    80104d91 <alltraps>
...
8010551c:	6a 00                	push   $0x0
  pushl $96
8010551e:	6a 60                	push   $0x60
  jmp alltraps
80105520:	e9 6c f8 ff ff       	jmp    80104d91 <alltraps>
...
80105525:	6a 00                	push   $0x0
  pushl $97
80105527:	6a 61                	push   $0x61
  jmp alltraps
80105529:	e9 63 f8 ff ff       	jmp    80104d91 <alltraps>
...
8010552e:	6a 00                	push   $0x0
  pushl $98
80105530:	6a 62                	push   $0x62
  jmp alltraps
80105532:	e9 5a f8 ff ff       	jmp    80104d91 <alltraps>
...
80105537:	6a 00                	push   $0x0
  pushl $99
80105539:	6a 63                	push   $0x63
  jmp alltraps
8010553b:	e9 51 f8 ff ff       	jmp    80104d91 <alltraps>
...
80105540:	6a 00                	push   $0x0
  pushl $100
80105542:	6a 64                	push   $0x64
  jmp alltraps
80105544:	e9 48 f8 ff ff       	jmp    80104d91 <alltraps>
...
80105549:	6a 00                	push   $0x0
  pushl $101
8010554b:	6a 65                	push   $0x65
  jmp alltraps
8010554d:	e9 3f f8 ff ff       	jmp    80104d91 <alltraps>
...
80105552:	6a 00                	push   $0x0
  pushl $102
80105554:	6a 66                	push   $0x66
  jmp alltraps
80105556:	e9 36 f8 ff ff       	jmp    80104d91 <alltraps>
...
8010555b:	6a 00                	push   $0x0
  pushl $103
8010555d:	6a 67                	push   $0x67
  jmp alltraps
8010555f:	e9 2d f8 ff ff       	jmp    80104d91 <alltraps>
...
80105564:	6a 00                	push   $0x0
  pushl $104
80105566:	6a 68                	push   $0x68
  jmp alltraps
80105568:	e9 24 f8 ff ff       	jmp    80104d91 <alltraps>
...
8010556d:	6a 00                	push   $0x0
  pushl $105
8010556f:	6a 69                	push   $0x69
  jmp alltraps
80105571:	e9 1b f8 ff ff       	jmp    80104d91 <alltraps>
...
80105576:	6a 00                	push   $0x0
  pushl $106
80105578:	6a 6a                	push   $0x6a
  jmp alltraps
8010557a:	e9 12 f8 ff ff       	jmp    80104d91 <alltraps>
...
8010557f:	6a 00                	push   $0x0
  pushl $107
80105581:	6a 6b                	push   $0x6b
  jmp alltraps
80105583:	e9 09 f8 ff ff       	jmp    80104d91 <alltraps>
...
80105588:	6a 00                	push   $0x0
  pushl $108
8010558a:	6a 6c                	push   $0x6c
  jmp alltraps
8010558c:	e9 00 f8 ff ff       	jmp    80104d91 <alltraps>
...
80105591:	6a 00                	push   $0x0
  pushl $109
80105593:	6a 6d                	push   $0x6d
  jmp alltraps
80105595:	e9 f7 f7 ff ff       	jmp    80104d91 <alltraps>
...
8010559a:	6a 00                	push   $0x0
  pushl $110
8010559c:	6a 6e                	push   $0x6e
  jmp alltraps
8010559e:	e9 ee f7 ff ff       	jmp    80104d91 <alltraps>
...
801055a3:	6a 00                	push   $0x0
  pushl $111
801055a5:	6a 6f                	push   $0x6f
  jmp alltraps
801055a7:	e9 e5 f7 ff ff       	jmp    80104d91 <alltraps>
...
801055ac:	6a 00                	push   $0x0
  pushl $112
801055ae:	6a 70                	push   $0x70
  jmp alltraps
801055b0:	e9 dc f7 ff ff       	jmp    80104d91 <alltraps>
...
801055b5:	6a 00                	push   $0x0
  pushl $113
801055b7:	6a 71                	push   $0x71
  jmp alltraps
801055b9:	e9 d3 f7 ff ff       	jmp    80104d91 <alltraps>
...
801055be:	6a 00                	push   $0x0
  pushl $114
801055c0:	6a 72                	push   $0x72
  jmp alltraps
801055c2:	e9 ca f7 ff ff       	jmp    80104d91 <alltraps>
...
801055c7:	6a 00                	push   $0x0
  pushl $115
801055c9:	6a 73                	push   $0x73
  jmp alltraps
801055cb:	e9 c1 f7 ff ff       	jmp    80104d91 <alltraps>
...
801055d0:	6a 00                	push   $0x0
  pushl $116
801055d2:	6a 74                	push   $0x74
  jmp alltraps
801055d4:	e9 b8 f7 ff ff       	jmp    80104d91 <alltraps>
...
801055d9:	6a 00                	push   $0x0
  pushl $117
801055db:	6a 75                	push   $0x75
  jmp alltraps
801055dd:	e9 af f7 ff ff       	jmp    80104d91 <alltraps>
...
801055e2:	6a 00                	push   $0x0
  pushl $118
801055e4:	6a 76                	push   $0x76
  jmp alltraps
801055e6:	e9 a6 f7 ff ff       	jmp    80104d91 <alltraps>
...
801055eb:	6a 00                	push   $0x0
  pushl $119
801055ed:	6a 77                	push   $0x77
  jmp alltraps
801055ef:	e9 9d f7 ff ff       	jmp    80104d91 <alltraps>
...
801055f4:	6a 00                	push   $0x0
  pushl $120
801055f6:	6a 78                	push   $0x78
  jmp alltraps
801055f8:	e9 94 f7 ff ff       	jmp    80104d91 <alltraps>
...
801055fd:	6a 00                	push   $0x0
  pushl $121
801055ff:	6a 79                	push   $0x79
  jmp alltraps
80105601:	e9 8b f7 ff ff       	jmp    80104d91 <alltraps>
...
80105606:	6a 00                	push   $0x0
  pushl $122
80105608:	6a 7a                	push   $0x7a
  jmp alltraps
8010560a:	e9 82 f7 ff ff       	jmp    80104d91 <alltraps>
...
8010560f:	6a 00                	push   $0x0
  pushl $123
80105611:	6a 7b                	push   $0x7b
  jmp alltraps
80105613:	e9 79 f7 ff ff       	jmp    80104d91 <alltraps>
...
80105618:	6a 00                	push   $0x0
  pushl $124
8010561a:	6a 7c                	push   $0x7c
  jmp alltraps
8010561c:	e9 70 f7 ff ff       	jmp    80104d91 <alltraps>
...
80105621:	6a 00                	push   $0x0
  pushl $125
80105623:	6a 7d                	push   $0x7d
  jmp alltraps
80105625:	e9 67 f7 ff ff       	jmp    80104d91 <alltraps>
...
8010562a:	6a 00                	push   $0x0
  pushl $126
8010562c:	6a 7e                	push   $0x7e
  jmp alltraps
8010562e:	e9 5e f7 ff ff       	jmp    80104d91 <alltraps>
...
80105633:	6a 00                	push   $0x0
  pushl $127
80105635:	6a 7f                	push   $0x7f
  jmp alltraps
80105637:	e9 55 f7 ff ff       	jmp    80104d91 <alltraps>
...
8010563c:	6a 00                	push   $0x0
  pushl $128
8010563e:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105643:	e9 49 f7 ff ff       	jmp    80104d91 <alltraps>
...
80105648:	6a 00                	push   $0x0
  pushl $129
8010564a:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010564f:	e9 3d f7 ff ff       	jmp    80104d91 <alltraps>
...
80105654:	6a 00                	push   $0x0
  pushl $130
80105656:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010565b:	e9 31 f7 ff ff       	jmp    80104d91 <alltraps>
...
80105660:	6a 00                	push   $0x0
  pushl $131
80105662:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105667:	e9 25 f7 ff ff       	jmp    80104d91 <alltraps>
...
8010566c:	6a 00                	push   $0x0
  pushl $132
8010566e:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105673:	e9 19 f7 ff ff       	jmp    80104d91 <alltraps>
...
80105678:	6a 00                	push   $0x0
  pushl $133
8010567a:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010567f:	e9 0d f7 ff ff       	jmp    80104d91 <alltraps>
...
80105684:	6a 00                	push   $0x0
  pushl $134
80105686:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010568b:	e9 01 f7 ff ff       	jmp    80104d91 <alltraps>
...
80105690:	6a 00                	push   $0x0
  pushl $135
80105692:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105697:	e9 f5 f6 ff ff       	jmp    80104d91 <alltraps>
...
8010569c:	6a 00                	push   $0x0
  pushl $136
8010569e:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801056a3:	e9 e9 f6 ff ff       	jmp    80104d91 <alltraps>
...
801056a8:	6a 00                	push   $0x0
  pushl $137
801056aa:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801056af:	e9 dd f6 ff ff       	jmp    80104d91 <alltraps>
...
801056b4:	6a 00                	push   $0x0
  pushl $138
801056b6:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801056bb:	e9 d1 f6 ff ff       	jmp    80104d91 <alltraps>
...
801056c0:	6a 00                	push   $0x0
  pushl $139
801056c2:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801056c7:	e9 c5 f6 ff ff       	jmp    80104d91 <alltraps>
...
801056cc:	6a 00                	push   $0x0
  pushl $140
801056ce:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801056d3:	e9 b9 f6 ff ff       	jmp    80104d91 <alltraps>
...
801056d8:	6a 00                	push   $0x0
  pushl $141
801056da:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801056df:	e9 ad f6 ff ff       	jmp    80104d91 <alltraps>
...
801056e4:	6a 00                	push   $0x0
  pushl $142
801056e6:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801056eb:	e9 a1 f6 ff ff       	jmp    80104d91 <alltraps>
...
801056f0:	6a 00                	push   $0x0
  pushl $143
801056f2:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801056f7:	e9 95 f6 ff ff       	jmp    80104d91 <alltraps>
...
801056fc:	6a 00                	push   $0x0
  pushl $144
801056fe:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105703:	e9 89 f6 ff ff       	jmp    80104d91 <alltraps>
...
80105708:	6a 00                	push   $0x0
  pushl $145
8010570a:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010570f:	e9 7d f6 ff ff       	jmp    80104d91 <alltraps>
...
80105714:	6a 00                	push   $0x0
  pushl $146
80105716:	68 92 00 00 00       	push   $0x92
  jmp alltraps
8010571b:	e9 71 f6 ff ff       	jmp    80104d91 <alltraps>
...
80105720:	6a 00                	push   $0x0
  pushl $147
80105722:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105727:	e9 65 f6 ff ff       	jmp    80104d91 <alltraps>
...
8010572c:	6a 00                	push   $0x0
  pushl $148
8010572e:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105733:	e9 59 f6 ff ff       	jmp    80104d91 <alltraps>
...
80105738:	6a 00                	push   $0x0
  pushl $149
8010573a:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010573f:	e9 4d f6 ff ff       	jmp    80104d91 <alltraps>
...
80105744:	6a 00                	push   $0x0
  pushl $150
80105746:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010574b:	e9 41 f6 ff ff       	jmp    80104d91 <alltraps>
...
80105750:	6a 00                	push   $0x0
  pushl $151
80105752:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105757:	e9 35 f6 ff ff       	jmp    80104d91 <alltraps>
...
8010575c:	6a 00                	push   $0x0
  pushl $152
8010575e:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105763:	e9 29 f6 ff ff       	jmp    80104d91 <alltraps>
...
80105768:	6a 00                	push   $0x0
  pushl $153
8010576a:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010576f:	e9 1d f6 ff ff       	jmp    80104d91 <alltraps>
...
80105774:	6a 00                	push   $0x0
  pushl $154
80105776:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010577b:	e9 11 f6 ff ff       	jmp    80104d91 <alltraps>
...
80105780:	6a 00                	push   $0x0
  pushl $155
80105782:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105787:	e9 05 f6 ff ff       	jmp    80104d91 <alltraps>
...
8010578c:	6a 00                	push   $0x0
  pushl $156
8010578e:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105793:	e9 f9 f5 ff ff       	jmp    80104d91 <alltraps>
...
80105798:	6a 00                	push   $0x0
  pushl $157
8010579a:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010579f:	e9 ed f5 ff ff       	jmp    80104d91 <alltraps>
...
801057a4:	6a 00                	push   $0x0
  pushl $158
801057a6:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801057ab:	e9 e1 f5 ff ff       	jmp    80104d91 <alltraps>
...
801057b0:	6a 00                	push   $0x0
  pushl $159
801057b2:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801057b7:	e9 d5 f5 ff ff       	jmp    80104d91 <alltraps>
...
801057bc:	6a 00                	push   $0x0
  pushl $160
801057be:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801057c3:	e9 c9 f5 ff ff       	jmp    80104d91 <alltraps>
...
801057c8:	6a 00                	push   $0x0
  pushl $161
801057ca:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801057cf:	e9 bd f5 ff ff       	jmp    80104d91 <alltraps>
...
801057d4:	6a 00                	push   $0x0
  pushl $162
801057d6:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801057db:	e9 b1 f5 ff ff       	jmp    80104d91 <alltraps>
...
801057e0:	6a 00                	push   $0x0
  pushl $163
801057e2:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801057e7:	e9 a5 f5 ff ff       	jmp    80104d91 <alltraps>
...
801057ec:	6a 00                	push   $0x0
  pushl $164
801057ee:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801057f3:	e9 99 f5 ff ff       	jmp    80104d91 <alltraps>
...
801057f8:	6a 00                	push   $0x0
  pushl $165
801057fa:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801057ff:	e9 8d f5 ff ff       	jmp    80104d91 <alltraps>
...
80105804:	6a 00                	push   $0x0
  pushl $166
80105806:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
8010580b:	e9 81 f5 ff ff       	jmp    80104d91 <alltraps>
...
80105810:	6a 00                	push   $0x0
  pushl $167
80105812:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105817:	e9 75 f5 ff ff       	jmp    80104d91 <alltraps>
...
8010581c:	6a 00                	push   $0x0
  pushl $168
8010581e:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105823:	e9 69 f5 ff ff       	jmp    80104d91 <alltraps>
...
80105828:	6a 00                	push   $0x0
  pushl $169
8010582a:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010582f:	e9 5d f5 ff ff       	jmp    80104d91 <alltraps>
...
80105834:	6a 00                	push   $0x0
  pushl $170
80105836:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
8010583b:	e9 51 f5 ff ff       	jmp    80104d91 <alltraps>
...
80105840:	6a 00                	push   $0x0
  pushl $171
80105842:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105847:	e9 45 f5 ff ff       	jmp    80104d91 <alltraps>
...
8010584c:	6a 00                	push   $0x0
  pushl $172
8010584e:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105853:	e9 39 f5 ff ff       	jmp    80104d91 <alltraps>
...
80105858:	6a 00                	push   $0x0
  pushl $173
8010585a:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010585f:	e9 2d f5 ff ff       	jmp    80104d91 <alltraps>
...
80105864:	6a 00                	push   $0x0
  pushl $174
80105866:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010586b:	e9 21 f5 ff ff       	jmp    80104d91 <alltraps>
...
80105870:	6a 00                	push   $0x0
  pushl $175
80105872:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105877:	e9 15 f5 ff ff       	jmp    80104d91 <alltraps>
...
8010587c:	6a 00                	push   $0x0
  pushl $176
8010587e:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105883:	e9 09 f5 ff ff       	jmp    80104d91 <alltraps>
...
80105888:	6a 00                	push   $0x0
  pushl $177
8010588a:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010588f:	e9 fd f4 ff ff       	jmp    80104d91 <alltraps>
...
80105894:	6a 00                	push   $0x0
  pushl $178
80105896:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010589b:	e9 f1 f4 ff ff       	jmp    80104d91 <alltraps>
...
801058a0:	6a 00                	push   $0x0
  pushl $179
801058a2:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801058a7:	e9 e5 f4 ff ff       	jmp    80104d91 <alltraps>
...
801058ac:	6a 00                	push   $0x0
  pushl $180
801058ae:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801058b3:	e9 d9 f4 ff ff       	jmp    80104d91 <alltraps>
...
801058b8:	6a 00                	push   $0x0
  pushl $181
801058ba:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801058bf:	e9 cd f4 ff ff       	jmp    80104d91 <alltraps>
...
801058c4:	6a 00                	push   $0x0
  pushl $182
801058c6:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801058cb:	e9 c1 f4 ff ff       	jmp    80104d91 <alltraps>
...
801058d0:	6a 00                	push   $0x0
  pushl $183
801058d2:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801058d7:	e9 b5 f4 ff ff       	jmp    80104d91 <alltraps>
...
801058dc:	6a 00                	push   $0x0
  pushl $184
801058de:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801058e3:	e9 a9 f4 ff ff       	jmp    80104d91 <alltraps>
...
801058e8:	6a 00                	push   $0x0
  pushl $185
801058ea:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801058ef:	e9 9d f4 ff ff       	jmp    80104d91 <alltraps>
...
801058f4:	6a 00                	push   $0x0
  pushl $186
801058f6:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801058fb:	e9 91 f4 ff ff       	jmp    80104d91 <alltraps>
...
80105900:	6a 00                	push   $0x0
  pushl $187
80105902:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80105907:	e9 85 f4 ff ff       	jmp    80104d91 <alltraps>
...
8010590c:	6a 00                	push   $0x0
  pushl $188
8010590e:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80105913:	e9 79 f4 ff ff       	jmp    80104d91 <alltraps>
...
80105918:	6a 00                	push   $0x0
  pushl $189
8010591a:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010591f:	e9 6d f4 ff ff       	jmp    80104d91 <alltraps>
...
80105924:	6a 00                	push   $0x0
  pushl $190
80105926:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
8010592b:	e9 61 f4 ff ff       	jmp    80104d91 <alltraps>
...
80105930:	6a 00                	push   $0x0
  pushl $191
80105932:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80105937:	e9 55 f4 ff ff       	jmp    80104d91 <alltraps>
...
8010593c:	6a 00                	push   $0x0
  pushl $192
8010593e:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80105943:	e9 49 f4 ff ff       	jmp    80104d91 <alltraps>
...
80105948:	6a 00                	push   $0x0
  pushl $193
8010594a:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010594f:	e9 3d f4 ff ff       	jmp    80104d91 <alltraps>
...
80105954:	6a 00                	push   $0x0
  pushl $194
80105956:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010595b:	e9 31 f4 ff ff       	jmp    80104d91 <alltraps>
...
80105960:	6a 00                	push   $0x0
  pushl $195
80105962:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80105967:	e9 25 f4 ff ff       	jmp    80104d91 <alltraps>
...
8010596c:	6a 00                	push   $0x0
  pushl $196
8010596e:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80105973:	e9 19 f4 ff ff       	jmp    80104d91 <alltraps>
...
80105978:	6a 00                	push   $0x0
  pushl $197
8010597a:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010597f:	e9 0d f4 ff ff       	jmp    80104d91 <alltraps>
...
80105984:	6a 00                	push   $0x0
  pushl $198
80105986:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010598b:	e9 01 f4 ff ff       	jmp    80104d91 <alltraps>
...
80105990:	6a 00                	push   $0x0
  pushl $199
80105992:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80105997:	e9 f5 f3 ff ff       	jmp    80104d91 <alltraps>
...
8010599c:	6a 00                	push   $0x0
  pushl $200
8010599e:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801059a3:	e9 e9 f3 ff ff       	jmp    80104d91 <alltraps>
...
801059a8:	6a 00                	push   $0x0
  pushl $201
801059aa:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801059af:	e9 dd f3 ff ff       	jmp    80104d91 <alltraps>
...
801059b4:	6a 00                	push   $0x0
  pushl $202
801059b6:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801059bb:	e9 d1 f3 ff ff       	jmp    80104d91 <alltraps>
...
801059c0:	6a 00                	push   $0x0
  pushl $203
801059c2:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801059c7:	e9 c5 f3 ff ff       	jmp    80104d91 <alltraps>
...
801059cc:	6a 00                	push   $0x0
  pushl $204
801059ce:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801059d3:	e9 b9 f3 ff ff       	jmp    80104d91 <alltraps>
...
801059d8:	6a 00                	push   $0x0
  pushl $205
801059da:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801059df:	e9 ad f3 ff ff       	jmp    80104d91 <alltraps>
...
801059e4:	6a 00                	push   $0x0
  pushl $206
801059e6:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801059eb:	e9 a1 f3 ff ff       	jmp    80104d91 <alltraps>
...
801059f0:	6a 00                	push   $0x0
  pushl $207
801059f2:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801059f7:	e9 95 f3 ff ff       	jmp    80104d91 <alltraps>
...
801059fc:	6a 00                	push   $0x0
  pushl $208
801059fe:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80105a03:	e9 89 f3 ff ff       	jmp    80104d91 <alltraps>
...
80105a08:	6a 00                	push   $0x0
  pushl $209
80105a0a:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80105a0f:	e9 7d f3 ff ff       	jmp    80104d91 <alltraps>
...
80105a14:	6a 00                	push   $0x0
  pushl $210
80105a16:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80105a1b:	e9 71 f3 ff ff       	jmp    80104d91 <alltraps>
...
80105a20:	6a 00                	push   $0x0
  pushl $211
80105a22:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80105a27:	e9 65 f3 ff ff       	jmp    80104d91 <alltraps>
...
80105a2c:	6a 00                	push   $0x0
  pushl $212
80105a2e:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80105a33:	e9 59 f3 ff ff       	jmp    80104d91 <alltraps>
...
80105a38:	6a 00                	push   $0x0
  pushl $213
80105a3a:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80105a3f:	e9 4d f3 ff ff       	jmp    80104d91 <alltraps>
...
80105a44:	6a 00                	push   $0x0
  pushl $214
80105a46:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80105a4b:	e9 41 f3 ff ff       	jmp    80104d91 <alltraps>
...
80105a50:	6a 00                	push   $0x0
  pushl $215
80105a52:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80105a57:	e9 35 f3 ff ff       	jmp    80104d91 <alltraps>
...
80105a5c:	6a 00                	push   $0x0
  pushl $216
80105a5e:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80105a63:	e9 29 f3 ff ff       	jmp    80104d91 <alltraps>
...
80105a68:	6a 00                	push   $0x0
  pushl $217
80105a6a:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80105a6f:	e9 1d f3 ff ff       	jmp    80104d91 <alltraps>
...
80105a74:	6a 00                	push   $0x0
  pushl $218
80105a76:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80105a7b:	e9 11 f3 ff ff       	jmp    80104d91 <alltraps>
...
80105a80:	6a 00                	push   $0x0
  pushl $219
80105a82:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80105a87:	e9 05 f3 ff ff       	jmp    80104d91 <alltraps>
...
80105a8c:	6a 00                	push   $0x0
  pushl $220
80105a8e:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80105a93:	e9 f9 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105a98:	6a 00                	push   $0x0
  pushl $221
80105a9a:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80105a9f:	e9 ed f2 ff ff       	jmp    80104d91 <alltraps>
...
80105aa4:	6a 00                	push   $0x0
  pushl $222
80105aa6:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80105aab:	e9 e1 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105ab0:	6a 00                	push   $0x0
  pushl $223
80105ab2:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80105ab7:	e9 d5 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105abc:	6a 00                	push   $0x0
  pushl $224
80105abe:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80105ac3:	e9 c9 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105ac8:	6a 00                	push   $0x0
  pushl $225
80105aca:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80105acf:	e9 bd f2 ff ff       	jmp    80104d91 <alltraps>
...
80105ad4:	6a 00                	push   $0x0
  pushl $226
80105ad6:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80105adb:	e9 b1 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105ae0:	6a 00                	push   $0x0
  pushl $227
80105ae2:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80105ae7:	e9 a5 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105aec:	6a 00                	push   $0x0
  pushl $228
80105aee:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80105af3:	e9 99 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105af8:	6a 00                	push   $0x0
  pushl $229
80105afa:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80105aff:	e9 8d f2 ff ff       	jmp    80104d91 <alltraps>
...
80105b04:	6a 00                	push   $0x0
  pushl $230
80105b06:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80105b0b:	e9 81 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105b10:	6a 00                	push   $0x0
  pushl $231
80105b12:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80105b17:	e9 75 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105b1c:	6a 00                	push   $0x0
  pushl $232
80105b1e:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80105b23:	e9 69 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105b28:	6a 00                	push   $0x0
  pushl $233
80105b2a:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80105b2f:	e9 5d f2 ff ff       	jmp    80104d91 <alltraps>
...
80105b34:	6a 00                	push   $0x0
  pushl $234
80105b36:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80105b3b:	e9 51 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105b40:	6a 00                	push   $0x0
  pushl $235
80105b42:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80105b47:	e9 45 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105b4c:	6a 00                	push   $0x0
  pushl $236
80105b4e:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80105b53:	e9 39 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105b58:	6a 00                	push   $0x0
  pushl $237
80105b5a:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80105b5f:	e9 2d f2 ff ff       	jmp    80104d91 <alltraps>
...
80105b64:	6a 00                	push   $0x0
  pushl $238
80105b66:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80105b6b:	e9 21 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105b70:	6a 00                	push   $0x0
  pushl $239
80105b72:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80105b77:	e9 15 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105b7c:	6a 00                	push   $0x0
  pushl $240
80105b7e:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80105b83:	e9 09 f2 ff ff       	jmp    80104d91 <alltraps>
...
80105b88:	6a 00                	push   $0x0
  pushl $241
80105b8a:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80105b8f:	e9 fd f1 ff ff       	jmp    80104d91 <alltraps>
...
80105b94:	6a 00                	push   $0x0
  pushl $242
80105b96:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80105b9b:	e9 f1 f1 ff ff       	jmp    80104d91 <alltraps>
...
80105ba0:	6a 00                	push   $0x0
  pushl $243
80105ba2:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80105ba7:	e9 e5 f1 ff ff       	jmp    80104d91 <alltraps>
...
80105bac:	6a 00                	push   $0x0
  pushl $244
80105bae:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80105bb3:	e9 d9 f1 ff ff       	jmp    80104d91 <alltraps>
...
80105bb8:	6a 00                	push   $0x0
  pushl $245
80105bba:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80105bbf:	e9 cd f1 ff ff       	jmp    80104d91 <alltraps>
...
80105bc4:	6a 00                	push   $0x0
  pushl $246
80105bc6:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80105bcb:	e9 c1 f1 ff ff       	jmp    80104d91 <alltraps>
...
80105bd0:	6a 00                	push   $0x0
  pushl $247
80105bd2:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80105bd7:	e9 b5 f1 ff ff       	jmp    80104d91 <alltraps>
...
80105bdc:	6a 00                	push   $0x0
  pushl $248
80105bde:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80105be3:	e9 a9 f1 ff ff       	jmp    80104d91 <alltraps>
...
80105be8:	6a 00                	push   $0x0
  pushl $249
80105bea:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80105bef:	e9 9d f1 ff ff       	jmp    80104d91 <alltraps>
...
80105bf4:	6a 00                	push   $0x0
  pushl $250
80105bf6:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80105bfb:	e9 91 f1 ff ff       	jmp    80104d91 <alltraps>
...
80105c00:	6a 00                	push   $0x0
  pushl $251
80105c02:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80105c07:	e9 85 f1 ff ff       	jmp    80104d91 <alltraps>
...
80105c0c:	6a 00                	push   $0x0
  pushl $252
80105c0e:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80105c13:	e9 79 f1 ff ff       	jmp    80104d91 <alltraps>
...
80105c18:	6a 00                	push   $0x0
  pushl $253
80105c1a:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80105c1f:	e9 6d f1 ff ff       	jmp    80104d91 <alltraps>
...
80105c24:	6a 00                	push   $0x0
  pushl $254
80105c26:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80105c2b:	e9 61 f1 ff ff       	jmp    80104d91 <alltraps>
...
80105c30:	6a 00                	push   $0x0
  pushl $255
80105c32:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80105c37:	e9 55 f1 ff ff       	jmp    80104d91 <alltraps>
...
80105c3f:	57                   	push   %edi
80105c40:	56                   	push   %esi
80105c41:	53                   	push   %ebx
80105c42:	83 ec 0c             	sub    $0xc,%esp
80105c45:	89 d6                	mov    %edx,%esi
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80105c47:	c1 ea 16             	shr    $0x16,%edx
80105c4a:	8d 3c 90             	lea    (%eax,%edx,4),%edi
  if(*pde & PTE_P){
80105c4d:	8b 1f                	mov    (%edi),%ebx
80105c4f:	f6 c3 01             	test   $0x1,%bl
80105c52:	74 22                	je     80105c76 <walkpgdir+0x3a>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80105c54:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80105c5a:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80105c60:	c1 ee 0c             	shr    $0xc,%esi
80105c63:	81 e6 ff 03 00 00    	and    $0x3ff,%esi
80105c69:	8d 1c b3             	lea    (%ebx,%esi,4),%ebx
}
...
80105c76:	85 c9                	test   %ecx,%ecx
80105c78:	74 2b                	je     80105ca5 <walkpgdir+0x69>
80105c7a:	e8 3c c4 ff ff       	call   801020bb <kalloc>
80105c7f:	89 c3                	mov    %eax,%ebx
80105c81:	85 c0                	test   %eax,%eax
80105c83:	74 e7                	je     80105c6c <walkpgdir+0x30>
    memset(pgtab, 0, PGSIZE);
80105c85:	83 ec 04             	sub    $0x4,%esp
80105c88:	68 00 10 00 00       	push   $0x1000
80105c8d:	6a 00                	push   $0x0
80105c8f:	50                   	push   %eax
80105c90:	e8 ac df ff ff       	call   80103c41 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80105c95:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80105c9b:	83 c8 07             	or     $0x7,%eax
80105c9e:	89 07                	mov    %eax,(%edi)
80105ca0:	83 c4 10             	add    $0x10,%esp
80105ca3:	eb bb                	jmp    80105c60 <walkpgdir+0x24>
      return 0;
80105ca5:	bb 00 00 00 00       	mov    $0x0,%ebx
80105caa:	eb c0                	jmp    80105c6c <walkpgdir+0x30>
...
80105cb1:	53                   	push   %ebx
80105cb2:	83 ec 1c             	sub    $0x1c,%esp
80105cb5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105cb8:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80105cbb:	89 d3                	mov    %edx,%ebx
80105cbd:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80105cc3:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
80105cc7:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105ccd:	b9 01 00 00 00       	mov    $0x1,%ecx
80105cd2:	89 da                	mov    %ebx,%edx
80105cd4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105cd7:	e8 60 ff ff ff       	call   80105c3c <walkpgdir>
80105cdc:	85 c0                	test   %eax,%eax
80105cde:	74 2e                	je     80105d0e <mappages+0x62>
      return -1;
    if(*pte & PTE_P)
80105ce0:	f6 00 01             	testb  $0x1,(%eax)
80105ce3:	75 1c                	jne    80105d01 <mappages+0x55>
      panic("remap");
    *pte = pa | perm | PTE_P;
80105ce5:	89 f2                	mov    %esi,%edx
80105ce7:	0b 55 0c             	or     0xc(%ebp),%edx
80105cea:	83 ca 01             	or     $0x1,%edx
80105ced:	89 10                	mov    %edx,(%eax)
    if(a == last)
80105cef:	39 fb                	cmp    %edi,%ebx
80105cf1:	74 28                	je     80105d1b <mappages+0x6f>
      break;
    a += PGSIZE;
80105cf3:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
80105cf9:	81 c6 00 10 00 00    	add    $0x1000,%esi
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105cff:	eb cc                	jmp    80105ccd <mappages+0x21>
      panic("remap");
80105d01:	83 ec 0c             	sub    $0xc,%esp
80105d04:	68 b0 6d 10 80       	push   $0x80106db0
80105d09:	e8 3a a6 ff ff       	call   80100348 <panic>
      return -1;
...
80105d20:	eb f1                	jmp    80105d13 <mappages+0x67>
...
80105d26:	83 ec 14             	sub    $0x14,%esp
  c = &cpus[cpuid()];
80105d29:	e8 ad d4 ff ff       	call   801031db <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80105d2e:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80105d34:	66 c7 80 f8 17 11 80 	movw   $0xffff,-0x7feee808(%eax)
80105d3b:	ff ff 
80105d3d:	66 c7 80 fa 17 11 80 	movw   $0x0,-0x7feee806(%eax)
80105d44:	00 00 
80105d46:	c6 80 fc 17 11 80 00 	movb   $0x0,-0x7feee804(%eax)
80105d4d:	0f b6 88 fd 17 11 80 	movzbl -0x7feee803(%eax),%ecx
80105d54:	83 e1 f0             	and    $0xfffffff0,%ecx
80105d57:	83 c9 1a             	or     $0x1a,%ecx
80105d5a:	83 e1 9f             	and    $0xffffff9f,%ecx
80105d5d:	83 c9 80             	or     $0xffffff80,%ecx
80105d60:	88 88 fd 17 11 80    	mov    %cl,-0x7feee803(%eax)
80105d66:	0f b6 88 fe 17 11 80 	movzbl -0x7feee802(%eax),%ecx
80105d6d:	83 c9 0f             	or     $0xf,%ecx
80105d70:	83 e1 cf             	and    $0xffffffcf,%ecx
80105d73:	83 c9 c0             	or     $0xffffffc0,%ecx
80105d76:	88 88 fe 17 11 80    	mov    %cl,-0x7feee802(%eax)
80105d7c:	c6 80 ff 17 11 80 00 	movb   $0x0,-0x7feee801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80105d83:	66 c7 80 00 18 11 80 	movw   $0xffff,-0x7feee800(%eax)
80105d8a:	ff ff 
80105d8c:	66 c7 80 02 18 11 80 	movw   $0x0,-0x7feee7fe(%eax)
80105d93:	00 00 
80105d95:	c6 80 04 18 11 80 00 	movb   $0x0,-0x7feee7fc(%eax)
80105d9c:	0f b6 88 05 18 11 80 	movzbl -0x7feee7fb(%eax),%ecx
80105da3:	83 e1 f0             	and    $0xfffffff0,%ecx
80105da6:	83 c9 12             	or     $0x12,%ecx
80105da9:	83 e1 9f             	and    $0xffffff9f,%ecx
80105dac:	83 c9 80             	or     $0xffffff80,%ecx
80105daf:	88 88 05 18 11 80    	mov    %cl,-0x7feee7fb(%eax)
80105db5:	0f b6 88 06 18 11 80 	movzbl -0x7feee7fa(%eax),%ecx
80105dbc:	83 c9 0f             	or     $0xf,%ecx
80105dbf:	83 e1 cf             	and    $0xffffffcf,%ecx
80105dc2:	83 c9 c0             	or     $0xffffffc0,%ecx
80105dc5:	88 88 06 18 11 80    	mov    %cl,-0x7feee7fa(%eax)
80105dcb:	c6 80 07 18 11 80 00 	movb   $0x0,-0x7feee7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80105dd2:	66 c7 80 08 18 11 80 	movw   $0xffff,-0x7feee7f8(%eax)
80105dd9:	ff ff 
80105ddb:	66 c7 80 0a 18 11 80 	movw   $0x0,-0x7feee7f6(%eax)
80105de2:	00 00 
80105de4:	c6 80 0c 18 11 80 00 	movb   $0x0,-0x7feee7f4(%eax)
80105deb:	c6 80 0d 18 11 80 fa 	movb   $0xfa,-0x7feee7f3(%eax)
80105df2:	0f b6 88 0e 18 11 80 	movzbl -0x7feee7f2(%eax),%ecx
80105df9:	83 c9 0f             	or     $0xf,%ecx
80105dfc:	83 e1 cf             	and    $0xffffffcf,%ecx
80105dff:	83 c9 c0             	or     $0xffffffc0,%ecx
80105e02:	88 88 0e 18 11 80    	mov    %cl,-0x7feee7f2(%eax)
80105e08:	c6 80 0f 18 11 80 00 	movb   $0x0,-0x7feee7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80105e0f:	66 c7 80 10 18 11 80 	movw   $0xffff,-0x7feee7f0(%eax)
80105e16:	ff ff 
80105e18:	66 c7 80 12 18 11 80 	movw   $0x0,-0x7feee7ee(%eax)
80105e1f:	00 00 
80105e21:	c6 80 14 18 11 80 00 	movb   $0x0,-0x7feee7ec(%eax)
80105e28:	c6 80 15 18 11 80 f2 	movb   $0xf2,-0x7feee7eb(%eax)
80105e2f:	0f b6 88 16 18 11 80 	movzbl -0x7feee7ea(%eax),%ecx
80105e36:	83 c9 0f             	or     $0xf,%ecx
80105e39:	83 e1 cf             	and    $0xffffffcf,%ecx
80105e3c:	83 c9 c0             	or     $0xffffffc0,%ecx
80105e3f:	88 88 16 18 11 80    	mov    %cl,-0x7feee7ea(%eax)
80105e45:	c6 80 17 18 11 80 00 	movb   $0x0,-0x7feee7e9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80105e4c:	05 f0 17 11 80       	add    $0x801117f0,%eax
  pd[0] = size-1;
80105e51:	66 c7 45 f2 2f 00    	movw   $0x2f,-0xe(%ebp)
  pd[1] = (uint)p;
80105e57:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80105e5b:	c1 e8 10             	shr    $0x10,%eax
80105e5e:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80105e62:	8d 45 f2             	lea    -0xe(%ebp),%eax
80105e65:	0f 01 10             	lgdtl  (%eax)
}
80105e68:	83 c4 14             	add    $0x14,%esp
80105e6b:	5b                   	pop    %ebx
80105e6c:	5d                   	pop    %ebp
80105e6d:	c3                   	ret    
...
80105e71:	a1 a4 44 11 80       	mov    0x801144a4,%eax
80105e76:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80105e8e:	0f 84 dd 00 00 00    	je     80105f71 <switchuvm+0xf1>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80105e94:	83 7e 08 00          	cmpl   $0x0,0x8(%esi)
80105e98:	0f 84 e0 00 00 00    	je     80105f7e <switchuvm+0xfe>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80105e9e:	83 7e 04 00          	cmpl   $0x0,0x4(%esi)
80105ea2:	0f 84 e3 00 00 00    	je     80105f8b <switchuvm+0x10b>
    panic("switchuvm: no pgdir");

  pushcli();
80105ea8:	e8 0b dc ff ff       	call   80103ab8 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80105ead:	e8 cd d2 ff ff       	call   8010317f <mycpu>
80105eb2:	89 c3                	mov    %eax,%ebx
80105eb4:	e8 c6 d2 ff ff       	call   8010317f <mycpu>
80105eb9:	8d 78 08             	lea    0x8(%eax),%edi
80105ebc:	e8 be d2 ff ff       	call   8010317f <mycpu>
80105ec1:	83 c0 08             	add    $0x8,%eax
80105ec4:	c1 e8 10             	shr    $0x10,%eax
80105ec7:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105eca:	e8 b0 d2 ff ff       	call   8010317f <mycpu>
80105ecf:	83 c0 08             	add    $0x8,%eax
80105ed2:	c1 e8 18             	shr    $0x18,%eax
80105ed5:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80105edc:	67 00 
80105ede:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80105ee5:	0f b6 4d e4          	movzbl -0x1c(%ebp),%ecx
80105ee9:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80105eef:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80105ef6:	83 e2 f0             	and    $0xfffffff0,%edx
80105ef9:	83 ca 19             	or     $0x19,%edx
80105efc:	83 e2 9f             	and    $0xffffff9f,%edx
80105eff:	83 ca 80             	or     $0xffffff80,%edx
80105f02:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80105f08:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80105f0f:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80105f15:	e8 65 d2 ff ff       	call   8010317f <mycpu>
80105f1a:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80105f21:	83 e2 ef             	and    $0xffffffef,%edx
80105f24:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80105f2a:	e8 50 d2 ff ff       	call   8010317f <mycpu>
80105f2f:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80105f35:	8b 5e 08             	mov    0x8(%esi),%ebx
80105f38:	e8 42 d2 ff ff       	call   8010317f <mycpu>
80105f3d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80105f43:	89 58 0c             	mov    %ebx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80105f46:	e8 34 d2 ff ff       	call   8010317f <mycpu>
80105f4b:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80105f51:	b8 28 00 00 00       	mov    $0x28,%eax
80105f56:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
80105f59:	8b 46 04             	mov    0x4(%esi),%eax
80105f5c:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80105f61:	0f 22 d8             	mov    %eax,%cr3
  popcli();
80105f64:	e8 8c db ff ff       	call   80103af5 <popcli>
}
...
80105f74:	68 b6 6d 10 80       	push   $0x80106db6
80105f79:	e8 ca a3 ff ff       	call   80100348 <panic>
    panic("switchuvm: no kstack");
80105f7e:	83 ec 0c             	sub    $0xc,%esp
80105f81:	68 cc 6d 10 80       	push   $0x80106dcc
80105f86:	e8 bd a3 ff ff       	call   80100348 <panic>
    panic("switchuvm: no pgdir");
80105f8b:	83 ec 0c             	sub    $0xc,%esp
80105f8e:	68 e1 6d 10 80       	push   $0x80106de1
80105f93:	e8 b0 a3 ff ff       	call   80100348 <panic>
...
80105f9d:	8b 75 10             	mov    0x10(%ebp),%esi
  char *mem;

  if(sz >= PGSIZE)
80105fa0:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80105fa6:	77 4c                	ja     80105ff4 <inituvm+0x5c>
    panic("inituvm: more than a page");
  mem = kalloc();
80105fa8:	e8 0e c1 ff ff       	call   801020bb <kalloc>
80105fad:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80105faf:	83 ec 04             	sub    $0x4,%esp
80105fb2:	68 00 10 00 00       	push   $0x1000
80105fb7:	6a 00                	push   $0x0
80105fb9:	50                   	push   %eax
80105fba:	e8 82 dc ff ff       	call   80103c41 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80105fbf:	83 c4 08             	add    $0x8,%esp
80105fc2:	6a 06                	push   $0x6
80105fc4:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80105fca:	50                   	push   %eax
80105fcb:	b9 00 10 00 00       	mov    $0x1000,%ecx
80105fd0:	ba 00 00 00 00       	mov    $0x0,%edx
80105fd5:	8b 45 08             	mov    0x8(%ebp),%eax
80105fd8:	e8 cf fc ff ff       	call   80105cac <mappages>
  memmove(mem, init, sz);
80105fdd:	83 c4 0c             	add    $0xc,%esp
80105fe0:	56                   	push   %esi
80105fe1:	ff 75 0c             	pushl  0xc(%ebp)
80105fe4:	53                   	push   %ebx
80105fe5:	e8 d2 dc ff ff       	call   80103cbc <memmove>
}
80105fea:	83 c4 10             	add    $0x10,%esp
80105fed:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105ff0:	5b                   	pop    %ebx
80105ff1:	5e                   	pop    %esi
80105ff2:	5d                   	pop    %ebp
80105ff3:	c3                   	ret    
...
80105ff7:	68 f5 6d 10 80       	push   $0x80106df5
80105ffc:	e8 47 a3 ff ff       	call   80100348 <panic>
...
80106006:	53                   	push   %ebx
80106007:	83 ec 0c             	sub    $0xc,%esp
8010600a:	8b 7d 18             	mov    0x18(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
8010600d:	f7 45 0c ff 0f 00 00 	testl  $0xfff,0xc(%ebp)
80106014:	75 07                	jne    8010601d <loaduvm+0x1c>
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80106016:	bb 00 00 00 00       	mov    $0x0,%ebx
8010601b:	eb 3c                	jmp    80106059 <loaduvm+0x58>
    panic("loaduvm: addr must be page aligned");
8010601d:	83 ec 0c             	sub    $0xc,%esp
80106020:	68 b0 6e 10 80       	push   $0x80106eb0
80106025:	e8 1e a3 ff ff       	call   80100348 <panic>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
8010602a:	83 ec 0c             	sub    $0xc,%esp
8010602d:	68 0f 6e 10 80       	push   $0x80106e0f
...
80106037:	05 00 00 00 80       	add    $0x80000000,%eax
8010603c:	56                   	push   %esi
8010603d:	89 da                	mov    %ebx,%edx
8010603f:	03 55 14             	add    0x14(%ebp),%edx
80106042:	52                   	push   %edx
80106043:	50                   	push   %eax
80106044:	ff 75 10             	pushl  0x10(%ebp)
80106047:	e8 27 b7 ff ff       	call   80101773 <readi>
8010604c:	83 c4 10             	add    $0x10,%esp
8010604f:	39 f0                	cmp    %esi,%eax
80106051:	75 47                	jne    8010609a <loaduvm+0x99>
  for(i = 0; i < sz; i += PGSIZE){
80106053:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106059:	39 fb                	cmp    %edi,%ebx
8010605b:	73 30                	jae    8010608d <loaduvm+0x8c>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
8010605d:	89 da                	mov    %ebx,%edx
8010605f:	03 55 0c             	add    0xc(%ebp),%edx
80106062:	b9 00 00 00 00       	mov    $0x0,%ecx
80106067:	8b 45 08             	mov    0x8(%ebp),%eax
8010606a:	e8 cd fb ff ff       	call   80105c3c <walkpgdir>
8010606f:	85 c0                	test   %eax,%eax
80106071:	74 b7                	je     8010602a <loaduvm+0x29>
    pa = PTE_ADDR(*pte);
80106073:	8b 00                	mov    (%eax),%eax
80106075:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
8010607a:	89 fe                	mov    %edi,%esi
8010607c:	29 de                	sub    %ebx,%esi
8010607e:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106084:	76 b1                	jbe    80106037 <loaduvm+0x36>
      n = PGSIZE;
80106086:	be 00 10 00 00       	mov    $0x1000,%esi
8010608b:	eb aa                	jmp    80106037 <loaduvm+0x36>
      return -1;
  }
  return 0;
8010608d:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
8010609f:	eb f1                	jmp    80106092 <loaduvm+0x91>
...
801060aa:	8b 7d 0c             	mov    0xc(%ebp),%edi
  ...
  if(newsz >= oldsz)
801060ad:	39 7d 10             	cmp    %edi,0x10(%ebp)
801060b0:	73 11                	jae    801060c3 <deallocuvm+0x22>
    return oldsz;

  a = PGROUNDUP(newsz);
801060b2:	8b 45 10             	mov    0x10(%ebp),%eax
801060b5:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
801060bb:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801060c1:	eb 19                	jmp    801060dc <deallocuvm+0x3b>
    return oldsz;
801060c3:	89 f8                	mov    %edi,%eax
801060c5:	eb 64                	jmp    8010612b <deallocuvm+0x8a>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801060c7:	c1 eb 16             	shr    $0x16,%ebx
801060ca:	83 c3 01             	add    $0x1,%ebx
801060cd:	c1 e3 16             	shl    $0x16,%ebx
801060d0:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801060d6:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801060dc:	39 fb                	cmp    %edi,%ebx
801060de:	73 48                	jae    80106128 <deallocuvm+0x87>
    pte = walkpgdir(pgdir, (char*)a, 0);
801060e0:	b9 00 00 00 00       	mov    $0x0,%ecx
801060e5:	89 da                	mov    %ebx,%edx
801060e7:	8b 45 08             	mov    0x8(%ebp),%eax
801060ea:	e8 4d fb ff ff       	call   80105c3c <walkpgdir>
801060ef:	89 c6                	mov    %eax,%esi
    if(!pte)
801060f1:	85 c0                	test   %eax,%eax
801060f3:	74 d2                	je     801060c7 <deallocuvm+0x26>
    else if((*pte & PTE_P) != 0){
801060f5:	8b 00                	mov    (%eax),%eax
801060f7:	a8 01                	test   $0x1,%al
801060f9:	74 db                	je     801060d6 <deallocuvm+0x35>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
801060fb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106100:	74 19                	je     8010611b <deallocuvm+0x7a>
        panic("kfree");
      char *v = P2V(pa);
80106102:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
80106107:	83 ec 0c             	sub    $0xc,%esp
8010610a:	50                   	push   %eax
8010610b:	e8 94 be ff ff       	call   80101fa4 <kfree>
      *pte = 0;
80106110:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80106116:	83 c4 10             	add    $0x10,%esp
80106119:	eb bb                	jmp    801060d6 <deallocuvm+0x35>
        panic("kfree");
8010611b:	83 ec 0c             	sub    $0xc,%esp
8010611e:	68 46 67 10 80       	push   $0x80106746
80106123:	e8 20 a2 ff ff       	call   80100348 <panic>
    }
  }
  return newsz;
...
80106139:	83 ec 1c             	sub    $0x1c,%esp
8010613c:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz >= KERNBASE)
8010613f:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106142:	85 ff                	test   %edi,%edi
80106144:	0f 88 c1 00 00 00    	js     8010620b <allocuvm+0xd8>
  if(newsz < oldsz)
8010614a:	3b 7d 0c             	cmp    0xc(%ebp),%edi
8010614d:	72 5c                	jb     801061ab <allocuvm+0x78>
  a = PGROUNDUP(oldsz);
8010614f:	8b 45 0c             	mov    0xc(%ebp),%eax
80106152:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106158:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
8010615e:	39 fb                	cmp    %edi,%ebx
80106160:	0f 83 ac 00 00 00    	jae    80106212 <allocuvm+0xdf>
    mem = kalloc();
80106166:	e8 50 bf ff ff       	call   801020bb <kalloc>
8010616b:	89 c6                	mov    %eax,%esi
    if(mem == 0){
8010616d:	85 c0                	test   %eax,%eax
8010616f:	74 42                	je     801061b3 <allocuvm+0x80>
    memset(mem, 0, PGSIZE);
80106171:	83 ec 04             	sub    $0x4,%esp
80106174:	68 00 10 00 00       	push   $0x1000
80106179:	6a 00                	push   $0x0
8010617b:	50                   	push   %eax
8010617c:	e8 c0 da ff ff       	call   80103c41 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106181:	83 c4 08             	add    $0x8,%esp
80106184:	6a 06                	push   $0x6
80106186:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
8010618c:	50                   	push   %eax
8010618d:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106192:	89 da                	mov    %ebx,%edx
80106194:	8b 45 08             	mov    0x8(%ebp),%eax
80106197:	e8 10 fb ff ff       	call   80105cac <mappages>
8010619c:	83 c4 10             	add    $0x10,%esp
8010619f:	85 c0                	test   %eax,%eax
801061a1:	78 38                	js     801061db <allocuvm+0xa8>
  for(; a < newsz; a += PGSIZE){
801061a3:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801061a9:	eb b3                	jmp    8010615e <allocuvm+0x2b>
    return oldsz;
801061ab:	8b 45 0c             	mov    0xc(%ebp),%eax
801061ae:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801061b1:	eb 5f                	jmp    80106212 <allocuvm+0xdf>
      cprintf("allocuvm out of memory\n");
801061b3:	83 ec 0c             	sub    $0xc,%esp
801061b6:	68 2d 6e 10 80       	push   $0x80106e2d
801061bb:	e8 4b a4 ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801061c0:	83 c4 0c             	add    $0xc,%esp
801061c3:	ff 75 0c             	pushl  0xc(%ebp)
801061c6:	57                   	push   %edi
801061c7:	ff 75 08             	pushl  0x8(%ebp)
801061ca:	e8 d2 fe ff ff       	call   801060a1 <deallocuvm>
      return 0;
801061cf:	83 c4 10             	add    $0x10,%esp
801061d2:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801061d9:	eb 37                	jmp    80106212 <allocuvm+0xdf>
      cprintf("allocuvm out of memory (2)\n");
801061db:	83 ec 0c             	sub    $0xc,%esp
801061de:	68 45 6e 10 80       	push   $0x80106e45
801061e3:	e8 23 a4 ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801061e8:	83 c4 0c             	add    $0xc,%esp
801061eb:	ff 75 0c             	pushl  0xc(%ebp)
801061ee:	57                   	push   %edi
801061ef:	ff 75 08             	pushl  0x8(%ebp)
801061f2:	e8 aa fe ff ff       	call   801060a1 <deallocuvm>
      kfree(mem);
801061f7:	89 34 24             	mov    %esi,(%esp)
801061fa:	e8 a5 bd ff ff       	call   80101fa4 <kfree>
      return 0;
801061ff:	83 c4 10             	add    $0x10,%esp
80106202:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80106209:	eb 07                	jmp    80106212 <allocuvm+0xdf>
    return 0;
8010620b:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
80106212:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106215:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106218:	5b                   	pop    %ebx
80106219:	5e                   	pop    %esi
8010621a:	5f                   	pop    %edi
8010621b:	5d                   	pop    %ebp
...
80106222:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
80106225:	85 f6                	test   %esi,%esi
80106227:	74 1a                	je     80106243 <freevm+0x26>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
80106229:	83 ec 04             	sub    $0x4,%esp
8010622c:	6a 00                	push   $0x0
8010622e:	68 00 00 00 80       	push   $0x80000000
80106233:	56                   	push   %esi
80106234:	e8 68 fe ff ff       	call   801060a1 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80106239:	83 c4 10             	add    $0x10,%esp
8010623c:	bb 00 00 00 00       	mov    $0x0,%ebx
80106241:	eb 10                	jmp    80106253 <freevm+0x36>
    panic("freevm: no pgdir");
80106243:	83 ec 0c             	sub    $0xc,%esp
80106246:	68 61 6e 10 80       	push   $0x80106e61
8010624b:	e8 f8 a0 ff ff       	call   80100348 <panic>
  for(i = 0; i < NPDENTRIES; i++){
80106250:	83 c3 01             	add    $0x1,%ebx
80106253:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
80106259:	77 1f                	ja     8010627a <freevm+0x5d>
    if(pgdir[i] & PTE_P){
8010625b:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
8010625e:	a8 01                	test   $0x1,%al
80106260:	74 ee                	je     80106250 <freevm+0x33>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106262:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106267:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
8010626c:	83 ec 0c             	sub    $0xc,%esp
8010626f:	50                   	push   %eax
80106270:	e8 2f bd ff ff       	call   80101fa4 <kfree>
80106275:	83 c4 10             	add    $0x10,%esp
80106278:	eb d6                	jmp    80106250 <freevm+0x33>
    }
  }
  kfree((char*)pgdir);
8010627a:	83 ec 0c             	sub    $0xc,%esp
8010627d:	56                   	push   %esi
8010627e:	e8 21 bd ff ff       	call   80101fa4 <kfree>
}
80106283:	83 c4 10             	add    $0x10,%esp
80106286:	8d 65 f8             	lea    -0x8(%ebp),%esp
80106289:	5b                   	pop    %ebx
8010628a:	5e                   	pop    %esi
8010628b:	5d                   	pop    %ebp
8010628c:	c3                   	ret    
...
80106292:	e8 24 be ff ff       	call   801020bb <kalloc>
80106297:	89 c6                	mov    %eax,%esi
80106299:	85 c0                	test   %eax,%eax
8010629b:	74 55                	je     801062f2 <setupkvm+0x65>
  memset(pgdir, 0, PGSIZE);
8010629d:	83 ec 04             	sub    $0x4,%esp
801062a0:	68 00 10 00 00       	push   $0x1000
801062a5:	6a 00                	push   $0x0
801062a7:	50                   	push   %eax
801062a8:	e8 94 d9 ff ff       	call   80103c41 <memset>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801062ad:	83 c4 10             	add    $0x10,%esp
801062b0:	bb 20 94 10 80       	mov    $0x80109420,%ebx
801062b5:	81 fb 60 94 10 80    	cmp    $0x80109460,%ebx
801062bb:	73 35                	jae    801062f2 <setupkvm+0x65>
                (uint)k->phys_start, k->perm) < 0) {
801062bd:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
801062c0:	8b 4b 08             	mov    0x8(%ebx),%ecx
801062c3:	29 c1                	sub    %eax,%ecx
801062c5:	83 ec 08             	sub    $0x8,%esp
801062c8:	ff 73 0c             	pushl  0xc(%ebx)
801062cb:	50                   	push   %eax
801062cc:	8b 13                	mov    (%ebx),%edx
801062ce:	89 f0                	mov    %esi,%eax
801062d0:	e8 d7 f9 ff ff       	call   80105cac <mappages>
801062d5:	83 c4 10             	add    $0x10,%esp
801062d8:	85 c0                	test   %eax,%eax
801062da:	78 05                	js     801062e1 <setupkvm+0x54>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801062dc:	83 c3 10             	add    $0x10,%ebx
801062df:	eb d4                	jmp    801062b5 <setupkvm+0x28>
      freevm(pgdir);
801062e1:	83 ec 0c             	sub    $0xc,%esp
801062e4:	56                   	push   %esi
801062e5:	e8 33 ff ff ff       	call   8010621d <freevm>
      return 0;
801062ea:	83 c4 10             	add    $0x10,%esp
801062ed:	be 00 00 00 00       	mov    $0x0,%esi
}
801062f2:	89 f0                	mov    %esi,%eax
801062f4:	8d 65 f8             	lea    -0x8(%ebp),%esp
801062f7:	5b                   	pop    %ebx
801062f8:	5e                   	pop    %esi
801062f9:	5d                   	pop    %ebp
801062fa:	c3                   	ret    
...
801062fe:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106301:	e8 87 ff ff ff       	call   8010628d <setupkvm>
80106306:	a3 a4 44 11 80       	mov    %eax,0x801144a4
  switchkvm();
8010630b:	e8 5e fb ff ff       	call   80105e6e <switchkvm>
}
80106310:	c9                   	leave  
80106311:	c3                   	ret    
...
8010631d:	8b 55 0c             	mov    0xc(%ebp),%edx
80106320:	8b 45 08             	mov    0x8(%ebp),%eax
80106323:	e8 14 f9 ff ff       	call   80105c3c <walkpgdir>
  if(pte == 0)
80106328:	85 c0                	test   %eax,%eax
8010632a:	74 05                	je     80106331 <clearpteu+0x1f>
    panic("clearpteu");
  *pte &= ~PTE_U;
8010632c:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
8010632f:	c9                   	leave  
80106330:	c3                   	ret    
    panic("clearpteu");
80106331:	83 ec 0c             	sub    $0xc,%esp
80106334:	68 72 6e 10 80       	push   $0x80106e72
...
80106344:	83 ec 1c             	sub    $0x1c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80106347:	e8 41 ff ff ff       	call   8010628d <setupkvm>
8010634c:	89 45 dc             	mov    %eax,-0x24(%ebp)
8010634f:	85 c0                	test   %eax,%eax
80106351:	0f 84 c4 00 00 00    	je     8010641b <copyuvm+0xdd>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106357:	bf 00 00 00 00       	mov    $0x0,%edi
8010635c:	3b 7d 0c             	cmp    0xc(%ebp),%edi
8010635f:	0f 83 b6 00 00 00    	jae    8010641b <copyuvm+0xdd>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106365:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106368:	b9 00 00 00 00       	mov    $0x0,%ecx
8010636d:	89 fa                	mov    %edi,%edx
8010636f:	8b 45 08             	mov    0x8(%ebp),%eax
80106372:	e8 c5 f8 ff ff       	call   80105c3c <walkpgdir>
80106377:	85 c0                	test   %eax,%eax
80106379:	74 65                	je     801063e0 <copyuvm+0xa2>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
8010637b:	8b 00                	mov    (%eax),%eax
8010637d:	a8 01                	test   $0x1,%al
8010637f:	74 6c                	je     801063ed <copyuvm+0xaf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106381:	89 c6                	mov    %eax,%esi
80106383:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    flags = PTE_FLAGS(*pte);
80106389:	25 ff 0f 00 00       	and    $0xfff,%eax
8010638e:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if((mem = kalloc()) == 0)
80106391:	e8 25 bd ff ff       	call   801020bb <kalloc>
80106396:	89 c3                	mov    %eax,%ebx
80106398:	85 c0                	test   %eax,%eax
8010639a:	74 6a                	je     80106406 <copyuvm+0xc8>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
8010639c:	81 c6 00 00 00 80    	add    $0x80000000,%esi
801063a2:	83 ec 04             	sub    $0x4,%esp
801063a5:	68 00 10 00 00       	push   $0x1000
801063aa:	56                   	push   %esi
801063ab:	50                   	push   %eax
801063ac:	e8 0b d9 ff ff       	call   80103cbc <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801063b1:	83 c4 08             	add    $0x8,%esp
801063b4:	ff 75 e0             	pushl  -0x20(%ebp)
801063b7:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801063bd:	50                   	push   %eax
801063be:	b9 00 10 00 00       	mov    $0x1000,%ecx
801063c3:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801063c6:	8b 45 dc             	mov    -0x24(%ebp),%eax
801063c9:	e8 de f8 ff ff       	call   80105cac <mappages>
801063ce:	83 c4 10             	add    $0x10,%esp
801063d1:	85 c0                	test   %eax,%eax
801063d3:	78 25                	js     801063fa <copyuvm+0xbc>
  for(i = 0; i < sz; i += PGSIZE){
801063d5:	81 c7 00 10 00 00    	add    $0x1000,%edi
801063db:	e9 7c ff ff ff       	jmp    8010635c <copyuvm+0x1e>
      panic("copyuvm: pte should exist");
801063e0:	83 ec 0c             	sub    $0xc,%esp
801063e3:	68 7c 6e 10 80       	push   $0x80106e7c
801063e8:	e8 5b 9f ff ff       	call   80100348 <panic>
      panic("copyuvm: page not present");
801063ed:	83 ec 0c             	sub    $0xc,%esp
801063f0:	68 96 6e 10 80       	push   $0x80106e96
801063f5:	e8 4e 9f ff ff       	call   80100348 <panic>
      kfree(mem);
801063fa:	83 ec 0c             	sub    $0xc,%esp
801063fd:	53                   	push   %ebx
801063fe:	e8 a1 bb ff ff       	call   80101fa4 <kfree>
      goto bad;
...
8010640c:	e8 0c fe ff ff       	call   8010621d <freevm>
  return 0;
...
80106437:	e8 00 f8 ff ff       	call   80105c3c <walkpgdir>
  if((*pte & PTE_P) == 0)
...
8010647d:	e8 3a d8 ff ff       	call   80103cbc <memmove>
    len -= n;
