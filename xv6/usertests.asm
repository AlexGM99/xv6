...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       ...
       b:	ff 35 64 5b 00 00    	pushl  0x5b64
      11:	e8 54 38 00 00       	call   386a <printf>
  ...
  printf(stdout, "iput test ok\n");
      ...
      6d:	ff 35 64 5b 00 00    	pushl  0x5b64
      73:	e8 f2 37 00 00       	call   386a <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
      ...
      85:	ff 35 64 5b 00 00    	pushl  0x5b64
      8b:	e8 da 37 00 00       	call   386a <printf>
    exit();
      90:	e8 8b 36 00 00       	call   3720 <exit>
    printf(stdout, "chdir iputdir failed\n");
      95:	83 ec 08             	sub    $0x8,%esp
      98:	68 32 3b 00 00       	push   $0x3b32
      9d:	ff 35 64 5b 00 00    	pushl  0x5b64
      a3:	e8 c2 37 00 00       	call   386a <printf>
    exit();
      a8:	e8 73 36 00 00       	call   3720 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
      ad:	83 ec 08             	sub    $0x8,%esp
      b0:	68 53 3b 00 00       	push   $0x3b53
      b5:	ff 35 64 5b 00 00    	pushl  0x5b64
      bb:	e8 aa 37 00 00       	call   386a <printf>
    exit();
      c0:	e8 5b 36 00 00       	call   3720 <exit>
    printf(stdout, "chdir / failed\n");
      c5:	83 ec 08             	sub    $0x8,%esp
      c8:	68 6f 3b 00 00       	push   $0x3b6f
      cd:	ff 35 64 5b 00 00    	pushl  0x5b64
      d3:	e8 92 37 00 00       	call   386a <printf>
    exit();
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      e8:	ff 35 64 5b 00 00    	pushl  0x5b64
      ee:	e8 77 37 00 00       	call   386a <printf>
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     10a:	68 4b 3b 00 00       	push   $0x3b4b
    ...
    if(chdir("iputdir") < 0){
     ...
     11e:	68 4b 3b 00 00       	push   $0x3b4b
    ...
    if(unlink("../iputdir") < 0){
     ...
     132:	68 48 3b 00 00       	push   $0x3b48
    ...
    printf(stdout, "fork failed\n");
     ...
     14b:	68 65 4a 00 00       	push   $0x4a65
     150:	ff 35 64 5b 00 00    	pushl  0x5b64
     156:	e8 0f 37 00 00       	call   386a <printf>
    exit();
     15b:	e8 c0 35 00 00       	call   3720 <exit>
      printf(stdout, "mkdir failed\n");
     160:	83 ec 08             	sub    $0x8,%esp
     163:	68 24 3b 00 00       	push   $0x3b24
     168:	ff 35 64 5b 00 00    	pushl  0x5b64
     16e:	e8 f7 36 00 00       	call   386a <printf>
      exit();
     173:	e8 a8 35 00 00       	call   3720 <exit>
      printf(stdout, "child chdir failed\n");
     178:	83 ec 08             	sub    $0x8,%esp
     17b:	68 8e 3b 00 00       	push   $0x3b8e
     180:	ff 35 64 5b 00 00    	pushl  0x5b64
     186:	e8 df 36 00 00       	call   386a <printf>
      exit();
     18b:	e8 90 35 00 00       	call   3720 <exit>
      printf(stdout, "unlink ../iputdir failed\n");
     190:	83 ec 08             	sub    $0x8,%esp
     193:	68 53 3b 00 00       	push   $0x3b53
     198:	ff 35 64 5b 00 00    	pushl  0x5b64
     19e:	e8 c7 36 00 00       	call   386a <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1b0:	68 a2 3b 00 00       	push   $0x3ba2
     1b5:	ff 35 64 5b 00 00    	pushl  0x5b64
     1bb:	e8 aa 36 00 00       	call   386a <printf>
}
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cb:	68 b4 3b 00 00       	push   $0x3bb4
     1d0:	ff 35 64 5b 00 00    	pushl  0x5b64
     1d6:	e8 8f 36 00 00       	call   386a <printf>
  if(mkdir("oidir") < 0){
     1db:	c7 04 24 c3 3b 00 00 	movl   $0x3bc3,(%esp)
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     1fe:	6a 02                	push   $0x2
     200:	68 c3 3b 00 00       	push   $0x3bc3
    ...
    if(fd >= 0){
     ...
     214:	68 48 4b 00 00       	push   $0x4b48
     219:	ff 35 64 5b 00 00    	pushl  0x5b64
     21f:	e8 46 36 00 00       	call   386a <printf>
      exit();
     224:	e8 f7 34 00 00       	call   3720 <exit>
    printf(stdout, "mkdir oidir failed\n");
     229:	83 ec 08             	sub    $0x8,%esp
     22c:	68 c9 3b 00 00       	push   $0x3bc9
     231:	ff 35 64 5b 00 00    	pushl  0x5b64
     237:	e8 2e 36 00 00       	call   386a <printf>
    exit();
     23c:	e8 df 34 00 00       	call   3720 <exit>
    printf(stdout, "fork failed\n");
     241:	83 ec 08             	sub    $0x8,%esp
     244:	68 65 4a 00 00       	push   $0x4a65
     249:	ff 35 64 5b 00 00    	pushl  0x5b64
     24f:	e8 16 36 00 00       	call   386a <printf>
    exit();
  ...
  if(unlink("oidir") != 0){
     268:	c7 04 24 c3 3b 00 00 	movl   $0x3bc3,(%esp)
  ...
  printf(stdout, "openiput test ok\n");
     ...
     283:	68 ec 3b 00 00       	push   $0x3bec
     288:	ff 35 64 5b 00 00    	pushl  0x5b64
     28e:	e8 d7 35 00 00       	call   386a <printf>
}
    ...
    printf(stdout, "unlink failed\n");
     ...
     29b:	68 dd 3b 00 00       	push   $0x3bdd
     2a0:	ff 35 64 5b 00 00    	pushl  0x5b64
     2a6:	e8 bf 35 00 00       	call   386a <printf>
    exit();
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2b6:	68 fe 3b 00 00       	push   $0x3bfe
     2bb:	ff 35 64 5b 00 00    	pushl  0x5b64
     2c1:	e8 a4 35 00 00       	call   386a <printf>
  fd = open("echo", 0);
     2c6:	83 c4 08             	add    $0x8,%esp
     2c9:	6a 00                	push   $0x0
     2cb:	68 09 3c 00 00       	push   $0x3c09
  ...
  fd = open("doesnotexist", 0);
     ...
     2e8:	6a 00                	push   $0x0
     2ea:	68 21 3c 00 00       	push   $0x3c21
  ...
  printf(stdout, "open test ok\n");
     ...
     2fe:	68 4c 3c 00 00       	push   $0x3c4c
     303:	ff 35 64 5b 00 00    	pushl  0x5b64
     309:	e8 5c 35 00 00       	call   386a <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     ...
     316:	68 0e 3c 00 00       	push   $0x3c0e
     31b:	ff 35 64 5b 00 00    	pushl  0x5b64
     321:	e8 44 35 00 00       	call   386a <printf>
    exit();
     326:	e8 f5 33 00 00       	call   3720 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     32b:	83 ec 08             	sub    $0x8,%esp
     32e:	68 2e 3c 00 00       	push   $0x3c2e
     333:	ff 35 64 5b 00 00    	pushl  0x5b64
     339:	e8 2c 35 00 00       	call   386a <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     34b:	68 5a 3c 00 00       	push   $0x3c5a
     350:	ff 35 64 5b 00 00    	pushl  0x5b64
     356:	e8 0f 35 00 00       	call   386a <printf>
  fd = open("small", O_CREATE|O_RDWR);
     35b:	83 c4 08             	add    $0x8,%esp
     35e:	68 02 02 00 00       	push   $0x202
     363:	68 6b 3c 00 00       	push   $0x3c6b
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     379:	68 71 3c 00 00       	push   $0x3c71
     37e:	ff 35 64 5b 00 00    	pushl  0x5b64
     384:	e8 e1 34 00 00       	call   386a <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     399:	6a 0a                	push   $0xa
     39b:	68 a8 3c 00 00       	push   $0x3ca8
     3a0:	56                   	push   %esi
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     3b1:	6a 0a                	push   $0xa
     3b3:	68 b3 3c 00 00       	push   $0x3cb3
     3b8:	56                   	push   %esi
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3ce:	68 8c 3c 00 00       	push   $0x3c8c
     3d3:	ff 35 64 5b 00 00    	pushl  0x5b64
     3d9:	e8 8c 34 00 00       	call   386a <printf>
    exit();
     3de:	e8 3d 33 00 00       	call   3720 <exit>
      printf(stdout, "error: write aa %d new file failed\n", i);
     3e3:	83 ec 04             	sub    $0x4,%esp
     3e6:	53                   	push   %ebx
     3e7:	68 6c 4b 00 00       	push   $0x4b6c
     3ec:	ff 35 64 5b 00 00    	pushl  0x5b64
     3f2:	e8 73 34 00 00       	call   386a <printf>
      exit();
     3f7:	e8 24 33 00 00       	call   3720 <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     3fc:	83 ec 04             	sub    $0x4,%esp
     3ff:	53                   	push   %ebx
     400:	68 90 4b 00 00       	push   $0x4b90
     405:	ff 35 64 5b 00 00    	pushl  0x5b64
     40b:	e8 5a 34 00 00       	call   386a <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     ...
     418:	68 be 3c 00 00       	push   $0x3cbe
     41d:	ff 35 64 5b 00 00    	pushl  0x5b64
     423:	e8 42 34 00 00       	call   386a <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     433:	6a 00                	push   $0x0
     435:	68 6b 3c 00 00       	push   $0x3c6b
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     44b:	68 c9 3c 00 00       	push   $0x3cc9
     450:	ff 35 64 5b 00 00    	pushl  0x5b64
     456:	e8 0f 34 00 00       	call   386a <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     47b:	68 fd 3c 00 00       	push   $0x3cfd
     480:	ff 35 64 5b 00 00    	pushl  0x5b64
     486:	e8 df 33 00 00       	call   386a <printf>
  } else {
  ...
  if(unlink("small") < 0){
     493:	c7 04 24 6b 3c 00 00 	movl   $0x3c6b,(%esp)
  ...
  printf(stdout, "small file test ok\n");
     ...
     4a9:	68 25 3d 00 00       	push   $0x3d25
     4ae:	ff 35 64 5b 00 00    	pushl  0x5b64
     4b4:	e8 b1 33 00 00       	call   386a <printf>
}
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     4c6:	68 e2 3c 00 00       	push   $0x3ce2
     4cb:	ff 35 64 5b 00 00    	pushl  0x5b64
     4d1:	e8 94 33 00 00       	call   386a <printf>
    exit();
     4d6:	e8 45 32 00 00       	call   3720 <exit>
    printf(stdout, "read failed\n");
     4db:	83 ec 08             	sub    $0x8,%esp
     4de:	68 29 40 00 00       	push   $0x4029
     4e3:	ff 35 64 5b 00 00    	pushl  0x5b64
     4e9:	e8 7c 33 00 00       	call   386a <printf>
    exit();
     4ee:	e8 2d 32 00 00       	call   3720 <exit>
    printf(stdout, "unlink small failed\n");
     4f3:	83 ec 08             	sub    $0x8,%esp
     4f6:	68 10 3d 00 00       	push   $0x3d10
     4fb:	ff 35 64 5b 00 00    	pushl  0x5b64
     501:	e8 64 33 00 00       	call   386a <printf>
    exit();
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     513:	68 39 3d 00 00       	push   $0x3d39
     518:	ff 35 64 5b 00 00    	pushl  0x5b64
     51e:	e8 47 33 00 00       	call   386a <printf>

  fd = open("big", O_CREATE|O_RDWR);
     523:	83 c4 08             	add    $0x8,%esp
     526:	68 02 02 00 00       	push   $0x202
     52b:	68 b3 3d 00 00       	push   $0x3db3
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     576:	68 49 3d 00 00       	push   $0x3d49
     57b:	ff 35 64 5b 00 00    	pushl  0x5b64
     581:	e8 e4 32 00 00       	call   386a <printf>
    exit();
     586:	e8 95 31 00 00       	call   3720 <exit>
      printf(stdout, "error: write big file failed\n", i);
     58b:	83 ec 04             	sub    $0x4,%esp
     58e:	53                   	push   %ebx
     58f:	68 63 3d 00 00       	push   $0x3d63
     594:	ff 35 64 5b 00 00    	pushl  0x5b64
     59a:	e8 cb 32 00 00       	call   386a <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     5b0:	6a 00                	push   $0x0
     5b2:	68 b3 3d 00 00       	push   $0x3db3
  ...
  for(;;){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     604:	68 81 3d 00 00       	push   $0x3d81
     609:	ff 35 64 5b 00 00    	pushl  0x5b64
     60f:	e8 56 32 00 00       	call   386a <printf>
    exit();
  ...
  if(unlink("big") < 0){
     62a:	c7 04 24 b3 3d 00 00 	movl   $0x3db3,(%esp)
  ...
  printf(stdout, "big files ok\n");
     ...
     640:	68 da 3d 00 00       	push   $0x3dda
     645:	ff 35 64 5b 00 00    	pushl  0x5b64
     64b:	e8 1a 32 00 00       	call   386a <printf>
}
     ...
     65d:	53                   	push   %ebx
     65e:	68 9a 3d 00 00       	push   $0x3d9a
     663:	ff 35 64 5b 00 00    	pushl  0x5b64
     669:	e8 fc 31 00 00       	call   386a <printf>
        exit();
     66e:	e8 ad 30 00 00       	call   3720 <exit>
      printf(stdout, "read failed %d\n", i);
     673:	83 ec 04             	sub    $0x4,%esp
     676:	50                   	push   %eax
     677:	68 b7 3d 00 00       	push   $0x3db7
     67c:	ff 35 64 5b 00 00    	pushl  0x5b64
     682:	e8 e3 31 00 00       	call   386a <printf>
      exit();
     687:	e8 94 30 00 00       	call   3720 <exit>
      printf(stdout, "read content of block %d is %d\n",
     68c:	50                   	push   %eax
     68d:	53                   	push   %ebx
     68e:	68 b4 4b 00 00       	push   $0x4bb4
     693:	ff 35 64 5b 00 00    	pushl  0x5b64
     699:	e8 cc 31 00 00       	call   386a <printf>
      exit();
     69e:	e8 7d 30 00 00       	call   3720 <exit>
    printf(stdout, "unlink big failed\n");
     6a3:	83 ec 08             	sub    $0x8,%esp
     6a6:	68 c7 3d 00 00       	push   $0x3dc7
     6ab:	ff 35 64 5b 00 00    	pushl  0x5b64
     6b1:	e8 b4 31 00 00       	call   386a <printf>
    exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     6c2:	68 d4 4b 00 00       	push   $0x4bd4
     6c7:	ff 35 64 5b 00 00    	pushl  0x5b64
     6cd:	e8 98 31 00 00       	call   386a <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     74f:	68 fc 4b 00 00       	push   $0x4bfc
     754:	ff 35 64 5b 00 00    	pushl  0x5b64
     75a:	e8 0b 31 00 00       	call   386a <printf>
}
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     76d:	68 e8 3d 00 00       	push   $0x3de8
     772:	ff 35 64 5b 00 00    	pushl  0x5b64
     778:	e8 ed 30 00 00       	call   386a <printf>

  if(mkdir("dir0") < 0){
     77d:	c7 04 24 f4 3d 00 00 	movl   $0x3df4,(%esp)
  ...
  if(chdir("dir0") < 0){
     ...
     793:	68 f4 3d 00 00       	push   $0x3df4
  ...
  if(chdir("..") < 0){
     ...
     7a7:	68 99 43 00 00       	push   $0x4399
  ...
  if(unlink("dir0") < 0){
     ...
     7bb:	68 f4 3d 00 00       	push   $0x3df4
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     7cf:	68 31 3e 00 00       	push   $0x3e31
     7d4:	ff 35 64 5b 00 00    	pushl  0x5b64
     7da:	e8 8b 30 00 00       	call   386a <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     7e7:	68 24 3b 00 00       	push   $0x3b24
     7ec:	ff 35 64 5b 00 00    	pushl  0x5b64
     7f2:	e8 73 30 00 00       	call   386a <printf>
    exit();
     7f7:	e8 24 2f 00 00       	call   3720 <exit>
    printf(stdout, "chdir dir0 failed\n");
     7fc:	83 ec 08             	sub    $0x8,%esp
     7ff:	68 f9 3d 00 00       	push   $0x3df9
     804:	ff 35 64 5b 00 00    	pushl  0x5b64
     80a:	e8 5b 30 00 00       	call   386a <printf>
    exit();
     80f:	e8 0c 2f 00 00       	call   3720 <exit>
    printf(stdout, "chdir .. failed\n");
     814:	83 ec 08             	sub    $0x8,%esp
     817:	68 0c 3e 00 00       	push   $0x3e0c
     81c:	ff 35 64 5b 00 00    	pushl  0x5b64
     822:	e8 43 30 00 00       	call   386a <printf>
    exit();
     827:	e8 f4 2e 00 00       	call   3720 <exit>
    printf(stdout, "unlink dir0 failed\n");
     82c:	83 ec 08             	sub    $0x8,%esp
     82f:	68 1d 3e 00 00       	push   $0x3e1d
     834:	ff 35 64 5b 00 00    	pushl  0x5b64
     83a:	e8 2b 30 00 00       	call   386a <printf>
    exit();
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     84a:	68 40 3e 00 00       	push   $0x3e40
     84f:	ff 35 64 5b 00 00    	pushl  0x5b64
     855:	e8 10 30 00 00       	call   386a <printf>
  if(exec("echo", echoargv) < 0){
     85a:	83 c4 08             	add    $0x8,%esp
     85d:	68 68 5b 00 00       	push   $0x5b68
     862:	68 09 3c 00 00       	push   $0x3c09
    ...
    printf(stdout, "exec echo failed\n");
     ...
     878:	68 4b 3e 00 00       	push   $0x3e4b
     87d:	ff 35 64 5b 00 00    	pushl  0x5b64
     883:	e8 e2 2f 00 00       	call   386a <printf>
    exit();
...
pipe1(void)
{
  ...
  seq = 0;
    ...
    printf(1, "pipe() failed\n");
     ...
     91d:	68 5d 3e 00 00       	push   $0x3e5d
     922:	6a 01                	push   $0x1
     924:	e8 41 2f 00 00       	call   386a <printf>
    exit();
  ...
  seq = 0;
    ...
    for(n = 0; n < 5; n++){
     ...
     983:	68 6c 3e 00 00       	push   $0x3e6c
     988:	6a 01                	push   $0x1
     98a:	e8 db 2e 00 00       	call   386a <printf>
        exit();
    ...
    exit();
     ...
     99c:	68 7a 3e 00 00       	push   $0x3e7a
     9a1:	6a 01                	push   $0x1
     9a3:	e8 c2 2e 00 00       	call   386a <printf>
          return;
  ...
  printf(1, "pipe1 ok\n");
     ...
     9f1:	68 9f 3e 00 00       	push   $0x3e9f
     9f6:	6a 01                	push   $0x1
     9f8:	e8 6d 2e 00 00       	call   386a <printf>
     9fd:	83 c4 10             	add    $0x10,%esp
     a00:	eb a9                	jmp    9ab <pipe1+0x11e>
      printf(1, "pipe1 oops 3 total %d\n", total);
     a02:	83 ec 04             	sub    $0x4,%esp
     a05:	ff 75 d0             	pushl  -0x30(%ebp)
     a08:	68 88 3e 00 00       	push   $0x3e88
     a0d:	6a 01                	push   $0x1
     a0f:	e8 56 2e 00 00       	call   386a <printf>
      exit();
     a14:	e8 07 2d 00 00       	call   3720 <exit>
    printf(1, "fork() failed\n");
     a19:	83 ec 08             	sub    $0x8,%esp
     a1c:	68 a9 3e 00 00       	push   $0x3ea9
     a21:	6a 01                	push   $0x1
     a23:	e8 42 2e 00 00       	call   386a <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     a36:	68 b8 3e 00 00       	push   $0x3eb8
     a3b:	6a 01                	push   $0x1
     a3d:	e8 28 2e 00 00       	call   386a <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     a87:	6a 01                	push   $0x1
     a89:	68 7d 44 00 00       	push   $0x447d
     ...
     aa1:	68 c2 3e 00 00       	push   $0x3ec2
     aa6:	6a 01                	push   $0x1
     aa8:	e8 bd 2d 00 00       	call   386a <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     aeb:	68 d6 3e 00 00       	push   $0x3ed6
     af0:	6a 01                	push   $0x1
     af2:	e8 73 2d 00 00       	call   386a <printf>
    return;
  ...
  printf(1, "kill... ");
     ...
     b10:	68 e9 3e 00 00       	push   $0x3ee9
     b15:	6a 01                	push   $0x1
     b17:	e8 4e 2d 00 00       	call   386a <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     ...
     b37:	68 f2 3e 00 00       	push   $0x3ef2
     b3c:	6a 01                	push   $0x1
     b3e:	e8 27 2d 00 00       	call   386a <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ...
     b55:	68 fb 3e 00 00       	push   $0x3efb
     b5a:	6a 01                	push   $0x1
     b5c:	e8 09 2d 00 00       	call   386a <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
     ...
     b95:	68 65 4a 00 00       	push   $0x4a65
     b9a:	6a 01                	push   $0x1
     b9c:	e8 c9 2c 00 00       	call   386a <printf>
      return;
  ...
  printf(1, "exitwait ok\n");
     ...
     bae:	68 07 3f 00 00       	push   $0x3f07
     bb3:	6a 01                	push   $0x1
     bb5:	e8 b0 2c 00 00       	call   386a <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     bc7:	68 17 3f 00 00       	push   $0x3f17
     bcc:	6a 01                	push   $0x1
     bce:	e8 97 2c 00 00       	call   386a <printf>
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     be1:	68 24 3f 00 00       	push   $0x3f24
     be6:	6a 01                	push   $0x1
     be8:	e8 7d 2c 00 00       	call   386a <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     c17:	e8 77 2e 00 00       	call   3a93 <malloc>
    ...
    while(m1){
     ...
     c2a:	53                   	push   %ebx
     c2b:	e8 a3 2d 00 00       	call   39d3 <free>
      m1 = m2;
    ...
    m1 = malloc(1024*20);
     ...
     c41:	e8 4d 2e 00 00       	call   3a93 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     c50:	50                   	push   %eax
     c51:	e8 7d 2d 00 00       	call   39d3 <free>
    printf(1, "mem ok\n");
     c56:	83 c4 08             	add    $0x8,%esp
     c59:	68 48 3f 00 00       	push   $0x3f48
     c5e:	6a 01                	push   $0x1
     c60:	e8 05 2c 00 00       	call   386a <printf>
    exit();
     c65:	e8 b6 2a 00 00       	call   3720 <exit>
      printf(1, "couldn't allocate mem?!!\n");
     c6a:	83 ec 08             	sub    $0x8,%esp
     c6d:	68 2e 3f 00 00       	push   $0x3f2e
     c72:	6a 01                	push   $0x1
     c74:	e8 f1 2b 00 00       	call   386a <printf>
      kill(ppid);
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     c9c:	68 50 3f 00 00       	push   $0x3f50
     ca1:	6a 01                	push   $0x1
     ca3:	e8 c2 2b 00 00       	call   386a <printf>

  unlink("sharedfd");
     ca8:	c7 04 24 5f 3f 00 00 	movl   $0x3f5f,(%esp)
     caf:	e8 bc 2a 00 00       	call   3770 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     cb4:	83 c4 08             	add    $0x8,%esp
     cb7:	68 02 02 00 00       	push   $0x202
     cbc:	68 5f 3f 00 00       	push   $0x3f5f
  ...
  for(i = 0; i < 1000; i++){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     d1d:	68 24 4c 00 00       	push   $0x4c24
     d22:	6a 01                	push   $0x1
     d24:	e8 41 2b 00 00       	call   386a <printf>
    return;
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     d3b:	68 50 4c 00 00       	push   $0x4c50
     d40:	6a 01                	push   $0x1
     d42:	e8 23 2b 00 00       	call   386a <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     d5f:	6a 00                	push   $0x0
     d61:	68 5f 3f 00 00       	push   $0x3f5f
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     da3:	68 70 4c 00 00       	push   $0x4c70
     da8:	6a 01                	push   $0x1
     daa:	e8 bb 2a 00 00       	call   386a <printf>
    return;
  ...
  unlink("sharedfd");
     dde:	c7 04 24 5f 3f 00 00 	movl   $0x3f5f,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     e06:	68 68 3f 00 00       	push   $0x3f68
     e0b:	6a 01                	push   $0x1
     e0d:	e8 58 2a 00 00       	call   386a <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     e1d:	56                   	push   %esi
     e1e:	53                   	push   %ebx
     e1f:	68 75 3f 00 00       	push   $0x3f75
     e24:	6a 01                	push   $0x1
     e26:	e8 3f 2a 00 00       	call   386a <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
     e39:	c7 45 d8 8a 3f 00 00 	movl   $0x3f8a,-0x28(%ebp)
     e40:	c7 45 dc d3 40 00 00 	movl   $0x40d3,-0x24(%ebp)
     e47:	c7 45 e0 d7 40 00 00 	movl   $0x40d7,-0x20(%ebp)
     e4e:	c7 45 e4 8d 3f 00 00 	movl   $0x3f8d,-0x1c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
     e55:	68 90 3f 00 00       	push   $0x3f90
     e5a:	6a 01                	push   $0x1
     e5c:	e8 09 2a 00 00       	call   386a <printf>
  ...
  for(pi = 0; pi < 4; pi++){
     ...
     e97:	68 65 4a 00 00       	push   $0x4a65
     e9c:	6a 01                	push   $0x1
     e9e:	e8 c7 29 00 00       	call   386a <printf>
      exit();
     ...
     edf:	68 2b 42 00 00       	push   $0x422b
     ee4:	6a 01                	push   $0x1
     ee6:	e8 7f 29 00 00       	call   386a <printf>
        exit();
     ...
     f1d:	50                   	push   %eax
     f1e:	68 a0 3f 00 00       	push   $0x3fa0
     f23:	6a 01                	push   $0x1
     f25:	e8 40 29 00 00       	call   386a <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4d:	68 b1 3f 00 00       	push   $0x3fb1
     f52:	6a 01                	push   $0x1
     f54:	e8 11 29 00 00       	call   386a <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     fe9:	56                   	push   %esi
     fea:	68 bd 3f 00 00       	push   $0x3fbd
     fef:	6a 01                	push   $0x1
     ff1:	e8 74 28 00 00       	call   386a <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
     ...
     ffe:	68 ce 3f 00 00       	push   $0x3fce
    1003:	6a 01                	push   $0x1
    1005:	e8 60 28 00 00       	call   386a <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    101d:	68 dc 3f 00 00       	push   $0x3fdc
    1022:	6a 01                	push   $0x1
    1024:	e8 41 28 00 00       	call   386a <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1051:	68 65 4a 00 00       	push   $0x4a65
    1056:	6a 01                	push   $0x1
    1058:	e8 0d 28 00 00       	call   386a <printf>
      exit();
    ...
    1071:	68 2b 42 00 00       	push   $0x422b
    1076:	6a 01                	push   $0x1
    1078:	e8 ed 27 00 00       	call   386a <printf>
          exit();
    ...
    10e2:	68 dd 3b 00 00       	push   $0x3bdd
    10e7:	6a 01                	push   $0x1
    10e9:	e8 7c 27 00 00       	call   386a <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    116c:	50                   	push   %eax
    116d:	68 9c 4c 00 00       	push   $0x4c9c
    1172:	6a 01                	push   $0x1
    1174:	e8 f1 26 00 00       	call   386a <printf>
        exit();
    ...
    1188:	50                   	push   %eax
    1189:	68 c0 4c 00 00       	push   $0x4cc0
    118e:	6a 01                	push   $0x1
    1190:	e8 d5 26 00 00       	call   386a <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    ...
    11f6:	68 ef 3f 00 00       	push   $0x3fef
    11fb:	6a 01                	push   $0x1
    11fd:	e8 68 26 00 00       	call   386a <printf>
}
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1214:	68 00 40 00 00       	push   $0x4000
    1219:	6a 01                	push   $0x1
    121b:	e8 4a 26 00 00       	call   386a <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1220:	83 c4 08             	add    $0x8,%esp
    1223:	68 02 02 00 00       	push   $0x202
    1228:	68 11 40 00 00       	push   $0x4011
  ...
  write(fd, "hello", 5);
    ...
    1242:	6a 05                	push   $0x5
    1244:	68 36 40 00 00       	push   $0x4036
    1249:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    125a:	6a 02                	push   $0x2
    125c:	68 11 40 00 00       	push   $0x4011
  ...
  if(unlink("unlinkread") != 0){
    ...
    1276:	68 11 40 00 00       	push   $0x4011
  ...
  unlink("unlinkread");
    1308:	c7 04 24 11 40 00 00 	movl   $0x4011,(%esp)
    130f:	e8 5c 24 00 00       	call   3770 <unlink>
  printf(1, "unlinkread ok\n");
    1314:	83 c4 08             	add    $0x8,%esp
    1317:	68 b9 40 00 00       	push   $0x40b9
    131c:	6a 01                	push   $0x1
    131e:	e8 47 25 00 00       	call   386a <printf>
}
    ...
    1330:	68 1c 40 00 00       	push   $0x401c
    1335:	6a 01                	push   $0x1
    1337:	e8 2e 25 00 00       	call   386a <printf>
    exit();
    133c:	e8 df 23 00 00       	call   3720 <exit>
    printf(1, "open unlinkread failed\n");
    1341:	83 ec 08             	sub    $0x8,%esp
    1344:	68 3c 40 00 00       	push   $0x403c
    1349:	6a 01                	push   $0x1
    134b:	e8 1a 25 00 00       	call   386a <printf>
    exit();
    1350:	e8 cb 23 00 00       	call   3720 <exit>
    printf(1, "unlink unlinkread failed\n");
    1355:	83 ec 08             	sub    $0x8,%esp
    1358:	68 54 40 00 00       	push   $0x4054
    135d:	6a 01                	push   $0x1
    135f:	e8 06 25 00 00       	call   386a <printf>
    exit();
    1364:	e8 b7 23 00 00       	call   3720 <exit>
    printf(1, "unlinkread read failed");
    1369:	83 ec 08             	sub    $0x8,%esp
    136c:	68 72 40 00 00       	push   $0x4072
    1371:	6a 01                	push   $0x1
    1373:	e8 f2 24 00 00       	call   386a <printf>
    exit();
    1378:	e8 a3 23 00 00       	call   3720 <exit>
    printf(1, "unlinkread wrong data\n");
    137d:	83 ec 08             	sub    $0x8,%esp
    1380:	68 89 40 00 00       	push   $0x4089
    1385:	6a 01                	push   $0x1
    1387:	e8 de 24 00 00       	call   386a <printf>
    exit();
    138c:	e8 8f 23 00 00       	call   3720 <exit>
    printf(1, "unlinkread write failed\n");
    1391:	83 ec 08             	sub    $0x8,%esp
    1394:	68 a0 40 00 00       	push   $0x40a0
    1399:	6a 01                	push   $0x1
    139b:	e8 ca 24 00 00       	call   386a <printf>
    exit();
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    13ac:	68 c8 40 00 00       	push   $0x40c8
    13b1:	6a 01                	push   $0x1
    13b3:	e8 b2 24 00 00       	call   386a <printf>

  unlink("lf1");
    13b8:	c7 04 24 d2 40 00 00 	movl   $0x40d2,(%esp)
    13bf:	e8 ac 23 00 00       	call   3770 <unlink>
  unlink("lf2");
    13c4:	c7 04 24 d6 40 00 00 	movl   $0x40d6,(%esp)
    13cb:	e8 a0 23 00 00       	call   3770 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    13d0:	83 c4 08             	add    $0x8,%esp
    13d3:	68 02 02 00 00       	push   $0x202
    13d8:	68 d2 40 00 00       	push   $0x40d2
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    13f2:	6a 05                	push   $0x5
    13f4:	68 36 40 00 00       	push   $0x4036
    13f9:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    ...
    1417:	68 d6 40 00 00       	push   $0x40d6
    141c:	68 d2 40 00 00       	push   $0x40d2
  ...
  unlink("lf1");
    ...
    1434:	68 d2 40 00 00       	push   $0x40d2
    1439:	e8 32 23 00 00       	call   3770 <unlink>

  if(open("lf1", 0) >= 0){
    143e:	83 c4 08             	add    $0x8,%esp
    1441:	6a 00                	push   $0x0
    1443:	68 d2 40 00 00       	push   $0x40d2
  ...
  fd = open("lf2", 0);
    ...
    145b:	6a 00                	push   $0x0
    145d:	68 d6 40 00 00       	push   $0x40d6
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    14a4:	68 d6 40 00 00       	push   $0x40d6
  ...
  unlink("lf2");
    ...
    14bc:	68 d6 40 00 00       	push   $0x40d6
    14c1:	e8 aa 22 00 00       	call   3770 <unlink>
  if(link("lf2", "lf1") >= 0){
    14c6:	83 c4 08             	add    $0x8,%esp
    14c9:	68 d2 40 00 00       	push   $0x40d2
    14ce:	68 d6 40 00 00       	push   $0x40d6
  ...
  if(link(".", "lf1") >= 0){
    ...
    14e6:	68 d2 40 00 00       	push   $0x40d2
    14eb:	68 9a 43 00 00       	push   $0x439a
  ...
  printf(1, "linktest ok\n");
    ...
    1503:	68 70 41 00 00       	push   $0x4170
    1508:	6a 01                	push   $0x1
    150a:	e8 5b 23 00 00       	call   386a <printf>
}
    ...
    151a:	68 da 40 00 00       	push   $0x40da
    151f:	6a 01                	push   $0x1
    1521:	e8 44 23 00 00       	call   386a <printf>
    exit();
    1526:	e8 f5 21 00 00       	call   3720 <exit>
    printf(1, "write lf1 failed\n");
    152b:	83 ec 08             	sub    $0x8,%esp
    152e:	68 ed 40 00 00       	push   $0x40ed
    1533:	6a 01                	push   $0x1
    1535:	e8 30 23 00 00       	call   386a <printf>
    exit();
    153a:	e8 e1 21 00 00       	call   3720 <exit>
    printf(1, "link lf1 lf2 failed\n");
    153f:	83 ec 08             	sub    $0x8,%esp
    1542:	68 ff 40 00 00       	push   $0x40ff
    1547:	6a 01                	push   $0x1
    1549:	e8 1c 23 00 00       	call   386a <printf>
    exit();
    154e:	e8 cd 21 00 00       	call   3720 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    1553:	83 ec 08             	sub    $0x8,%esp
    1556:	68 e0 4c 00 00       	push   $0x4ce0
    155b:	6a 01                	push   $0x1
    155d:	e8 08 23 00 00       	call   386a <printf>
    exit();
    1562:	e8 b9 21 00 00       	call   3720 <exit>
    printf(1, "open lf2 failed\n");
    1567:	83 ec 08             	sub    $0x8,%esp
    156a:	68 14 41 00 00       	push   $0x4114
    156f:	6a 01                	push   $0x1
    1571:	e8 f4 22 00 00       	call   386a <printf>
    exit();
    1576:	e8 a5 21 00 00       	call   3720 <exit>
    printf(1, "read lf2 failed\n");
    157b:	83 ec 08             	sub    $0x8,%esp
    157e:	68 25 41 00 00       	push   $0x4125
    1583:	6a 01                	push   $0x1
    1585:	e8 e0 22 00 00       	call   386a <printf>
    exit();
    158a:	e8 91 21 00 00       	call   3720 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    158f:	83 ec 08             	sub    $0x8,%esp
    1592:	68 36 41 00 00       	push   $0x4136
    1597:	6a 01                	push   $0x1
    1599:	e8 cc 22 00 00       	call   386a <printf>
    exit();
    159e:	e8 7d 21 00 00       	call   3720 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    15a3:	83 ec 08             	sub    $0x8,%esp
    15a6:	68 08 4d 00 00       	push   $0x4d08
    15ab:	6a 01                	push   $0x1
    15ad:	e8 b8 22 00 00       	call   386a <printf>
    exit();
    15b2:	e8 69 21 00 00       	call   3720 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    15b7:	83 ec 08             	sub    $0x8,%esp
    15ba:	68 54 41 00 00       	push   $0x4154
    15bf:	6a 01                	push   $0x1
    15c1:	e8 a4 22 00 00       	call   386a <printf>
    exit();
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    15d4:	68 7d 41 00 00       	push   $0x417d
    15d9:	6a 01                	push   $0x1
    15db:	e8 8a 22 00 00       	call   386a <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    16a3:	50                   	push   %eax
    16a4:	68 8d 41 00 00       	push   $0x418d
    ...
    16b9:	50                   	push   %eax
    16ba:	68 8d 41 00 00       	push   $0x418d
    ...
    16d2:	50                   	push   %eax
    16d3:	68 90 41 00 00       	push   $0x4190
    16d8:	6a 01                	push   $0x1
    16da:	e8 8b 21 00 00       	call   386a <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    16fc:	6a 00                	push   $0x0
    16fe:	68 9a 43 00 00       	push   $0x439a
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    175e:	50                   	push   %eax
    175f:	68 ac 41 00 00       	push   $0x41ac
    1764:	6a 01                	push   $0x1
    1766:	e8 ff 20 00 00       	call   386a <printf>
        exit();
    ...
    1776:	50                   	push   %eax
    1777:	68 c5 41 00 00       	push   $0x41c5
    177c:	6a 01                	push   $0x1
    177e:	e8 e7 20 00 00       	call   386a <printf>
        exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    17ab:	6a 01                	push   $0x1
    17ad:	e8 b8 20 00 00       	call   386a <printf>
    exit();
    ...
    17ba:	68 65 4a 00 00       	push   $0x4a65
    17bf:	6a 01                	push   $0x1
    17c1:	e8 a4 20 00 00       	call   386a <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    ...
    18a2:	68 e2 41 00 00       	push   $0x41e2
    18a7:	6a 01                	push   $0x1
    18a9:	e8 bc 1f 00 00       	call   386a <printf>
}
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    18c2:	68 f0 41 00 00       	push   $0x41f0
    18c7:	6a 01                	push   $0x1
    18c9:	e8 9c 1f 00 00       	call   386a <printf>

  unlink("x");
    18ce:	c7 04 24 7d 44 00 00 	movl   $0x447d,(%esp)
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    18fb:	68 65 4a 00 00       	push   $0x4a65
    1900:	6a 01                	push   $0x1
    1902:	e8 63 1f 00 00       	call   386a <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    191b:	68 7d 44 00 00       	push   $0x447d
  ...
  for(i = 0; i < 100; i++){
    ...
    1960:	68 7d 44 00 00       	push   $0x447d
    ...
    1972:	68 7d 44 00 00       	push   $0x447d
    1977:	68 01 42 00 00       	push   $0x4201
  ...
  printf(1, "linkunlink ok\n");
    ...
    1992:	68 05 42 00 00       	push   $0x4205
    1997:	6a 01                	push   $0x1
    1999:	e8 cc 1e 00 00       	call   386a <printf>
}
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    19b2:	68 14 42 00 00       	push   $0x4214
    19b7:	6a 01                	push   $0x1
    19b9:	e8 ac 1e 00 00       	call   386a <printf>
  unlink("bd");
    19be:	c7 04 24 21 42 00 00 	movl   $0x4221,(%esp)
    19c5:	e8 a6 1d 00 00       	call   3770 <unlink>

  fd = open("bd", O_CREATE);
    19ca:	83 c4 08             	add    $0x8,%esp
    19cd:	68 00 02 00 00       	push   $0x200
    19d2:	68 21 42 00 00       	push   $0x4221
  ...
  for(i = 0; i < 500; i++){
    ...
    1a31:	50                   	push   %eax
    1a32:	68 21 42 00 00       	push   $0x4221
  ...
  for(i = 0; i < 500; i++){
    ...
    1a4b:	68 24 42 00 00       	push   $0x4224
    1a50:	6a 01                	push   $0x1
    1a52:	e8 13 1e 00 00       	call   386a <printf>
    exit();
    1a57:	e8 c4 1c 00 00       	call   3720 <exit>
      printf(1, "bigdir link failed\n");
    1a5c:	83 ec 08             	sub    $0x8,%esp
    1a5f:	68 3a 42 00 00       	push   $0x423a
    1a64:	6a 01                	push   $0x1
    1a66:	e8 ff 1d 00 00       	call   386a <printf>
      exit();
  ...
  unlink("bd");
    ...
    1a73:	68 21 42 00 00       	push   $0x4221
  ...
  for(i = 0; i < 500; i++){
    ...
    1ad7:	68 4e 42 00 00       	push   $0x424e
    1adc:	6a 01                	push   $0x1
    1ade:	e8 87 1d 00 00       	call   386a <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    ...
    1aeb:	68 63 42 00 00       	push   $0x4263
    1af0:	6a 01                	push   $0x1
    1af2:	e8 73 1d 00 00       	call   386a <printf>
}
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1b06:	68 6e 42 00 00       	push   $0x426e
    1b0b:	6a 01                	push   $0x1
    1b0d:	e8 58 1d 00 00       	call   386a <printf>

  unlink("ff");
    1b12:	c7 04 24 f7 42 00 00 	movl   $0x42f7,(%esp)
    1b19:	e8 52 1c 00 00       	call   3770 <unlink>
  if(mkdir("dd") != 0){
    1b1e:	c7 04 24 94 43 00 00 	movl   $0x4394,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1b3d:	68 cd 42 00 00       	push   $0x42cd
  ...
  write(fd, "ff", 2);
    ...
    1b57:	6a 02                	push   $0x2
    1b59:	68 f7 42 00 00       	push   $0x42f7
    1b5e:	50                   	push   %eax
  ...
  if(unlink("dd") >= 0){
    1b6c:	c7 04 24 94 43 00 00 	movl   $0x4394,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1b86:	68 a8 42 00 00       	push   $0x42a8
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ba3:	68 ca 42 00 00       	push   $0x42ca
  ...
  write(fd, "FF", 2);
    ...
    1bbd:	6a 02                	push   $0x2
    1bbf:	68 eb 42 00 00       	push   $0x42eb
    1bc4:	50                   	push   %eax
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    1bd5:	6a 00                	push   $0x0
    1bd7:	68 ee 42 00 00       	push   $0x42ee
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    1c26:	68 2e 43 00 00       	push   $0x432e
    1c2b:	68 ca 42 00 00       	push   $0x42ca
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1c43:	68 ca 42 00 00       	push   $0x42ca
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1c5b:	6a 00                	push   $0x0
    1c5d:	68 ca 42 00 00       	push   $0x42ca
  ...
  if(chdir("dd") != 0){
    ...
    1c75:	68 94 43 00 00       	push   $0x4394
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1c8d:	68 62 43 00 00       	push   $0x4362
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ca5:	68 88 43 00 00       	push   $0x4388
  ...
  if(chdir("./..") != 0){
    ...
    1cbd:	68 97 43 00 00       	push   $0x4397
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1cd5:	6a 00                	push   $0x0
    1cd7:	68 2e 43 00 00       	push   $0x432e
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1d19:	6a 00                	push   $0x0
    1d1b:	68 ca 42 00 00       	push   $0x42ca
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d38:	68 e2 43 00 00       	push   $0x43e2
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d55:	68 07 44 00 00       	push   $0x4407
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1d72:	68 94 43 00 00       	push   $0x4394
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1d8a:	6a 02                	push   $0x2
    1d8c:	68 94 43 00 00       	push   $0x4394
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1da4:	6a 01                	push   $0x1
    1da6:	68 94 43 00 00       	push   $0x4394
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1dbe:	68 76 44 00 00       	push   $0x4476
    1dc3:	68 e2 43 00 00       	push   $0x43e2
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1ddb:	68 76 44 00 00       	push   $0x4476
    1de0:	68 07 44 00 00       	push   $0x4407
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1df8:	68 2e 43 00 00       	push   $0x432e
    1dfd:	68 cd 42 00 00       	push   $0x42cd
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    1e15:	68 e2 43 00 00       	push   $0x43e2
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    1e2d:	68 07 44 00 00       	push   $0x4407
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    1e45:	68 2e 43 00 00       	push   $0x432e
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    1e5d:	68 07 44 00 00       	push   $0x4407
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    1e75:	68 e2 43 00 00       	push   $0x43e2
  ...
  if(chdir("dd/ff") == 0){
    ...
    1e8d:	68 cd 42 00 00       	push   $0x42cd
  ...
  if(chdir("dd/xx") == 0){
    ...
    1ea5:	68 79 44 00 00       	push   $0x4479
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    1ebd:	68 2e 43 00 00       	push   $0x432e
  ...
  if(unlink("dd/ff") != 0){
    ...
    1ed5:	68 cd 42 00 00       	push   $0x42cd
  ...
  if(unlink("dd") == 0){
    ...
    1eed:	68 94 43 00 00       	push   $0x4394
  ...
  if(unlink("dd/dd") < 0){
    ...
    1f05:	68 a9 42 00 00       	push   $0x42a9
  ...
  if(unlink("dd") < 0){
    ...
    1f1d:	68 94 43 00 00       	push   $0x4394
  ...
  printf(1, "subdir ok\n");
    ...
    1f35:	68 76 45 00 00       	push   $0x4576
    1f3a:	6a 01                	push   $0x1
    1f3c:	e8 29 19 00 00       	call   386a <printf>
}
    ...
    1f4c:	68 7b 42 00 00       	push   $0x427b
    1f51:	6a 01                	push   $0x1
    1f53:	e8 12 19 00 00       	call   386a <printf>
    exit();
    1f58:	e8 c3 17 00 00       	call   3720 <exit>
    printf(1, "create dd/ff failed\n");
    1f5d:	83 ec 08             	sub    $0x8,%esp
    1f60:	68 93 42 00 00       	push   $0x4293
    1f65:	6a 01                	push   $0x1
    1f67:	e8 fe 18 00 00       	call   386a <printf>
    exit();
    1f6c:	e8 af 17 00 00       	call   3720 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    1f71:	83 ec 08             	sub    $0x8,%esp
    1f74:	68 60 4d 00 00       	push   $0x4d60
    1f79:	6a 01                	push   $0x1
    1f7b:	e8 ea 18 00 00       	call   386a <printf>
    exit();
    1f80:	e8 9b 17 00 00       	call   3720 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    1f85:	83 ec 08             	sub    $0x8,%esp
    1f88:	68 af 42 00 00       	push   $0x42af
    1f8d:	6a 01                	push   $0x1
    1f8f:	e8 d6 18 00 00       	call   386a <printf>
    exit();
    1f94:	e8 87 17 00 00       	call   3720 <exit>
    printf(1, "create dd/dd/ff failed\n");
    1f99:	83 ec 08             	sub    $0x8,%esp
    1f9c:	68 d3 42 00 00       	push   $0x42d3
    1fa1:	6a 01                	push   $0x1
    1fa3:	e8 c2 18 00 00       	call   386a <printf>
    exit();
    1fa8:	e8 73 17 00 00       	call   3720 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    1fad:	83 ec 08             	sub    $0x8,%esp
    1fb0:	68 fa 42 00 00       	push   $0x42fa
    1fb5:	6a 01                	push   $0x1
    1fb7:	e8 ae 18 00 00       	call   386a <printf>
    exit();
    1fbc:	e8 5f 17 00 00       	call   3720 <exit>
    printf(1, "dd/dd/../ff wrong content\n");
    1fc1:	83 ec 08             	sub    $0x8,%esp
    1fc4:	68 13 43 00 00       	push   $0x4313
    1fc9:	6a 01                	push   $0x1
    1fcb:	e8 9a 18 00 00       	call   386a <printf>
    exit();
    1fd0:	e8 4b 17 00 00       	call   3720 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1fd5:	83 ec 08             	sub    $0x8,%esp
    1fd8:	68 88 4d 00 00       	push   $0x4d88
    1fdd:	6a 01                	push   $0x1
    1fdf:	e8 86 18 00 00       	call   386a <printf>
    exit();
    1fe4:	e8 37 17 00 00       	call   3720 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    1fe9:	83 ec 08             	sub    $0x8,%esp
    1fec:	68 39 43 00 00       	push   $0x4339
    1ff1:	6a 01                	push   $0x1
    1ff3:	e8 72 18 00 00       	call   386a <printf>
    exit();
    1ff8:	e8 23 17 00 00       	call   3720 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    1ffd:	83 ec 08             	sub    $0x8,%esp
    2000:	68 ac 4d 00 00       	push   $0x4dac
    2005:	6a 01                	push   $0x1
    2007:	e8 5e 18 00 00       	call   386a <printf>
    exit();
    200c:	e8 0f 17 00 00       	call   3720 <exit>
    printf(1, "chdir dd failed\n");
    2011:	83 ec 08             	sub    $0x8,%esp
    2014:	68 51 43 00 00       	push   $0x4351
    2019:	6a 01                	push   $0x1
    201b:	e8 4a 18 00 00       	call   386a <printf>
    exit();
    2020:	e8 fb 16 00 00       	call   3720 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    2025:	83 ec 08             	sub    $0x8,%esp
    2028:	68 6e 43 00 00       	push   $0x436e
    202d:	6a 01                	push   $0x1
    202f:	e8 36 18 00 00       	call   386a <printf>
    exit();
    2034:	e8 e7 16 00 00       	call   3720 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    2039:	83 ec 08             	sub    $0x8,%esp
    203c:	68 6e 43 00 00       	push   $0x436e
    2041:	6a 01                	push   $0x1
    2043:	e8 22 18 00 00       	call   386a <printf>
    exit();
    2048:	e8 d3 16 00 00       	call   3720 <exit>
    printf(1, "chdir ./.. failed\n");
    204d:	83 ec 08             	sub    $0x8,%esp
    2050:	68 9c 43 00 00       	push   $0x439c
    2055:	6a 01                	push   $0x1
    2057:	e8 0e 18 00 00       	call   386a <printf>
    exit();
    205c:	e8 bf 16 00 00       	call   3720 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    2061:	83 ec 08             	sub    $0x8,%esp
    2064:	68 af 43 00 00       	push   $0x43af
    2069:	6a 01                	push   $0x1
    206b:	e8 fa 17 00 00       	call   386a <printf>
    exit();
    2070:	e8 ab 16 00 00       	call   3720 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    2075:	83 ec 08             	sub    $0x8,%esp
    2078:	68 c7 43 00 00       	push   $0x43c7
    207d:	6a 01                	push   $0x1
    207f:	e8 e6 17 00 00       	call   386a <printf>
    exit();
    2084:	e8 97 16 00 00       	call   3720 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2089:	83 ec 08             	sub    $0x8,%esp
    208c:	68 d0 4d 00 00       	push   $0x4dd0
    2091:	6a 01                	push   $0x1
    2093:	e8 d2 17 00 00       	call   386a <printf>
    exit();
    2098:	e8 83 16 00 00       	call   3720 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    209d:	83 ec 08             	sub    $0x8,%esp
    20a0:	68 eb 43 00 00       	push   $0x43eb
    20a5:	6a 01                	push   $0x1
    20a7:	e8 be 17 00 00       	call   386a <printf>
    exit();
    20ac:	e8 6f 16 00 00       	call   3720 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    20b1:	83 ec 08             	sub    $0x8,%esp
    20b4:	68 10 44 00 00       	push   $0x4410
    20b9:	6a 01                	push   $0x1
    20bb:	e8 aa 17 00 00       	call   386a <printf>
    exit();
    20c0:	e8 5b 16 00 00       	call   3720 <exit>
    printf(1, "create dd succeeded!\n");
    20c5:	83 ec 08             	sub    $0x8,%esp
    20c8:	68 2c 44 00 00       	push   $0x442c
    20cd:	6a 01                	push   $0x1
    20cf:	e8 96 17 00 00       	call   386a <printf>
    exit();
    20d4:	e8 47 16 00 00       	call   3720 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    20d9:	83 ec 08             	sub    $0x8,%esp
    20dc:	68 42 44 00 00       	push   $0x4442
    20e1:	6a 01                	push   $0x1
    20e3:	e8 82 17 00 00       	call   386a <printf>
    exit();
    20e8:	e8 33 16 00 00       	call   3720 <exit>
    printf(1, "open dd wronly succeeded!\n");
    20ed:	83 ec 08             	sub    $0x8,%esp
    20f0:	68 5b 44 00 00       	push   $0x445b
    20f5:	6a 01                	push   $0x1
    20f7:	e8 6e 17 00 00       	call   386a <printf>
    exit();
    20fc:	e8 1f 16 00 00       	call   3720 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    2101:	83 ec 08             	sub    $0x8,%esp
    2104:	68 f8 4d 00 00       	push   $0x4df8
    2109:	6a 01                	push   $0x1
    210b:	e8 5a 17 00 00       	call   386a <printf>
    exit();
    2110:	e8 0b 16 00 00       	call   3720 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2115:	83 ec 08             	sub    $0x8,%esp
    2118:	68 1c 4e 00 00       	push   $0x4e1c
    211d:	6a 01                	push   $0x1
    211f:	e8 46 17 00 00       	call   386a <printf>
    exit();
    2124:	e8 f7 15 00 00       	call   3720 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2129:	83 ec 08             	sub    $0x8,%esp
    212c:	68 40 4e 00 00       	push   $0x4e40
    2131:	6a 01                	push   $0x1
    2133:	e8 32 17 00 00       	call   386a <printf>
    exit();
    2138:	e8 e3 15 00 00       	call   3720 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    213d:	83 ec 08             	sub    $0x8,%esp
    2140:	68 7f 44 00 00       	push   $0x447f
    2145:	6a 01                	push   $0x1
    2147:	e8 1e 17 00 00       	call   386a <printf>
    exit();
    214c:	e8 cf 15 00 00       	call   3720 <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    2151:	83 ec 08             	sub    $0x8,%esp
    2154:	68 9a 44 00 00       	push   $0x449a
    2159:	6a 01                	push   $0x1
    215b:	e8 0a 17 00 00       	call   386a <printf>
    exit();
    2160:	e8 bb 15 00 00       	call   3720 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    2165:	83 ec 08             	sub    $0x8,%esp
    2168:	68 b5 44 00 00       	push   $0x44b5
    216d:	6a 01                	push   $0x1
    216f:	e8 f6 16 00 00       	call   386a <printf>
    exit();
    2174:	e8 a7 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2179:	83 ec 08             	sub    $0x8,%esp
    217c:	68 d2 44 00 00       	push   $0x44d2
    2181:	6a 01                	push   $0x1
    2183:	e8 e2 16 00 00       	call   386a <printf>
    exit();
    2188:	e8 93 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    218d:	83 ec 08             	sub    $0x8,%esp
    2190:	68 ee 44 00 00       	push   $0x44ee
    2195:	6a 01                	push   $0x1
    2197:	e8 ce 16 00 00       	call   386a <printf>
    exit();
    219c:	e8 7f 15 00 00       	call   3720 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    21a1:	83 ec 08             	sub    $0x8,%esp
    21a4:	68 0a 45 00 00       	push   $0x450a
    21a9:	6a 01                	push   $0x1
    21ab:	e8 ba 16 00 00       	call   386a <printf>
    exit();
    21b0:	e8 6b 15 00 00       	call   3720 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    21b5:	83 ec 08             	sub    $0x8,%esp
    21b8:	68 22 45 00 00       	push   $0x4522
    21bd:	6a 01                	push   $0x1
    21bf:	e8 a6 16 00 00       	call   386a <printf>
    exit();
    21c4:	e8 57 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    21c9:	83 ec 08             	sub    $0x8,%esp
    21cc:	68 39 43 00 00       	push   $0x4339
    21d1:	6a 01                	push   $0x1
    21d3:	e8 92 16 00 00       	call   386a <printf>
    exit();
    21d8:	e8 43 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/ff failed\n");
    21dd:	83 ec 08             	sub    $0x8,%esp
    21e0:	68 3a 45 00 00       	push   $0x453a
    21e5:	6a 01                	push   $0x1
    21e7:	e8 7e 16 00 00       	call   386a <printf>
    exit();
    21ec:	e8 2f 15 00 00       	call   3720 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    21f1:	83 ec 08             	sub    $0x8,%esp
    21f4:	68 64 4e 00 00       	push   $0x4e64
    21f9:	6a 01                	push   $0x1
    21fb:	e8 6a 16 00 00       	call   386a <printf>
    exit();
    2200:	e8 1b 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd/dd failed\n");
    2205:	83 ec 08             	sub    $0x8,%esp
    2208:	68 4f 45 00 00       	push   $0x454f
    220d:	6a 01                	push   $0x1
    220f:	e8 56 16 00 00       	call   386a <printf>
    exit();
    2214:	e8 07 15 00 00       	call   3720 <exit>
    printf(1, "unlink dd failed\n");
    2219:	83 ec 08             	sub    $0x8,%esp
    221c:	68 64 45 00 00       	push   $0x4564
    2221:	6a 01                	push   $0x1
    2223:	e8 42 16 00 00       	call   386a <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    2236:	68 81 45 00 00       	push   $0x4581
    223b:	6a 01                	push   $0x1
    223d:	e8 28 16 00 00       	call   386a <printf>

  unlink("bigwrite");
    2242:	c7 04 24 90 45 00 00 	movl   $0x4590,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    225b:	68 99 45 00 00       	push   $0x4599
    2260:	6a 01                	push   $0x1
    2262:	e8 03 16 00 00       	call   386a <printf>
      exit();
    ...
    226c:	50                   	push   %eax
    226d:	56                   	push   %esi
    226e:	68 b1 45 00 00       	push   $0x45b1
    2273:	6a 01                	push   $0x1
    2275:	e8 f0 15 00 00       	call   386a <printf>
        exit();
    ...
    unlink("bigwrite");
    2288:	c7 04 24 90 45 00 00 	movl   $0x4590,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    22ad:	68 90 45 00 00       	push   $0x4590
  ...
  printf(1, "bigwrite ok\n");
    ...
    22e8:	68 c3 45 00 00       	push   $0x45c3
    22ed:	6a 01                	push   $0x1
    22ef:	e8 76 15 00 00       	call   386a <printf>
}
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    2308:	68 d0 45 00 00       	push   $0x45d0
    230d:	6a 01                	push   $0x1
    230f:	e8 56 15 00 00       	call   386a <printf>

  unlink("bigfile");
    2314:	c7 04 24 ec 45 00 00 	movl   $0x45ec,(%esp)
    231b:	e8 50 14 00 00       	call   3770 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2320:	83 c4 08             	add    $0x8,%esp
    2323:	68 02 02 00 00       	push   $0x202
    2328:	68 ec 45 00 00       	push   $0x45ec
  ...
  for(i = 0; i < 20; i++){
    ...
    2345:	68 de 45 00 00       	push   $0x45de
    234a:	6a 01                	push   $0x1
    234c:	e8 19 15 00 00       	call   386a <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2391:	68 f4 45 00 00       	push   $0x45f4
    2396:	6a 01                	push   $0x1
    2398:	e8 cd 14 00 00       	call   386a <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    23ae:	6a 00                	push   $0x0
    23b0:	68 ec 45 00 00       	push   $0x45ec
  ...
  for(i = 0; ; i++){
    ...
    241b:	68 0a 46 00 00       	push   $0x460a
    2420:	6a 01                	push   $0x1
    2422:	e8 43 14 00 00       	call   386a <printf>
    exit();
    2427:	e8 f4 12 00 00       	call   3720 <exit>
      printf(1, "read bigfile failed\n");
    242c:	83 ec 08             	sub    $0x8,%esp
    242f:	68 1f 46 00 00       	push   $0x461f
    2434:	6a 01                	push   $0x1
    2436:	e8 2f 14 00 00       	call   386a <printf>
      exit();
    243b:	e8 e0 12 00 00       	call   3720 <exit>
      printf(1, "short read bigfile\n");
    2440:	83 ec 08             	sub    $0x8,%esp
    2443:	68 34 46 00 00       	push   $0x4634
    2448:	6a 01                	push   $0x1
    244a:	e8 1b 14 00 00       	call   386a <printf>
      exit();
    244f:	e8 cc 12 00 00       	call   3720 <exit>
      printf(1, "read bigfile wrong data\n");
    2454:	83 ec 08             	sub    $0x8,%esp
    2457:	68 48 46 00 00       	push   $0x4648
    245c:	6a 01                	push   $0x1
    245e:	e8 07 14 00 00       	call   386a <printf>
      exit();
  ...
  unlink("bigfile");
    ...
    247f:	68 ec 45 00 00       	push   $0x45ec
    2484:	e8 e7 12 00 00       	call   3770 <unlink>

  printf(1, "bigfile test ok\n");
    2489:	83 c4 08             	add    $0x8,%esp
    248c:	68 7b 46 00 00       	push   $0x467b
    2491:	6a 01                	push   $0x1
    2493:	e8 d2 13 00 00       	call   386a <printf>
}
    ...
    24a6:	68 61 46 00 00       	push   $0x4661
    24ab:	6a 01                	push   $0x1
    24ad:	e8 b8 13 00 00       	call   386a <printf>
    exit();
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    24bd:	68 8c 46 00 00       	push   $0x468c
    24c2:	6a 01                	push   $0x1
    24c4:	e8 a1 13 00 00       	call   386a <printf>

  if(mkdir("12345678901234") != 0){
    24c9:	c7 04 24 c7 46 00 00 	movl   $0x46c7,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    24e3:	68 84 4e 00 00       	push   $0x4e84
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2500:	68 d4 4e 00 00       	push   $0x4ed4
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2521:	6a 00                	push   $0x0
    2523:	68 44 4f 00 00       	push   $0x4f44
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    2541:	c7 04 24 b8 46 00 00 	movl   $0x46b8,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2557:	68 e0 4f 00 00       	push   $0x4fe0
  ...
  printf(1, "fourteen ok\n");
    ...
    256b:	68 d6 46 00 00       	push   $0x46d6
    2570:	6a 01                	push   $0x1
    2572:	e8 f3 12 00 00       	call   386a <printf>
}
    ...
    257f:	68 9b 46 00 00       	push   $0x469b
    2584:	6a 01                	push   $0x1
    2586:	e8 df 12 00 00       	call   386a <printf>
    exit();
    258b:	e8 90 11 00 00       	call   3720 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    2590:	83 ec 08             	sub    $0x8,%esp
    2593:	68 a4 4e 00 00       	push   $0x4ea4
    2598:	6a 01                	push   $0x1
    259a:	e8 cb 12 00 00       	call   386a <printf>
    exit();
    259f:	e8 7c 11 00 00       	call   3720 <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    25a4:	83 ec 08             	sub    $0x8,%esp
    25a7:	68 04 4f 00 00       	push   $0x4f04
    25ac:	6a 01                	push   $0x1
    25ae:	e8 b7 12 00 00       	call   386a <printf>
    exit();
    25b3:	e8 68 11 00 00       	call   3720 <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    25b8:	83 ec 08             	sub    $0x8,%esp
    25bb:	68 74 4f 00 00       	push   $0x4f74
    25c0:	6a 01                	push   $0x1
    25c2:	e8 a3 12 00 00       	call   386a <printf>
    exit();
    25c7:	e8 54 11 00 00       	call   3720 <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    25cc:	83 ec 08             	sub    $0x8,%esp
    25cf:	68 b0 4f 00 00       	push   $0x4fb0
    25d4:	6a 01                	push   $0x1
    25d6:	e8 8f 12 00 00       	call   386a <printf>
    exit();
    25db:	e8 40 11 00 00       	call   3720 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    25e0:	83 ec 08             	sub    $0x8,%esp
    25e3:	68 00 50 00 00       	push   $0x5000
    25e8:	6a 01                	push   $0x1
    25ea:	e8 7b 12 00 00       	call   386a <printf>
    exit();
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    25fa:	68 e3 46 00 00       	push   $0x46e3
    25ff:	6a 01                	push   $0x1
    2601:	e8 64 12 00 00       	call   386a <printf>
  if(mkdir("dots") != 0){
    2606:	c7 04 24 ef 46 00 00 	movl   $0x46ef,(%esp)
  ...
  if(chdir("dots") != 0){
    ...
    2620:	68 ef 46 00 00       	push   $0x46ef
  ...
  if(unlink(".") == 0){
    ...
    2638:	68 9a 43 00 00       	push   $0x439a
  ...
  if(unlink("..") == 0){
    ...
    2650:	68 99 43 00 00       	push   $0x4399
  ...
  if(chdir("/") != 0){
    ...
    2668:	68 6d 3b 00 00       	push   $0x3b6d
  ...
  if(unlink("dots/.") == 0){
    ...
    2680:	68 37 47 00 00       	push   $0x4737
  ...
  if(unlink("dots/..") == 0){
    ...
    2698:	68 55 47 00 00       	push   $0x4755
  ...
  if(unlink("dots") != 0){
    ...
    26b0:	68 ef 46 00 00       	push   $0x46ef
  ...
  printf(1, "rmdot ok\n");
    ...
    26c8:	68 8a 47 00 00       	push   $0x478a
    26cd:	6a 01                	push   $0x1
    26cf:	e8 96 11 00 00       	call   386a <printf>
}
    ...
    26dc:	68 f4 46 00 00       	push   $0x46f4
    26e1:	6a 01                	push   $0x1
    26e3:	e8 82 11 00 00       	call   386a <printf>
    exit();
    26e8:	e8 33 10 00 00       	call   3720 <exit>
    printf(1, "chdir dots failed\n");
    26ed:	83 ec 08             	sub    $0x8,%esp
    26f0:	68 07 47 00 00       	push   $0x4707
    26f5:	6a 01                	push   $0x1
    26f7:	e8 6e 11 00 00       	call   386a <printf>
    exit();
    26fc:	e8 1f 10 00 00       	call   3720 <exit>
    printf(1, "rm . worked!\n");
    2701:	83 ec 08             	sub    $0x8,%esp
    2704:	68 1a 47 00 00       	push   $0x471a
    2709:	6a 01                	push   $0x1
    270b:	e8 5a 11 00 00       	call   386a <printf>
    exit();
    2710:	e8 0b 10 00 00       	call   3720 <exit>
    printf(1, "rm .. worked!\n");
    2715:	83 ec 08             	sub    $0x8,%esp
    2718:	68 28 47 00 00       	push   $0x4728
    271d:	6a 01                	push   $0x1
    271f:	e8 46 11 00 00       	call   386a <printf>
    exit();
    2724:	e8 f7 0f 00 00       	call   3720 <exit>
    printf(1, "chdir / failed\n");
    2729:	83 ec 08             	sub    $0x8,%esp
    272c:	68 6f 3b 00 00       	push   $0x3b6f
    2731:	6a 01                	push   $0x1
    2733:	e8 32 11 00 00       	call   386a <printf>
    exit();
    2738:	e8 e3 0f 00 00       	call   3720 <exit>
    printf(1, "unlink dots/. worked!\n");
    273d:	83 ec 08             	sub    $0x8,%esp
    2740:	68 3e 47 00 00       	push   $0x473e
    2745:	6a 01                	push   $0x1
    2747:	e8 1e 11 00 00       	call   386a <printf>
    exit();
    274c:	e8 cf 0f 00 00       	call   3720 <exit>
    printf(1, "unlink dots/.. worked!\n");
    2751:	83 ec 08             	sub    $0x8,%esp
    2754:	68 5d 47 00 00       	push   $0x475d
    2759:	6a 01                	push   $0x1
    275b:	e8 0a 11 00 00       	call   386a <printf>
    exit();
    2760:	e8 bb 0f 00 00       	call   3720 <exit>
    printf(1, "unlink dots failed!\n");
    2765:	83 ec 08             	sub    $0x8,%esp
    2768:	68 75 47 00 00       	push   $0x4775
    276d:	6a 01                	push   $0x1
    276f:	e8 f6 10 00 00       	call   386a <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2780:	68 94 47 00 00       	push   $0x4794
    2785:	6a 01                	push   $0x1
    2787:	e8 de 10 00 00       	call   386a <printf>

  fd = open("dirfile", O_CREATE);
    278c:	83 c4 08             	add    $0x8,%esp
    278f:	68 00 02 00 00       	push   $0x200
    2794:	68 a1 47 00 00       	push   $0x47a1
  ...
  if(chdir("dirfile") == 0){
    27b2:	c7 04 24 a1 47 00 00 	movl   $0x47a1,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    27cc:	6a 00                	push   $0x0
    27ce:	68 da 47 00 00       	push   $0x47da
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    27eb:	68 da 47 00 00       	push   $0x47da
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2803:	68 da 47 00 00       	push   $0x47da
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    281b:	68 da 47 00 00       	push   $0x47da
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2833:	68 da 47 00 00       	push   $0x47da
    2838:	68 3e 48 00 00       	push   $0x483e
  ...
  if(unlink("dirfile") != 0){
    ...
    2850:	68 a1 47 00 00       	push   $0x47a1
  ...
  fd = open(".", O_RDWR);
    ...
    2868:	6a 02                	push   $0x2
    286a:	68 9a 43 00 00       	push   $0x439a
  ...
  printf(1, "dir vs file OK\n");
    ...
    28b7:	68 71 48 00 00       	push   $0x4871
    28bc:	6a 01                	push   $0x1
    28be:	e8 a7 0f 00 00       	call   386a <printf>
}
    ...
    28ce:	68 a9 47 00 00       	push   $0x47a9
    28d3:	6a 01                	push   $0x1
    28d5:	e8 90 0f 00 00       	call   386a <printf>
    exit();
    28da:	e8 41 0e 00 00       	call   3720 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    28df:	83 ec 08             	sub    $0x8,%esp
    28e2:	68 c0 47 00 00       	push   $0x47c0
    28e7:	6a 01                	push   $0x1
    28e9:	e8 7c 0f 00 00       	call   386a <printf>
    exit();
    28ee:	e8 2d 0e 00 00       	call   3720 <exit>
    printf(1, "create dirfile/xx succeeded!\n");
    28f3:	83 ec 08             	sub    $0x8,%esp
    28f6:	68 e5 47 00 00       	push   $0x47e5
    28fb:	6a 01                	push   $0x1
    28fd:	e8 68 0f 00 00       	call   386a <printf>
    exit();
    2902:	e8 19 0e 00 00       	call   3720 <exit>
    printf(1, "create dirfile/xx succeeded!\n");
    2907:	83 ec 08             	sub    $0x8,%esp
    290a:	68 e5 47 00 00       	push   $0x47e5
    290f:	6a 01                	push   $0x1
    2911:	e8 54 0f 00 00       	call   386a <printf>
    exit();
    2916:	e8 05 0e 00 00       	call   3720 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    291b:	83 ec 08             	sub    $0x8,%esp
    291e:	68 03 48 00 00       	push   $0x4803
    2923:	6a 01                	push   $0x1
    2925:	e8 40 0f 00 00       	call   386a <printf>
    exit();
    292a:	e8 f1 0d 00 00       	call   3720 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    292f:	83 ec 08             	sub    $0x8,%esp
    2932:	68 20 48 00 00       	push   $0x4820
    2937:	6a 01                	push   $0x1
    2939:	e8 2c 0f 00 00       	call   386a <printf>
    exit();
    293e:	e8 dd 0d 00 00       	call   3720 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    2943:	83 ec 08             	sub    $0x8,%esp
    2946:	68 34 50 00 00       	push   $0x5034
    294b:	6a 01                	push   $0x1
    294d:	e8 18 0f 00 00       	call   386a <printf>
    exit();
    2952:	e8 c9 0d 00 00       	call   3720 <exit>
    printf(1, "unlink dirfile failed!\n");
    2957:	83 ec 08             	sub    $0x8,%esp
    295a:	68 45 48 00 00       	push   $0x4845
    295f:	6a 01                	push   $0x1
    2961:	e8 04 0f 00 00       	call   386a <printf>
    exit();
    2966:	e8 b5 0d 00 00       	call   3720 <exit>
    printf(1, "open . for writing succeeded!\n");
    296b:	83 ec 08             	sub    $0x8,%esp
    296e:	68 54 50 00 00       	push   $0x5054
    2973:	6a 01                	push   $0x1
    2975:	e8 f0 0e 00 00       	call   386a <printf>
    exit();
    297a:	e8 a1 0d 00 00       	call   3720 <exit>
    printf(1, "write . succeeded!\n");
    297f:	83 ec 08             	sub    $0x8,%esp
    2982:	68 5d 48 00 00       	push   $0x485d
    2987:	6a 01                	push   $0x1
    2989:	e8 dc 0e 00 00       	call   386a <printf>
    exit();
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    299a:	68 81 48 00 00       	push   $0x4881
    299f:	6a 01                	push   $0x1
    29a1:	e8 c4 0e 00 00       	call   386a <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    29b3:	68 98 48 00 00       	push   $0x4898
    29b8:	6a 01                	push   $0x1
    29ba:	e8 ab 0e 00 00       	call   386a <printf>
      exit();
    ...
    29c7:	68 ac 48 00 00       	push   $0x48ac
    29cc:	6a 01                	push   $0x1
    29ce:	e8 97 0e 00 00       	call   386a <printf>
      exit();
    ...
    29ec:	68 7c 44 00 00       	push   $0x447c
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2a08:	68 92 48 00 00       	push   $0x4892
    ...
    2a1c:	68 92 48 00 00       	push   $0x4892
    ...
    2a71:	68 7c 44 00 00       	push   $0x447c
  ...
  chdir("/");
    ...
    2a9a:	68 6d 3b 00 00       	push   $0x3b6d
    2a9f:	e8 ec 0c 00 00       	call   3790 <chdir>
  printf(1, "empty file name OK\n");
    2aa4:	83 c4 08             	add    $0x8,%esp
    2aa7:	68 c0 48 00 00       	push   $0x48c0
    2aac:	6a 01                	push   $0x1
    2aae:	e8 b7 0d 00 00       	call   386a <printf>
}
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    2ac2:	68 d4 48 00 00       	push   $0x48d4
    2ac7:	6a 01                	push   $0x1
    2ac9:	e8 9c 0d 00 00       	call   386a <printf>
  ...
  for(; n > 0; n--){
    ...
    2b12:	68 74 50 00 00       	push   $0x5074
    2b17:	6a 01                	push   $0x1
    2b19:	e8 4c 0d 00 00       	call   386a <printf>
    exit();
    2b1e:	e8 fd 0b 00 00       	call   3720 <exit>
      printf(1, "wait stopped early\n");
    2b23:	83 ec 08             	sub    $0x8,%esp
    2b26:	68 df 48 00 00       	push   $0x48df
    2b2b:	6a 01                	push   $0x1
    2b2d:	e8 38 0d 00 00       	call   386a <printf>
      exit();
  ...
  printf(1, "fork test OK\n");
    ...
    2b44:	68 06 49 00 00       	push   $0x4906
    2b49:	6a 01                	push   $0x1
    2b4b:	e8 1a 0d 00 00       	call   386a <printf>
}
    ...
    2b5b:	68 f3 48 00 00       	push   $0x48f3
    2b60:	6a 01                	push   $0x1
    2b62:	e8 03 0d 00 00       	call   386a <printf>
    exit();
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    2b75:	68 14 49 00 00       	push   $0x4914
    2b7a:	ff 35 64 5b 00 00    	pushl  0x5b64
    2b80:	e8 e5 0c 00 00       	call   386a <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    2bd1:	56                   	push   %esi
    2bd2:	53                   	push   %ebx
    2bd3:	68 1f 49 00 00       	push   $0x491f
    2bd8:	ff 35 64 5b 00 00    	pushl  0x5b64
    2bde:	e8 87 0c 00 00       	call   386a <printf>
      exit();
...
#define BIG (100*1024*1024)
  ...
  *lastaddr = 99;
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2d50:	68 3a 49 00 00       	push   $0x493a
    2d55:	ff 35 64 5b 00 00    	pushl  0x5b64
    2d5b:	e8 0a 0b 00 00       	call   386a <printf>
    exit();
    2d60:	e8 bb 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    2d65:	83 ec 08             	sub    $0x8,%esp
    2d68:	68 51 49 00 00       	push   $0x4951
    2d6d:	ff 35 64 5b 00 00    	pushl  0x5b64
    2d73:	e8 f2 0a 00 00       	call   386a <printf>
    exit();
    ...
    2d85:	68 98 50 00 00       	push   $0x5098
    2d8a:	ff 35 64 5b 00 00    	pushl  0x5b64
    2d90:	e8 d5 0a 00 00       	call   386a <printf>
    exit();
    2d95:	e8 86 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    2d9a:	83 ec 08             	sub    $0x8,%esp
    2d9d:	68 6d 49 00 00       	push   $0x496d
    2da2:	ff 35 64 5b 00 00    	pushl  0x5b64
    2da8:	e8 bd 0a 00 00       	call   386a <printf>
    exit();
    2dad:	e8 6e 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    2db2:	50                   	push   %eax
    2db3:	53                   	push   %ebx
    2db4:	68 d8 50 00 00       	push   $0x50d8
    2db9:	ff 35 64 5b 00 00    	pushl  0x5b64
    2dbf:	e8 a6 0a 00 00       	call   386a <printf>
    exit();
    2dc4:	e8 57 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    2dc9:	56                   	push   %esi
    2dca:	53                   	push   %ebx
    2dcb:	68 10 51 00 00       	push   $0x5110
    2dd0:	ff 35 64 5b 00 00    	pushl  0x5b64
    2dd6:	e8 8f 0a 00 00       	call   386a <printf>
    exit();
    2ddb:	e8 40 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    2de0:	83 ec 08             	sub    $0x8,%esp
    2de3:	68 38 51 00 00       	push   $0x5138
    2de8:	ff 35 64 5b 00 00    	pushl  0x5b64
    2dee:	e8 77 0a 00 00       	call   386a <printf>
    exit();
    2df3:	e8 28 09 00 00       	call   3720 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    2df8:	50                   	push   %eax
    2df9:	53                   	push   %ebx
    2dfa:	68 68 51 00 00       	push   $0x5168
    2dff:	ff 35 64 5b 00 00    	pushl  0x5b64
    2e05:	e8 60 0a 00 00       	call   386a <printf>
    exit();
    2e0a:	e8 11 09 00 00       	call   3720 <exit>
      printf(stdout, "fork failed\n");
    2e0f:	83 ec 08             	sub    $0x8,%esp
    2e12:	68 65 4a 00 00       	push   $0x4a65
    2e17:	ff 35 64 5b 00 00    	pushl  0x5b64
    2e1d:	e8 48 0a 00 00       	call   386a <printf>
      exit();
    ...
    2e2a:	50                   	push   %eax
    2e2b:	53                   	push   %ebx
    2e2c:	68 88 49 00 00       	push   $0x4988
    2e31:	ff 35 64 5b 00 00    	pushl  0x5b64
    2e37:	e8 2e 0a 00 00       	call   386a <printf>
      kill(ppid);
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2e65:	68 5d 3e 00 00       	push   $0x3e5d
    2e6a:	6a 01                	push   $0x1
    2e6c:	e8 f9 09 00 00       	call   386a <printf>
    exit();
    ...
    2e92:	6a 01                	push   $0x1
    2e94:	68 7d 44 00 00       	push   $0x447d
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2f37:	68 bc 49 00 00       	push   $0x49bc
    2f3c:	ff 35 64 5b 00 00    	pushl  0x5b64
    2f42:	e8 23 09 00 00       	call   386a <printf>
}
    ...
    2f55:	68 a1 49 00 00       	push   $0x49a1
    2f5a:	ff 35 64 5b 00 00    	pushl  0x5b64
    2f60:	e8 05 09 00 00       	call   386a <printf>
    exit();
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    2f90:	68 ca 49 00 00       	push   $0x49ca
    2f95:	ff 35 64 5b 00 00    	pushl  0x5b64
    2f9b:	e8 ca 08 00 00       	call   386a <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    2fe1:	53                   	push   %ebx
    2fe2:	68 d9 49 00 00       	push   $0x49d9
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3004:	68 e4 49 00 00       	push   $0x49e4
    3009:	ff 35 64 5b 00 00    	pushl  0x5b64
    300f:	e8 56 08 00 00       	call   386a <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    ...
    301c:	68 fd 49 00 00       	push   $0x49fd
    3021:	ff 35 64 5b 00 00    	pushl  0x5b64
    3027:	e8 3e 08 00 00       	call   386a <printf>
}
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    303c:	68 0a 4a 00 00       	push   $0x4a0a
    3041:	ff 35 64 5b 00 00    	pushl  0x5b64
    3047:	e8 1e 08 00 00       	call   386a <printf>
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    306c:	68 14 4a 00 00       	push   $0x4a14
    3071:	ff 35 64 5b 00 00    	pushl  0x5b64
    3077:	e8 ee 07 00 00       	call   386a <printf>
      exit();
  ...
  printf(stdout, "bss test ok\n");
    ...
    3084:	68 25 4a 00 00       	push   $0x4a25
    3089:	ff 35 64 5b 00 00    	pushl  0x5b64
    308f:	e8 d6 07 00 00       	call   386a <printf>
}
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    309f:	68 32 4a 00 00       	push   $0x4a32
  ...
  fd = open("bigarg-ok", 0);
    ...
    30c5:	6a 00                	push   $0x0
    30c7:	68 32 4a 00 00       	push   $0x4a32
  ...
  unlink("bigarg-ok");
    30e5:	c7 04 24 32 4a 00 00 	movl   $0x4a32,(%esp)
    ...
    30f6:	c7 04 85 80 5b 00 00 	movl   $0x518c,0x5b80(,%eax,4)
    30fd:	8c 51 00 00 
    ...
    3116:	68 3c 4a 00 00       	push   $0x4a3c
    311b:	ff 35 64 5b 00 00    	pushl  0x5b64
    3121:	e8 44 07 00 00       	call   386a <printf>
    exec("echo", args);
    3126:	83 c4 08             	add    $0x8,%esp
    3129:	68 80 5b 00 00       	push   $0x5b80
    312e:	68 09 3c 00 00       	push   $0x3c09
    3133:	e8 20 06 00 00       	call   3758 <exec>
    printf(stdout, "bigarg test ok\n");
    3138:	83 c4 08             	add    $0x8,%esp
    313b:	68 49 4a 00 00       	push   $0x4a49
    3140:	ff 35 64 5b 00 00    	pushl  0x5b64
    3146:	e8 1f 07 00 00       	call   386a <printf>
    fd = open("bigarg-ok", O_CREATE);
    314b:	83 c4 08             	add    $0x8,%esp
    314e:	68 00 02 00 00       	push   $0x200
    3153:	68 32 4a 00 00       	push   $0x4a32
    ...
    316d:	68 59 4a 00 00       	push   $0x4a59
    3172:	ff 35 64 5b 00 00    	pushl  0x5b64
    3178:	e8 ed 06 00 00       	call   386a <printf>
    exit();
    317d:	e8 9e 05 00 00       	call   3720 <exit>
    printf(stdout, "bigarg test failed!\n");
    3182:	83 ec 08             	sub    $0x8,%esp
    3185:	68 72 4a 00 00       	push   $0x4a72
    318a:	ff 35 64 5b 00 00    	pushl  0x5b64
    3190:	e8 d5 06 00 00       	call   386a <printf>
    exit();
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    31a3:	68 87 4a 00 00       	push   $0x4a87
    31a8:	6a 01                	push   $0x1
    31aa:	e8 bb 06 00 00       	call   386a <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3241:	56                   	push   %esi
    3242:	68 94 4a 00 00       	push   $0x4a94
    3247:	6a 01                	push   $0x1
    3249:	e8 1c 06 00 00       	call   386a <printf>
    ...
    326b:	50                   	push   %eax
    326c:	68 a0 4a 00 00       	push   $0x4aa0
    3271:	6a 01                	push   $0x1
    3273:	e8 f2 05 00 00       	call   386a <printf>
      break;
    ...
    32a9:	57                   	push   %edi
    32aa:	68 b0 4a 00 00       	push   $0x4ab0
    32af:	6a 01                	push   $0x1
    32b1:	e8 b4 05 00 00       	call   386a <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    ...
    3372:	68 c0 4a 00 00       	push   $0x4ac0
    3377:	6a 01                	push   $0x1
    3379:	e8 ec 04 00 00       	call   386a <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    338f:	68 d6 4a 00 00       	push   $0x4ad6
    3394:	6a 01                	push   $0x1
    3396:	e8 cf 04 00 00       	call   386a <printf>
  pid = fork();
  ...
  printf(1, "uio test done\n");
    ...
    33b3:	68 e0 4a 00 00       	push   $0x4ae0
    33b8:	6a 01                	push   $0x1
    33ba:	e8 ab 04 00 00       	call   386a <printf>
}
    ...
    33d8:	68 6c 52 00 00       	push   $0x526c
    33dd:	6a 01                	push   $0x1
    33df:	e8 86 04 00 00       	call   386a <printf>
    exit();
    33e4:	e8 37 03 00 00       	call   3720 <exit>
    printf (1, "fork failed\n");
    33e9:	83 ec 08             	sub    $0x8,%esp
    33ec:	68 65 4a 00 00       	push   $0x4a65
    33f1:	6a 01                	push   $0x1
    33f3:	e8 72 04 00 00       	call   386a <printf>
    exit();
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    3404:	6a 00                	push   $0x0
    3406:	68 ef 4a 00 00       	push   $0x4aef
  ...
  printf(1, "arg test passed\n");
    ...
    343d:	68 01 4b 00 00       	push   $0x4b01
    3442:	6a 01                	push   $0x1
    3444:	e8 21 04 00 00       	call   386a <printf>
}
    ...
    3454:	68 f4 4a 00 00       	push   $0x4af4
    3459:	6a 02                	push   $0x2
    345b:	e8 0a 04 00 00       	call   386a <printf>
    exit();
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3468:	69 05 60 5b 00 00 0d 	imul   $0x19660d,0x5b60,%eax
    346f:	66 19 00 
    3472:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3477:	a3 60 5b 00 00       	mov    %eax,0x5b60
  return randstate;
}
    347c:	5d                   	pop    %ebp
    347d:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    348f:	68 12 4b 00 00       	push   $0x4b12
    3494:	6a 01                	push   $0x1
    3496:	e8 cf 03 00 00       	call   386a <printf>

  if(open("usertests.ran", 0) >= 0){
    349b:	83 c4 08             	add    $0x8,%esp
    349e:	6a 00                	push   $0x0
    34a0:	68 26 4b 00 00       	push   $0x4b26
    ...
    34b4:	68 90 52 00 00       	push   $0x5290
    34b9:	6a 01                	push   $0x1
    34bb:	e8 aa 03 00 00       	call   386a <printf>
    exit();
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    34cd:	68 26 4b 00 00       	push   $0x4b26
...
000037a0 <dup2>:
SYSCALL(dup2)
    37a0:	b8 17 00 00 00       	mov    $0x17,%eax
    37a5:	cd 40                	int    $0x40
    37a7:	c3                   	ret    
...
000037c8 <date>:
SYSCALL(date)
    37c8:	b8 16 00 00 00       	mov    $0x16,%eax
    37cd:	cd 40                	int    $0x40
    37cf:	c3                   	ret    
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    37de:	52                   	push   %edx
    37df:	50                   	push   %eax
    37e0:	e8 5b ff ff ff       	call   3740 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    37f5:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    37f9:	0f 95 c3             	setne  %bl
    37fc:	89 d0                	mov    %edx,%eax
    37fe:	c1 e8 1f             	shr    $0x1f,%eax
    3801:	84 c3                	test   %al,%bl
    3803:	74 10                	je     3815 <printint+0x2b>
    neg = 1;
    x = -xx;
    3805:	f7 da                	neg    %edx
    neg = 1;
    3807:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    380e:	be 00 00 00 00       	mov    $0x0,%esi
    3813:	eb 0b                	jmp    3820 <printint+0x36>
  neg = 0;
    3815:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
    381c:	eb f0                	jmp    380e <printint+0x24>
  do{
    buf[i++] = digits[x % base];
    ...
    3827:	f7 f1                	div    %ecx
    3829:	89 c3                	mov    %eax,%ebx
    382b:	8d 46 01             	lea    0x1(%esi),%eax
    382e:	0f b6 92 c4 52 00 00 	movzbl 0x52c4(%edx),%edx
    3835:	88 54 35 d8          	mov    %dl,-0x28(%ebp,%esi,1)
  }while((x /= base) != 0);
    3839:	89 da                	mov    %ebx,%edx
    383b:	85 db                	test   %ebx,%ebx
    383d:	75 df                	jne    381e <printint+0x34>
    383f:	89 c3                	mov    %eax,%ebx
  if(neg)
    3841:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
    3845:	74 16                	je     385d <printint+0x73>
    buf[i++] = '-';
    3847:	c6 44 05 d8 2d       	movb   $0x2d,-0x28(%ebp,%eax,1)
    384c:	8d 5e 02             	lea    0x2(%esi),%ebx
    384f:	eb 0c                	jmp    385d <printint+0x73>

  while(--i >= 0)
    putc(fd, buf[i]);
    3851:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
    3856:	89 f8                	mov    %edi,%eax
    3858:	e8 73 ff ff ff       	call   37d0 <putc>
  while(--i >= 0)
    385d:	83 eb 01             	sub    $0x1,%ebx
    3860:	79 ef                	jns    3851 <printint+0x67>
}
    3862:	83 c4 2c             	add    $0x2c,%esp
    3865:	5b                   	pop    %ebx
    3866:	5e                   	pop    %esi
    3867:	5f                   	pop    %edi
    3868:	5d                   	pop    %ebp
...
{
    386a:	55                   	push   %ebp
    386b:	89 e5                	mov    %esp,%ebp
    386d:	57                   	push   %edi
    386e:	56                   	push   %esi
    386f:	53                   	push   %ebx
    3870:	83 ec 1c             	sub    $0x1c,%esp
  char *s;
  int c, i, state;
  uint *ap;
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    3873:	8d 45 10             	lea    0x10(%ebp),%eax
    3876:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
    3879:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
    387e:	bb 00 00 00 00       	mov    $0x0,%ebx
    3883:	eb 14                	jmp    3899 <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
    3885:	89 fa                	mov    %edi,%edx
    3887:	8b 45 08             	mov    0x8(%ebp),%eax
    388a:	e8 41 ff ff ff       	call   37d0 <putc>
    388f:	eb 05                	jmp    3896 <printf+0x2c>
      }
    } else if(state == '%'){
    3891:	83 fe 25             	cmp    $0x25,%esi
    3894:	74 25                	je     38bb <printf+0x51>
  for(i = 0; fmt[i]; i++){
    3896:	83 c3 01             	add    $0x1,%ebx
    3899:	8b 45 0c             	mov    0xc(%ebp),%eax
    389c:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
    38a0:	84 c0                	test   %al,%al
    38a2:	0f 84 23 01 00 00    	je     39cb <printf+0x161>
    c = fmt[i] & 0xff;
    38a8:	0f be f8             	movsbl %al,%edi
    38ab:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
    38ae:	85 f6                	test   %esi,%esi
    38b0:	75 df                	jne    3891 <printf+0x27>
      if(c == '%'){
    38b2:	83 f8 25             	cmp    $0x25,%eax
    38b5:	75 ce                	jne    3885 <printf+0x1b>
        state = '%';
    38b7:	89 c6                	mov    %eax,%esi
    38b9:	eb db                	jmp    3896 <printf+0x2c>
      if(c == 'd'){
    38bb:	83 f8 64             	cmp    $0x64,%eax
    38be:	74 49                	je     3909 <printf+0x9f>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    38c0:	83 f8 78             	cmp    $0x78,%eax
    38c3:	0f 94 c1             	sete   %cl
    38c6:	83 f8 70             	cmp    $0x70,%eax
    38c9:	0f 94 c2             	sete   %dl
    38cc:	08 d1                	or     %dl,%cl
    38ce:	75 63                	jne    3933 <printf+0xc9>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    38d0:	83 f8 73             	cmp    $0x73,%eax
    38d3:	0f 84 84 00 00 00    	je     395d <printf+0xf3>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    38d9:	83 f8 63             	cmp    $0x63,%eax
    38dc:	0f 84 b7 00 00 00    	je     3999 <printf+0x12f>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    38e2:	83 f8 25             	cmp    $0x25,%eax
    38e5:	0f 84 cc 00 00 00    	je     39b7 <printf+0x14d>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    38eb:	ba 25 00 00 00       	mov    $0x25,%edx
    38f0:	8b 45 08             	mov    0x8(%ebp),%eax
    38f3:	e8 d8 fe ff ff       	call   37d0 <putc>
        putc(fd, c);
    38f8:	89 fa                	mov    %edi,%edx
    38fa:	8b 45 08             	mov    0x8(%ebp),%eax
    38fd:	e8 ce fe ff ff       	call   37d0 <putc>
      }
      state = 0;
    3902:	be 00 00 00 00       	mov    $0x0,%esi
    3907:	eb 8d                	jmp    3896 <printf+0x2c>
        printint(fd, *ap, 10, 1);
    ...
    391b:	e8 ca fe ff ff       	call   37ea <printint>
        ap++;
    ...
    392e:	e9 63 ff ff ff       	jmp    3896 <printf+0x2c>
        printint(fd, *ap, 16, 0);
    3933:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    3936:	8b 17                	mov    (%edi),%edx
    3938:	83 ec 0c             	sub    $0xc,%esp
    393b:	6a 00                	push   $0x0
    393d:	b9 10 00 00 00       	mov    $0x10,%ecx
    3942:	8b 45 08             	mov    0x8(%ebp),%eax
    3945:	e8 a0 fe ff ff       	call   37ea <printint>
        ap++;
    394a:	83 c7 04             	add    $0x4,%edi
    394d:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    3950:	83 c4 10             	add    $0x10,%esp
      state = 0;
    3953:	be 00 00 00 00       	mov    $0x0,%esi
    3958:	e9 39 ff ff ff       	jmp    3896 <printf+0x2c>
        s = (char*)*ap;
    395d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    3960:	8b 30                	mov    (%eax),%esi
        ap++;
    3962:	83 c0 04             	add    $0x4,%eax
    3965:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
    3968:	85 f6                	test   %esi,%esi
    396a:	75 28                	jne    3994 <printf+0x12a>
          s = "(null)";
    396c:	be bc 52 00 00       	mov    $0x52bc,%esi
    3971:	8b 7d 08             	mov    0x8(%ebp),%edi
    3974:	eb 0d                	jmp    3983 <printf+0x119>
          putc(fd, *s);
    3976:	0f be d2             	movsbl %dl,%edx
    3979:	89 f8                	mov    %edi,%eax
    397b:	e8 50 fe ff ff       	call   37d0 <putc>
          s++;
    3980:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
    3983:	0f b6 16             	movzbl (%esi),%edx
    3986:	84 d2                	test   %dl,%dl
    3988:	75 ec                	jne    3976 <printf+0x10c>
      state = 0;
    398a:	be 00 00 00 00       	mov    $0x0,%esi
    398f:	e9 02 ff ff ff       	jmp    3896 <printf+0x2c>
    3994:	8b 7d 08             	mov    0x8(%ebp),%edi
    3997:	eb ea                	jmp    3983 <printf+0x119>
        putc(fd, *ap);
    3999:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    399c:	0f be 17             	movsbl (%edi),%edx
    399f:	8b 45 08             	mov    0x8(%ebp),%eax
    39a2:	e8 29 fe ff ff       	call   37d0 <putc>
        ap++;
    39a7:	83 c7 04             	add    $0x4,%edi
    39aa:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
    39ad:	be 00 00 00 00       	mov    $0x0,%esi
    39b2:	e9 df fe ff ff       	jmp    3896 <printf+0x2c>
        putc(fd, c);
    39b7:	89 fa                	mov    %edi,%edx
    39b9:	8b 45 08             	mov    0x8(%ebp),%eax
    39bc:	e8 0f fe ff ff       	call   37d0 <putc>
      state = 0;
    39c1:	be 00 00 00 00       	mov    $0x0,%esi
    39c6:	e9 cb fe ff ff       	jmp    3896 <printf+0x2c>
    }
  }
}
    39cb:	8d 65 f4             	lea    -0xc(%ebp),%esp
    39ce:	5b                   	pop    %ebx
    39cf:	5e                   	pop    %esi
    39d0:	5f                   	pop    %edi
    39d1:	5d                   	pop    %ebp
...
{
    39d3:	55                   	push   %ebp
    39d4:	89 e5                	mov    %esp,%ebp
    39d6:	57                   	push   %edi
    39d7:	56                   	push   %esi
    39d8:	53                   	push   %ebx
    39d9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  Header *bp, *p;

  bp = (Header*)ap - 1;
    39dc:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    39df:	a1 00 5c 00 00       	mov    0x5c00,%eax
    39e4:	eb 02                	jmp    39e8 <free+0x15>
    39e6:	89 d0                	mov    %edx,%eax
    39e8:	39 c8                	cmp    %ecx,%eax
    39ea:	73 04                	jae    39f0 <free+0x1d>
    39ec:	39 08                	cmp    %ecx,(%eax)
    39ee:	77 12                	ja     3a02 <free+0x2f>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    39f0:	8b 10                	mov    (%eax),%edx
    39f2:	39 c2                	cmp    %eax,%edx
    39f4:	77 f0                	ja     39e6 <free+0x13>
    39f6:	39 c8                	cmp    %ecx,%eax
    39f8:	72 08                	jb     3a02 <free+0x2f>
    39fa:	39 ca                	cmp    %ecx,%edx
    39fc:	77 04                	ja     3a02 <free+0x2f>
    39fe:	89 d0                	mov    %edx,%eax
    3a00:	eb e6                	jmp    39e8 <free+0x15>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3a02:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3a05:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3a08:	8b 10                	mov    (%eax),%edx
    3a0a:	39 d7                	cmp    %edx,%edi
    3a0c:	74 19                	je     3a27 <free+0x54>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    3a0e:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    3a11:	8b 50 04             	mov    0x4(%eax),%edx
    3a14:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3a17:	39 ce                	cmp    %ecx,%esi
    3a19:	74 1b                	je     3a36 <free+0x63>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    3a1b:	89 08                	mov    %ecx,(%eax)
  freep = p;
    3a1d:	a3 00 5c 00 00       	mov    %eax,0x5c00
}
    3a22:	5b                   	pop    %ebx
    3a23:	5e                   	pop    %esi
    3a24:	5f                   	pop    %edi
    ...
    3a26:	c3                   	ret    
    bp->s.size += p->s.ptr->s.size;
    3a27:	03 72 04             	add    0x4(%edx),%esi
    3a2a:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3a2d:	8b 10                	mov    (%eax),%edx
    3a2f:	8b 12                	mov    (%edx),%edx
    3a31:	89 53 f8             	mov    %edx,-0x8(%ebx)
    3a34:	eb db                	jmp    3a11 <free+0x3e>
    p->s.size += bp->s.size;
    3a36:	03 53 fc             	add    -0x4(%ebx),%edx
    3a39:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    3a3c:	8b 53 f8             	mov    -0x8(%ebx),%edx
    3a3f:	89 10                	mov    %edx,(%eax)
    3a41:	eb da                	jmp    3a1d <free+0x4a>
...
{
    3a43:	55                   	push   %ebp
    3a44:	89 e5                	mov    %esp,%ebp
    3a46:	53                   	push   %ebx
    3a47:	83 ec 04             	sub    $0x4,%esp
    3a4a:	89 c3                	mov    %eax,%ebx
  char *p;
  Header *hp;

  if(nu < 4096)
    3a4c:	3d ff 0f 00 00       	cmp    $0xfff,%eax
    3a51:	77 05                	ja     3a58 <morecore+0x15>
    nu = 4096;
    3a53:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
    3a58:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    3a5f:	83 ec 0c             	sub    $0xc,%esp
    3a62:	50                   	push   %eax
    3a63:	e8 48 fd ff ff       	call   37b0 <sbrk>
  if(p == (char*)-1)
    3a68:	83 c4 10             	add    $0x10,%esp
    3a6b:	83 f8 ff             	cmp    $0xffffffff,%eax
    3a6e:	74 1c                	je     3a8c <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    3a70:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3a73:	83 c0 08             	add    $0x8,%eax
    3a76:	83 ec 0c             	sub    $0xc,%esp
    3a79:	50                   	push   %eax
    3a7a:	e8 54 ff ff ff       	call   39d3 <free>
  return freep;
    3a7f:	a1 00 5c 00 00       	mov    0x5c00,%eax
    ...
    3a91:	eb f4                	jmp    3a87 <morecore+0x44>
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    3a9d:	8d 58 07             	lea    0x7(%eax),%ebx
    3aa0:	c1 eb 03             	shr    $0x3,%ebx
    3aa3:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
    3aa6:	8b 0d 00 5c 00 00    	mov    0x5c00,%ecx
    3aac:	85 c9                	test   %ecx,%ecx
    3aae:	74 04                	je     3ab4 <malloc+0x21>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3ab0:	8b 01                	mov    (%ecx),%eax
    3ab2:	eb 4d                	jmp    3b01 <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
    3ab4:	c7 05 00 5c 00 00 04 	movl   $0x5c04,0x5c00
    3abb:	5c 00 00 
    3abe:	c7 05 04 5c 00 00 04 	movl   $0x5c04,0x5c04
    3ac5:	5c 00 00 
    base.s.size = 0;
    3ac8:	c7 05 08 5c 00 00 00 	movl   $0x0,0x5c08
    3acf:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    3ad2:	b9 04 5c 00 00       	mov    $0x5c04,%ecx
    3ad7:	eb d7                	jmp    3ab0 <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    3ad9:	39 da                	cmp    %ebx,%edx
    3adb:	74 1a                	je     3af7 <malloc+0x64>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    3add:	29 da                	sub    %ebx,%edx
    3adf:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    3ae2:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
    3ae5:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
    3ae8:	89 0d 00 5c 00 00    	mov    %ecx,0x5c00
      return (void*)(p + 1);
    3aee:	83 c0 08             	add    $0x8,%eax
    }
    if(p == freep)
    ...
    3af1:	83 c4 04             	add    $0x4,%esp
    3af4:	5b                   	pop    %ebx
    3af5:	5d                   	pop    %ebp
    3af6:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    3af7:	8b 10                	mov    (%eax),%edx
    3af9:	89 11                	mov    %edx,(%ecx)
    3afb:	eb eb                	jmp    3ae8 <malloc+0x55>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3afd:	89 c1                	mov    %eax,%ecx
    3aff:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
    3b01:	8b 50 04             	mov    0x4(%eax),%edx
    3b04:	39 da                	cmp    %ebx,%edx
    3b06:	73 d1                	jae    3ad9 <malloc+0x46>
    if(p == freep)
    3b08:	39 05 00 5c 00 00    	cmp    %eax,0x5c00
    3b0e:	75 ed                	jne    3afd <malloc+0x6a>
      if((p = morecore(nunits)) == 0)
    3b10:	89 d8                	mov    %ebx,%eax
    3b12:	e8 2c ff ff ff       	call   3a43 <morecore>
    3b17:	85 c0                	test   %eax,%eax
    3b19:	75 e2                	jne    3afd <malloc+0x6a>
        return 0;
    3b1b:	b8 00 00 00 00       	mov    $0x0,%eax
    3b20:	eb cf                	jmp    3af1 <malloc+0x5e>
