...
int main (int argc, char *argv [])
{
  ...
  14:	50                   	push   %eax
  15:	e8 76 02 00 00       	call   290 <date>
  1a:	83 c4 10             	add    $0x10,%esp
  1d:	85 c0                	test   %eax,%eax
  1f:	74 14                	je     35 <main+0x35>
     printf(2, "date failed\n");
  21:	83 ec 08             	sub    $0x8,%esp
  24:	68 ec 05 00 00       	push   $0x5ec
  29:	6a 02                	push   $0x2
  2b:	e8 02 03 00 00       	call   332 <printf>
     exit();
  30:	e8 b3 01 00 00       	call   1e8 <exit>
  }
  // Pon aquí tu código para imprimir la fecha en el formato que desees
  printf(1,"%d-%d-%d %d:%d:%d\n", r.day, r.month, r.year, r.hour, r.minute, r.second);
  35:	ff 75 e0             	pushl  -0x20(%ebp)
  38:	ff 75 e4             	pushl  -0x1c(%ebp)
  3b:	ff 75 e8             	pushl  -0x18(%ebp)
  3e:	ff 75 f4             	pushl  -0xc(%ebp)
  41:	ff 75 f0             	pushl  -0x10(%ebp)
  44:	ff 75 ec             	pushl  -0x14(%ebp)
  47:	68 f9 05 00 00       	push   $0x5f9
  4c:	6a 01                	push   $0x1
  4e:	e8 df 02 00 00       	call   332 <printf>
  exit();
...
00000268 <dup2>:
SYSCALL(dup2)
 268:	b8 17 00 00 00       	mov    $0x17,%eax
 26d:	cd 40                	int    $0x40
 26f:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 2f6:	0f b6 92 14 06 00 00 	movzbl 0x614(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 432:	75 28                	jne    45c <printf+0x12a>
          s = "(null)";
 434:	be 0c 06 00 00       	mov    $0x60c,%esi
...
morecore(uint nu)
{
 ...
 52a:	50                   	push   %eax
 52b:	e8 48 fd ff ff       	call   278 <sbrk>
  if(p == (char*)-1)
